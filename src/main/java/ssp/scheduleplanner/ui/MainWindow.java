...
public class MainWindow extends UiPart<Stage> {
    ...
    @FXML
    private BorderPane sidebarPlaceholder;
     ...
     */
    void fillInnerParts() {
        sidebarPanel = new SidebarPanel(logic);
        sidebarPlaceholder.getChildren().add(sidebarPanel.getRoot());
        ...
        StatusBarFooter statusBarFooter = new StatusBarFooter(prefs.getSchedulePlannerFilePath());
        statusbarPlaceholder.getChildren().add(statusBarFooter.getRoot());

        CommandBox commandBox = new CommandBox(logic);
        commandBoxPlaceholder.getChildren().add(commandBox.getRoot());

        ProgressBarPanel progressBarPanel = new ProgressBarPanel(logic);
        progressbarPlaceholder.getChildren().add(progressBarPanel.getRoot());
    }
