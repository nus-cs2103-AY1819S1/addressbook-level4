    ...
    public static Article[] getSampleArticles() {
        return new Article[] {
            new Article(new Name("Nike Wallet"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                new Description("Found at Blk 30 Geylang Street 29, #06-40"), Image.DEFAULT, new Name("Alex Yeoh"),
            ...
            new Article(new Name("Fitbit"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Description("Found at Blk 11 Ang Mo Kio Street 74, #11-04"), Image.DEFAULT, new Name("Charlotte Oliveiro"),
                    new Name("Not Claimed"), Boolean.FALSE, getTagSet("New")),
            new Article(new Name("Casio watch"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Description("Found at Blk 436 Serangoon Gardens Street 26, #16-43"), Image.DEFAULT,  new Name("David Li"),
                    new Name("Not Claimed"), Boolean.FALSE, getTagSet("Red")),
            new Article(new Name("Bluetooth speaker"), new Phone("92492021"), new Email("irfan@example.com"),
                new Description("Found at Blk 47 Tampines Street 20, #17-35"), Image.DEFAULT, new Name("Irfan Ibrahim"),
                    new Name("Not Claimed"), Boolean.FALSE, getTagSet("Blue")),
            new Article(new Name("IPhone 7"), new Phone("92624417"), new Email("royb@example.com"),
                new Description("Found at Blk 45 Aljunied Street 85, #11-31"), Image.DEFAULT, new Name("Roy Balakrishnan"),
                    new Name("Not Claimed"), Boolean.FALSE, getTagSet("Gold"))
        };
    }
