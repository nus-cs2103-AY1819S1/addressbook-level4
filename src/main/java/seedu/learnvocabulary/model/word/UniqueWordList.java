...
/**
 * A list of words that enforces uniqueness between its elements and does not allow nulls.
 * A word is considered unique by comparing using {@code Word#isSameWord(Word)}. As such, adding and updating of
 * words uses Word#isSameWord(Word) for equality so as to ensure that the word being added or updated is
