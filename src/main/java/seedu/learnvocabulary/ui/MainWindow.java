...
public class MainWindow extends UiPart<Stage> {
    ...
    @FXML
    private StackPane wordListPanelPlaceholder;
    ...
    void fillInnerParts() {
        ...
        wordListPanel = new WordListPanel(logic.getFilteredWordList());
        wordListPanelPlaceholder.getChildren().add(wordListPanel.getRoot());

        ResultDisplay resultDisplay = new ResultDisplay();
        resultDisplayPlaceholder.getChildren().add(resultDisplay.getRoot());

        StatusBarFooter statusBarFooter = new StatusBarFooter(prefs.getLearnVocabularyFilePath());
