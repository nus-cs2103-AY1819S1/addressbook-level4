    ...
    public static Ride[] getSampleRides() {
        return new Ride[] {
            new Ride(new Name("Accelerator"), new Maintenance("87"), new WaitTime("1"),
                new Zone("Blk 30 Geylang Street 29, #06-40"),
                getTagSet("friends")),
            new Ride(new Name("Battlestar Galactica"), new Maintenance("58"), new WaitTime("0"),
                new Zone("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                getTagSet("HUMANSvsCYLON", "friends"), Status.SHUTDOWN),
            new Ride(new Name("Canopy Flyer"), new Maintenance("93"), new WaitTime("3"),
                new Zone("Blk 11 Ang Mo Kio Street 74, #11-04"),
                getTagSet("neighbours")),
            new Ride(new Name("Dino Sorarin"), new Maintenance("28"), new WaitTime("12"),
                new Zone("Blk 436 Serangoon Gardens Street 26, #16-43"),
                getTagSet("family")),
            new Ride(new Name("Enchanted Airways"), new Maintenance("21"), new WaitTime("9"),
                new Zone("Blk 47 Tampines Street 20, #17-35"),
                getTagSet("classmates")),
            new Ride(new Name("TRANSFORMERS The Ride"), new Maintenance("17"), new WaitTime("18"),
                new Zone("Blk 45 Aljunied Street 85, #11-31"),
