...
public class DeleteEventCommandParser implements Parser<DeleteEventCommand> {
    ...
    public DeleteEventCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_MONTH, PREFIX_YEAR, PREFIX_START_DATE,
                        PREFIX_END_DATE, PREFIX_TITLE);

        if (!arePrefixesPresent(argMultimap, PREFIX_MONTH, PREFIX_YEAR, PREFIX_START_DATE,
                PREFIX_END_DATE, PREFIX_TITLE)
        ...
        return new DeleteEventCommand(month, year, startDate, endDate, title);
    }
