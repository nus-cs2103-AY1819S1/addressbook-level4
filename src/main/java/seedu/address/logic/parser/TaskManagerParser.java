...
public class TaskManagerParser {
    ...
    public Command parseCommand(String userInput) throws ParseException {
        ...
        case AchievementsCommand.COMMAND_WORD:
            return new AchievementsCommandParser().parse(arguments);
        ...
        case DependencyCommand.COMMAND_WORD:
            return new DependencyCommandParser().parse(arguments);
