...
public class HealthBookParser {
    ...
    public Command parseCommand(String userInput) throws ParseException {
        ...
        case RegisterDoctorCommand.COMMAND_WORD:
            return new RegisterDoctorCommandParser().parse(arguments);
        ...
        case DeleteMedicalHistoryCommand.COMMAND_WORD:
            return new DeleteMedicalHistoryCommandParser().parse(arguments);

        case FilterPatientCommand.COMMAND_WORD:
            return new FilterPatientCommand();
        ...
        case CompleteAppointmentCommand.COMMAND_WORD:
            return new CompleteAppointmentCommandParser().parse(arguments);
