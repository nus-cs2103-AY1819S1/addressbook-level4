 ...
 */
public class DelCardCommand extends Command {
     ...
     * @param targetIndex
     */
    public DelCardCommand(Index targetIndex) {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof DelCardCommand // instanceof handles nulls
                && targetIndex.equals(((DelCardCommand) other).targetIndex));
    }
}
