...
public class EditModuleCommand extends Command {
     ...
     */
    public EditModuleCommand(Index index, EditPersonDescriptor editPersonDescriptor) {
    ...
    public CommandResult execute(Model model, CommandHistory history) throws CommandException {
        ...
        Person editedPerson = createEditedModule(personToEdit, editPersonDescriptor);
     ...
     */
    private static Person createEditedModule(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
