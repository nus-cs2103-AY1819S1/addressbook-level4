...
public class AddCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Adds a person to the student list. "
            + "Parameters: "
            + PREFIX_NAME + "NAME "
            + PREFIX_PHONE + "PHONE "
            + PREFIX_EMAIL + "EMAIL "
            ...
            + PREFIX_EDUCATION + "Primary 4 "
            + PREFIX_GRADES + "Y1819S1_Mid 89 "
            + PREFIX_TAG + "friends "
