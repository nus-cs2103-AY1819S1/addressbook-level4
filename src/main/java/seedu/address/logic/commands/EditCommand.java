...
public class EditCommand extends Command {
    ...
    public CommandResult execute(Model model, CommandHistory history) throws CommandException {
        ...
        if (!personToEdit.isSameTask(editedPerson) && model.hasPerson(editedPerson)) {
    ...
    private static Task createEditedPerson(Task personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        Address updatedAddress = editPersonDescriptor.getAddress().orElse(personToEdit.getDescription());
