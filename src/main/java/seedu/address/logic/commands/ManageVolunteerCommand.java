...
public class ManageVolunteerCommand extends Command {
    ...
    public ManageVolunteerCommand(Index targetIndex) {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof ManageVolunteerCommand // instanceof handles nulls
                && targetIndex.equals(((ManageVolunteerCommand) other).targetIndex)); // state check
    }
}
