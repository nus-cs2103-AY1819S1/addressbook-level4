...
public class FindVolunteerCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Finds all volunteerss whose names contain any of "
            + "the specified keywords (case-insensitive) and displays them as a list with index numbers.\n"
            + "Parameters: KEYWORD [MORE_KEYWORDS]...\n"
            + "Example: " + COMMAND_WORD + " alice bob charlie";

    private final VolunteerNameContainsKeywordsPredicate predicate;

    public FindVolunteerCommand(VolunteerNameContainsKeywordsPredicate predicate) {
