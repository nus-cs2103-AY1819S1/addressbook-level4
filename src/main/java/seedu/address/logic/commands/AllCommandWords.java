...
public class AllCommandWords {
    public static final String[] COMMAND_WORDS = {AddCommand.COMMAND_WORD, ClearCommand.COMMAND_WORD,
        ...
        HelpCommand.COMMAND_WORD, HistoryCommand.COMMAND_WORD, OpenCommand.COMMAND_WORD,QuickViewCommand.COMMAND_WORD,
            RedoCommand.COMMAND_WORD, ShutDownCommand.COMMAND_WORD, ViewAllCommand.COMMAND_WORD,
