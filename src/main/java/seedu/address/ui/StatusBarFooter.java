...
public class StatusBarFooter extends UiPart<Region> {
    ...
    @Subscribe
    public void handleModuleListChangedEvent(ModuleListChangedEvent mlce) {
        long now = clock.millis();
        String lastUpdated = new Date(now).toString();
        logger.info(LogsCenter.getEventHandlingLogMessage(mlce, "Setting last updated status to " + lastUpdated));
