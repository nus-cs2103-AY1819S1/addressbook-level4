 ...
 * A person is considered unique by comparing using {@code Receptionist#isSameReceptionist(Receptionist)}. As such, adding and updating of
 * receptionists uses Receptionist#isSameReceptionist(Receptionist) for equality so as to ensure that the receptionist being added or updated is
 * unique in terms of identity in the UniqueReceptionistList. However, the removal of a receptionist uses Receptionist#equals(Object) so
 * as to ensure that the receptionist with exactly the same fields will be removed.
 *
...
public class UniqueReceptionistList implements Iterable<Receptionist> {
     ...
     * The receptionist identity of {@code editedReceptionist} must not be the same as another existing receptionist in the list.
     */
