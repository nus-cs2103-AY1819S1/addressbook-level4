...
public class SampleDataUtil {
    public static Task[] getSampleTasks() {
        return new Task[]{
            new Task(new Name("Alex Yeoh"), new DueDate("01-10-18"), new PriorityValue("alexyeoh@example.com"),
                    new Description("Blk 30 Geylang Street 29, #06-40"),
                    getLabelSet("friends")),
            new Task(new Name("Bernice Yu"), new DueDate("02-10-18"), new PriorityValue("berniceyu@example.com"),
                    new Description("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                    getLabelSet("colleagues", "friends")),
            new Task(new Name("Charlotte Oliveiro"), new DueDate("03-10-18"),
                    new PriorityValue("charlotte@example.com"),
                    new Description("Blk 11 Ang Mo Kio Street 74, #11-04"),
                    getLabelSet("neighbours")),
            new Task(new Name("David Li"), new DueDate("04-10-18"), new PriorityValue("lidavid@example.com"),
                    new Description("Blk 436 Serangoon Gardens Street 26, #16-43"),
                    getLabelSet("family")),
            new Task(new Name("Irfan Ibrahim"), new DueDate("05-10-18"), new PriorityValue("irfan@example.com"),
                    new Description("Blk 47 Tampines Street 20, #17-35"),
                    getLabelSet("classmates")),
            new Task(new Name("Roy Balakrishnan"), new DueDate("06-10-18"), new PriorityValue("royb@example.com"),
