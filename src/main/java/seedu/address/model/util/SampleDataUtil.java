    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Doctor(new Name("Roy Balakrishnan"), new Nric("S2271707C"), new Phone("92624417"),
                    new Email("royb@example.com"), new Address("Blk 45 Bishan Street 14, #11-31"),
            ...
            new Doctor(new Name("Jay Cutler"), new Nric("S7400037A"), new Phone("93324417"),
                    new Email("jay@example.com"), new Address("Blk 47 Lorang Chuan Street 12, #11-31"),
            ...
            new Doctor(new Name("Cristiano Ronaldo"), new Nric("S0928611Z"), new Phone("92644178"),
                    new Email("cr7@example.com"), new Address("Blk 48 Seletar Street 85, #11-31"),
            ...
            new Patient(new Name("Gary Goh"), new Nric("S6837870B"), new Phone("87938807"),
                    ...
                    getTagSet("hokkien only"),
                    new MedicalRecord("12.12.2018", "flu", "tamiflu", "")),
            new Patient(new Name("Gary Zuo"), new Nric("S9887917Z"), new Phone("87438817"),
                    new Email("garyzuo@example.com"), new Address("Blk 36 Sengkang Street 29, #25-40"),
                    getTagSet("chinese only"),
                    new MedicalRecord("12.12.2018", "flu", "tamiflu", "")),
            new Patient(new Name("Triston Pang"), new Nric("S8447383I"), new Phone("87438827"),
                    ...
                    getTagSet("english only"),
                    new MedicalRecord("12.12.2018", "flu", "tamiflu", "")),
            new Patient(new Name("Triston Yap"), new Nric("S6376673I"), new Phone("87438837"),
                    new Email("tristonyap@example.com"), new Address("Blk 38 Hougang Street 29, #23-40"),
                    getTagSet("chinese only"),
                    new MedicalRecord("12.12.2018", "flu", "tamiflu", "")),
            new Patient(new Name("Selene Yeoh"), new Nric("S3024786H"), new Phone("87438847"),
                    ...
                    getTagSet("hokkien only"),
                    new MedicalRecord("12.12.2018", "flu", "tamiflu", "")),
            new Patient(new Name("Celine Lim"), new Nric("S1942538Z"), new Phone("87438857"),
                    new Email("celinelim@example.com"), new Address("Blk 40 Punggol Street 29, #21-40"),
                    getTagSet("hokkien only"),
                    new MedicalRecord("12.12.2018", "flu", "tamiflu", "")),
            new Patient(new Name("Priscilia Goh"), new Nric("S7467468B"), new Phone("87438867"),
            ...
            new Patient(new Name("Sophia Tan"), new Nric("S9105236I"), new Phone("87438897"),
                    ...
                    getTagSet("chinese only"),
                    new MedicalRecord("12.12.2018", "flu", "tamiflu", "")),
            new Patient(new Name("Daisy Lim"), new Nric("S9049716B"), new Phone("87431807"),
                    new Email("daisylim@example.com"), new Address("Blk 45 Serangoon Street 29, #16-40"),
                    getTagSet("hokkien only"),
                    new MedicalRecord("12.12.2018", "flu", "tamiflu", "")),
            new Patient(new Name("Anna Tan"), new Nric("S6122266I"), new Phone("87432807"),
                    new Email("annatan@example.com"), new Address("Blk 46 Punggol Street 29, #15-40"),
                    getTagSet("english only"),
                    new MedicalRecord("12.12.2018", "flu", "tamiflu", "")),
