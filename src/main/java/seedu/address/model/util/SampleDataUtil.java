...
public class SampleDataUtil {
    public static Task[] getSampleTasks() {
        return new Task[]{
            new Task(new Name("Attack food"), new DueDate("01-10-18"), new PriorityValue("alexyeoh@example.com"),
                    new Description("Blk 30 Geylang Street 29, #06-40"),
                    getLabelSet("friends")),
            new Task(new Name("Bounce ball"), new DueDate("02-10-18"), new PriorityValue("berniceyu@example.com"),
            ...
            new Task(new Name("Dancing queen"), new DueDate("04-10-18"), new PriorityValue("lidavid@example.com"),
                    new Description("Blk 436 Serangoon Gardens Street 26, #16-43"),
                    getLabelSet("family")),
            new Task(new Name("Induce happiness"), new DueDate("05-10-18"), new PriorityValue("irfan@example.com"),
                    new Description("Blk 47 Tampines Street 20, #17-35"),
                    getLabelSet("classmates")),
            new Task(new Name("Run home"), new DueDate("06-10-18"), new PriorityValue("royb@example.com"),
