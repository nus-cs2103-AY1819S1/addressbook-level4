    ...
    public static Wish[] getSampleWishes() {
        return new Wish[] {
            ...
            new Wish(new Name("Nintendo Switch"), new Price("93210283"), new Email("charlotte@example.com"),
                new Url("https://www.lazada.sg/products/nintendo-switch-neon-console-1-year-local-warranty-best-seller-i180040203-s230048296.html"),
                    new SavedAmount("0.00"),
                    SAMPLE_REMARK_EMPTY, getTagSet("neighbours")),
            new Wish(new Name("PS4 Pro"), new Price("91031282"), new Email("lidavid@example.com"),
                new Url("https://www.lazada.sg/products/sony-playstation-4-pro-1tb-console-local-stock-with-sony-warranty-i100009437-s100011973.html"),
                    new SavedAmount("0.00"),
