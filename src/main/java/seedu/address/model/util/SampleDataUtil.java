...
/**
 * Contains utility methods for populating {@code HealthBook} with sample data.
 */
public class SampleDataUtil {
    ...
    public static ReadOnlyHealthBook getSampleHealthBook() {
        HealthBook sampleAb = new HealthBook();
