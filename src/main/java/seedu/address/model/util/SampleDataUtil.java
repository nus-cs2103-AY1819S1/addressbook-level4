...
public class SampleDataUtil {
    ...
    public static Wish[] getSampleWishes() {
        return new Wish[] {
                ...
                new Wish(new Name("Logitech K840 Mechanical Keyboard"), new Price("99272758"),
                ...
                new Wish(new Name("Nintendo Switch"), new Price("93210283"), new Email("charlotte@example.com"),
                        new Url("https://www.lazada.sg/products/" +
                ...
                new Wish(new Name("PS4 Pro"), new Price("91031282"), new Email("lidavid@example.com"),
                        new Url("https://www.lazada.sg/products/" +
                                "sony-playstation-4-pro-1tb-console-local-stock-with-sony-warranty-i100009437-s100011973.html"),
                        new SavedAmount("0.00"),
                        SAMPLE_REMARK_EMPTY, getTagSet("family")),
                new Wish(new Name("EVGA 1080 Ti Graphics Card"), new Price("92492021"),
                ...
                new Wish(new Name("1TB SSD"), new Price("92624417"),
