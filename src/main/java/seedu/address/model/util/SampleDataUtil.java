...
public class SampleDataUtil {
    ...
    private static Event[] getSampleEvents() {
        return new Event[] {
            ...
            new Event(new EventName("Linguistics Reading Group"), new Address("NUS Central Library"), getTagSet("Week12"),
                LocalDate.of(2018, 11, 12), LocalTime.of(17, 30),
                LocalTime.of(18, 30), CHARLOTTE),
            new Event(new EventName("Linguistics Reading Group"), new Address("NUS Central Library"), getTagSet("Week13"),
                LocalDate.of(2018, 11, 19), LocalTime.of(17, 30),
                LocalTime.of(18, 30), CHARLOTTE),
            new Event(new EventName("Linguistics Reading Group"), new Address("NUS Central Library"), getTagSet("Week14"),
