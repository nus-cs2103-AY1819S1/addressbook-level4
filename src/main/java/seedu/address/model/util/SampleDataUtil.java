...
//    }
    ...
    public static Carpark[] getSampleCarpark() {
        return new Carpark[] {
            new Carpark(new CarparkNumber("YB2"), new TotalLots("10"), new LotsAvailable("5"),
                    new Address("Blk 47 Tampines Street 20, #17-35"),
                    getTagSet("AMAZING")),
            new Carpark(new CarparkNumber("YB1"), new TotalLots("120"), new LotsAvailable("51"),
                    new Address("Blk 47 Tampines Street 21, #17-35"),
                    getTagSet("HOME"))
        };
    }
