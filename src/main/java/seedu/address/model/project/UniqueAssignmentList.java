 ...
 * adding and updating of assignment uses Assignment#isSameAssignment(Assignment) for equality so as to ensure that
 * the assignment being added or updated is unique in terms of identity in the UniqueAssignmentList. However, the
 * removal of an assignment uses Assignment#equals(Object) so as to ensure that the assignment with exactly the same
