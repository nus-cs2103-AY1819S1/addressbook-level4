...
public class XmlAdaptedFavourite {
     ...
     */
    public XmlAdaptedFavourite(String name, String difficulty, String cooktime,
     ...
     */
    public XmlAdaptedFavourite(Recipe source) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof seedu.souschef.storage.recipe.XmlAdaptedRecipe)) {
            return false;
        }

        seedu.souschef.storage.recipe.XmlAdaptedRecipe otherRecipe = (seedu.souschef.storage.recipe.XmlAdaptedRecipe) other;
