...
public class FavouritesParser {
     ...
     */
    public Command<Favourites> parseCommand(Model model, String userInput) throws ParseException {
        ...
        case DeleteCommand.COMMAND_WORD:
            return new DeleteCommandParser().parseFavourites(model, arguments);

        case FindCommand.COMMAND_WORD:
            return new FindCommandParser().parseFavourites(model, arguments);

        case ListCommand.COMMAND_WORD:
            return new ListCommand<Favourites>(model);
