...
//                ArgumentTokenizer.tokenize(args, PREFIX_PLAYLIST, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS, PREFIX_TAG);
//
//        Index index;
//
//        try {
...
//        if (argMultimap.getValue(PREFIX_PLAYLIST).isPresent()) {
//            editPersonDescriptor.setName(ParserUtil.parseName(argMultimap.getValue(PREFIX_PLAYLIST).get()));
//        }
