...
import seedu.modsuni.model.person.UniquePersonList;

/**
 * Wraps all data at the modsuni-book level
...
public class AddressBook implements ReadOnlyAddressBook {
     ...
     *
     * Note that non-static init blocks are not recommended to use. There are other wadys to avoid duplication
     *   among constructors.
     */
    {
    ...
    /**
     * Adds a person to the modsuni book.
     * The person must not already exist in the modsuni book.
     */
