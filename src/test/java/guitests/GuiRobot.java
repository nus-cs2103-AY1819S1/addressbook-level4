...
public class GuiRobot extends FxRobot {
     ...
     *
     * EventTimeoutException if the time taken exceeds {@code DEFAULT_WAIT_FOR_EVENT_TIMEOUT_MILLISECONDS}
     * milliseconds.
     */
     ...
     * EventTimeoutException if the time taken exceeds {@code timeOut}.
     */
