...
public class GuiRobot extends FxRobot {
     ...
     *
     * EventTimeoutException is thrown if the time taken exceeds {@code DEFAULT_WAIT_FOR_EVENT_TIMEOUT_MILLISECONDS}
     * milliseconds.
     */
     ...
     * EventTimeoutException is thrown if the time taken exceeds {@code timeOut}.
     */
     ...
     *
     * StageNotFoundException is thrown if the stage is not found.
     */
