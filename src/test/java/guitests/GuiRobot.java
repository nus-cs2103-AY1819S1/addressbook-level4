...
public class GuiRobot extends FxRobot {
     ...
     * milliseconds.
     */
    public void waitForEvent(BooleanSupplier event) throws EventTimeoutException {
     ...
     */
    public void waitForEvent(BooleanSupplier event, int timeOut) throws EventTimeoutException {
        int timePassed = 0;
