...
public class WebViewUtil {
    ...
    /**
     * If the {@code taskViewPanelHandle}'s {@code WebView} is loading, sleeps the thread till it is successfully loaded.
     */
    public static void waitUntilBrowserLoaded(TaskViewPanelHandle taskViewPanelHandle) {
        new GuiRobot().waitForEvent(taskViewPanelHandle::isLoaded);
    }
}
