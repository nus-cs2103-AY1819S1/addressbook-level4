 ...
 */
public class PersonListPanelHandle extends NodeHandle<ListView<Patient>> {
    public static final String PERSON_LIST_VIEW_ID = "#personListView";

    private static final String CARD_PANE_ID = "#cardPane";

    private Optional<Patient> lastRememberedSelectedPersonCard;

    public PersonListPanelHandle(ListView<Patient> personListPanelNode) {
    ...
    private Patient getPerson(int index) {
