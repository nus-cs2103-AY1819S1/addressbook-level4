...
/**
 * A handler for the {@code BudgetBrowserPanel} of the UI.
 */
public class BudgetBrowserPanelHandle extends NodeHandle<Node> {
    ...
    public BudgetBrowserPanelHandle(Node browserPanelNode) {
