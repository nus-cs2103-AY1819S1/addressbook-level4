...
import seedu.clinicio.ui.StatusBarFooter;

/**
 * A system test class for the help window, which contains interaction with other UI components.
 */
public class HelpCommandSystemTest extends ClinicIoSystemTest {
    ...
    public void openHelpWindow() {
        ...
        executeCommand(SelectCommand.COMMAND_WORD + " " + INDEX_FIRST_PATIENT.getOneBased());
        ...
        executeCommand(DeleteCommand.COMMAND_WORD + " " + INDEX_FIRST_PATIENT.getOneBased());
