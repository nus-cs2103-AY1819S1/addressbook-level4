 ...
 */
public class HelpCommandSystemTest extends SchedulerSystemTest {
    ...
    public void openHelpWindow() {
        ...
        executeCommand(SelectCommand.COMMAND_WORD + " " + INDEX_FIRST_ELEMENT.getOneBased());
        assertEquals("", getCommandBox().getInput());
        assertCommandBoxShowsDefaultStyle();
        assertNotEquals(HelpCommand.SHOWING_HELP_MESSAGE, getResultDisplay().getText());
        GuiTestAssert.assertCalendarListMatching(getCalendarEventListPanel(), getModel().getFilteredCalendarEventList());
