 ...
 */
public class HelpCommandSystemTest extends CarparkFinderSystemTest {
    ...
    public void openHelpWindow() {
        ...
        executeCommand(SelectCommand.COMMAND_WORD + " " + INDEX_FIRST_CARPARK.getOneBased());
        assertEquals("", getCommandBox().getInput());
        assertCommandBoxShowsDefaultStyle();
        assertNotEquals(HelpCommand.SHOWING_HELP_MESSAGE, getResultDisplay().getText());
        assertNotEquals(getClass().getResource(MAINPAGE_FILE_PATH).toString() + "?isDefault=1",
