...
/**
 * A system test class for HealthBook, which provides access to handles of GUI components and helper methods
 * for test verification.
 */
public abstract class HealthBookSystemTest {
    @ClassRule
     ...
     */
    protected HealthBook getInitialData() {
    ...
    protected void assertApplicationDisplaysExpected(String expectedCommandInput, String expectedResultMessage,
        ...
        assertEquals(new HealthBook(expectedModel.getAddressBook()), testApp.readStorageAddressBook());
