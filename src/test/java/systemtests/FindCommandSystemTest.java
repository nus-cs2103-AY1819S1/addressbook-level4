...
public class FindCommandSystemTest extends AddressBookSystemTest {
    ...
    public void find() {
        ...
        /* Case: find person in address book, 2 keywords -> 1 person found */
        command = FindCommand.COMMAND_WORD + "-n Daniel Meier";
        ModelHelper.setFilteredList(expectedModel, DANIEL);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find person in address book, 2 keywords in reversed order -> 1 person found */
        command = FindCommand.COMMAND_WORD + "-n Meier Daniel";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find person in address book, 2 keywords with 1 repeat -> 1 person found */
