...
public class FindCommandSystemTest extends AddressBookSystemTest {
    ...
    public void find() throws NoUserSelectedException {
        ...
        /* Case: find category number of person in address book -> 0 persons found */
        ...
        assertFalse(getPersonListPanel().getHandleToSelectedCard().getName().equals(DANIEL.getName().expenseName));
