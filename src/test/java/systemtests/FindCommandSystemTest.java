...
//         * -> 2 words found
//         */
//        String command = "   " + FindCommand.COMMAND_WORD + " " + KEYWORD_MATCHING_GLIDE + "   ";
//        Model expectedModel = getModel();
//        ModelHelper.setFilteredList(expectedModel, DELIBERATE, VOLCANO); first names of Benson and Daniel are "Meier"
...
//         * -> 2 words found
//         */
//        command = FindCommand.COMMAND_WORD + " " + KEYWORD_MATCHING_GLIDE;
//        assertCommandSuccess(command, expectedModel);
//        assertSelectedCardUnchanged();
//
