...
//         * -> 2 persons found
//         */
//        String command = "   " + PlaylistSearchCommand.COMMAND_PHRASE + " " + KEYWORD_MATCHING_SONG + "   ";
...
//        command = PlaylistSearchCommand.COMMAND_PHRASE + " Daniel Benson";
//        assertCommandSuccess(command, expectedModel);
//        assertSelectedCardUnchanged();
//
//        /* Case: find multiple persons in jxmusic book, 2 keywords with 1 repeat -> 2 persons found */
//        command = PlaylistSearchCommand.COMMAND_PHRASE + " Daniel Benson Daniel";
//        assertCommandSuccess(command, expectedModel);
//        assertSelectedCardUnchanged();
//
...
//         * -> 2 persons found
//         */
//        command = PlaylistSearchCommand.COMMAND_PHRASE + " Daniel Benson NonMatchingKeyWord";
//        assertCommandSuccess(command, expectedModel);
//        assertSelectedCardUnchanged();
//
...
//        executeCommand(PlaylistDelCommand.COMMAND_PHRASE + " 1");
...
//        command = PlaylistSearchCommand.COMMAND_PHRASE + " Daniel";
//        ModelHelper.setFilteredList(expectedModel, SFX);
//        assertCommandSuccess(command, expectedModel);
