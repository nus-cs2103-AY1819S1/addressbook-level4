...
public class FindPersonCommandByNameSystemTest extends AddressBookSystemTest {
    ...
    public void find() {
        ...
        command = FindPersonCommand.COMMAND_WORD + " n/" + " Daniel Benson";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find multiple persons in address book, 2 keywords with 1 repeat -> 2 persons found */
        command = FindPersonCommand.COMMAND_WORD + " n/" + " Daniel Benson Daniel";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
         ...
         * -> 2 persons found
         */
        command = FindPersonCommand.COMMAND_WORD + " n/" + " Daniel Benson NonMatchingKeyWord";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
        ...
        command = FindPersonCommand.COMMAND_WORD + " n/" + " MeIeR";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find person in address book, keyword is substring of name -> 0 persons found */
        command = FindPersonCommand.COMMAND_WORD + " n/" + " Mei";
        ...
        command = FindPersonCommand.COMMAND_WORD + " n/" + " Meiers";
        ModelHelper.setFilteredPersonList(expectedModel);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find person not in address book -> 0 persons found */
        command = FindPersonCommand.COMMAND_WORD + " n/" + " Mark";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find phone number of person in address book -> 0 persons found */
        command = FindPersonCommand.COMMAND_WORD + " n/" + " " + DANIEL.getPhone().value;
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find address of person in address book -> 0 persons found */
        command = FindPersonCommand.COMMAND_WORD + " n/" + " " + DANIEL.getAddress().value;
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find email of person in address book -> 0 persons found */
        command = FindPersonCommand.COMMAND_WORD + " n/" + " " + DANIEL.getEmail().value;
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find tags of person in address book -> 0 persons found */
        List<Tag> tags = new ArrayList<>(DANIEL.getTags());
        command = FindPersonCommand.COMMAND_WORD + " n/" + " " + tags.get(0).tagName;
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
        ...
        command = FindPersonCommand.COMMAND_WORD + " n/" + " Daniel";
        ModelHelper.setFilteredPersonList(expectedModel, DANIEL);
        assertCommandSuccess(command, expectedModel);
