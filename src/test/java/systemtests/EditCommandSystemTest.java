...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() {
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_AMY + EDUCATION_DESC_BOB + GRADES_DESC_BOB + TAG_DESC_FRIEND + TAG_DESC_HUSBAND;
        assertCommandFailure(command, EditCommand.MESSAGE_DUPLICATE_PERSON);
    ...
    private void assertCommandSuccess(String command, Model expectedModel, String expectedResultMessage,
        ...
        expectedModel.updateFilteredPersonList(PREDICATE_SHOW_ALL_PERSONS);
        assertApplicationDisplaysExpected(" edit  1   n/Bob Choo   p/22222222  e/bob@example.com   a/Block 123, Bobby Street 3   el/Secondary 3   g/Y1819S1_Mid 98  t/husband ", expectedResultMessage, expectedModel);
