...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() {
        ...
        String command = " " + EditCommand.COMMAND_WORD + "  " + index.getOneBased() + "  " + NAME_DESC_BOB + "  "
                + PHONE_DESC_BOB + " " + PRIORITY_VALUE_DESC_BOB + "  " + ADDRESS_DESC_BOB + " " + TAG_DESC_HUSBAND + " ";
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB + PRIORITY_VALUE_DESC_BOB
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_AMY + PHONE_DESC_BOB + PRIORITY_VALUE_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + TAG_DESC_HUSBAND;
         ...
         */
        index = INDEX_SECOND_TASK;
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_AMY + PRIORITY_VALUE_DESC_AMY
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + TAG_DESC_HUSBAND;
        editedPerson = new TaskBuilder(Z_TASK).withDueDate(VALID_DUEDATE_AMY).withPriorityValue(VALID_PRIORITY_VALUE_AMY)
                .build();
        assertCommandSuccess(command, index, editedPerson);
        ...
        /* Case: filtered person list, edit index within bounds of task manager and person list -> edited */
        ...
        /* Case: filtered person list, edit index within bounds of task manager but out of bounds of person list
         * -> rejected
         */
        showPersonsWithName(KEYWORD_MATCHING_TUTORIAL);
        ...
        index = INDEX_FIRST_TASK;
        selectPerson(index);
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_AMY + PHONE_DESC_AMY + PRIORITY_VALUE_DESC_AMY
        ...
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_TASK.getOneBased() + INVALID_PRIORITY_VALUE_DESC,
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_AMY + PRIORITY_VALUE_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + TAG_DESC_HUSBAND;
        assertCommandFailure(command, EditCommand.MESSAGE_DUPLICATE_TASK);

        /* Case: edit a person with new values same as another person's values but with different email -> rejected */
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB + PRIORITY_VALUE_DESC_AMY
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + TAG_DESC_HUSBAND;
        assertCommandFailure(command, EditCommand.MESSAGE_DUPLICATE_TASK);
    }
