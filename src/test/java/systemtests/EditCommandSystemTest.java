...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void editByName() {
        ...
        /* Case: edit a person with new values same as existing values -> edited */
        firstPerson = VALID_NAME_BOB; // first person's name is now Bob
         ...
         */
        index = INDEX_SECOND_PERSON;
        secondPerson = VALID_NAME_AMY; // Second person's name is now Amy, with every other field matching Bob's.
        ...
        /* Case: clear tags -> cleared */
        index = INDEX_FOURTH_PERSON;
        String fourthPerson = DANIEL.getName().toString();
        command = EditCommand.COMMAND_WORD + " " + fourthPerson + " " + PREFIX_TAG.getPrefix();
        Person personToEdit = getModel().getFilteredPersonList().get(index.getZeroBased());
        editedPerson = new PersonBuilder(personToEdit).withTags().build();
        assertCommandSuccess(command, index, editedPerson);
