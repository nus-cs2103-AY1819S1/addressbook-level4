...
//
//        /* --------------------- Performing edit operation
// while a carpark card is selected -------------------------- */
//
//        /* Case: selects first card in the carpark list,
// edit a carpark -> edited, card selection remains unchanged but
//         * browser url changes
//         */
//        showAllPersons();
//        index = INDEX_FIRST_PERSON;
...
//
//        /* Case: edit a carpark with new values same as
// another carpark's values but with different tags -> rejected */
//        command = EditCommand.COMMAND_WORD + " " +
// index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
...
//
//        /* Case: edit a carpark with new values same as
// another carpark's values but with different address -> rejected */
//        command = EditCommand.COMMAND_WORD + " " +
// index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
...
//
//        /* Case: edit a carpark with new values same as
// another carpark's values but with different phone -> rejected */
//        command = EditCommand.COMMAND_WORD + " " +
...
//
//        /* Case: edit a carpark with new values same as
// another carpark's values but with different email -> rejected */
//        command = EditCommand.COMMAND_WORD + " " +
