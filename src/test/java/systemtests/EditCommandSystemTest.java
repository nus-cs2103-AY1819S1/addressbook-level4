...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() {
        ...
        *//* Case: redo editing the last person in the list -> last person edited again *//*
        ...
        model.updatePerson(
                getModel().getFilteredPersonList().get(INDEX_FIRST_IMAGE.getZeroBased()), editedPerson);
        assertCommandSuccess(command, model, expectedResultMessage);
        ...
        *//* Case: missing all fields -> rejected *//*
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_IMAGE.getOneBased(),
                EditCommand.MESSAGE_NOT_EDITED);

        *//* Case: invalid name -> rejected *//*
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_IMAGE.getOneBased() + INVALID_NAME_DESC,
                Name.MESSAGE_NAME_CONSTRAINTS);

        *//* Case: invalid phone -> rejected *//*
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_IMAGE.getOneBased() + INVALID_PHONE_DESC,
                Phone.MESSAGE_PHONE_CONSTRAINTS);

        *//* Case: invalid email -> rejected *//*
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_IMAGE.getOneBased() + INVALID_EMAIL_DESC,
                Email.MESSAGE_EMAIL_CONSTRAINTS);

        *//* Case: invalid address -> rejected *//*
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_IMAGE.getOneBased() + INVALID_ADDRESS_DESC,
                Address.MESSAGE_ADDRESS_CONSTRAINTS);

        *//* Case: invalid tag -> rejected *//*
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_IMAGE.getOneBased() + INVALID_TAG_DESC,
        ...
        *//* Case: edit a person with new values same as another person's values but with different phone
        -> rejected *//*
