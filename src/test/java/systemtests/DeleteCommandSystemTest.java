...
public class DeleteCommandSystemTest extends AddressBookSystemTest {
    ...
    public void delete() {
        ...
        /* Case: filtered task list, delete index within bounds of task manager and task list -> deleted */
        ...
        /* Case: filtered task list, delete index within bounds of task manager but out of bounds of task list
         * -> rejected
         */
        showPersonsWithName(KEYWORD_MATCHING_TUTORIAL);
