...
public class DeleteCommandSystemTest extends AddressBookSystemTest {
    ...
    public void delete() {
        ...
        removeVolunteer(modelBeforeDeletingLast, lastPersonIndex);
        ...
        /* Case: delete the selected volunteer -> volunteer list panel selects the volunteer
            before the deleted volunteer */
        showAllVolunteers();
