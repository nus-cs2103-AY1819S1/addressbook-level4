...
public class DeleteCommandSystemTest extends AddressBookSystemTest {
    ...
    public void delete() {
        ...
        String expectedResultMessage = String.format(MESSAGE_DELETE_PERSON_SUCCESS, deletedRide);
        ...
        expectedResultMessage = String.format(MESSAGE_DELETE_PERSON_SUCCESS, deletedRide);
