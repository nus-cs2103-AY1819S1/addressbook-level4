...
import static seedu.modsuni.commons.core.Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX;
import static seedu.modsuni.commons.core.Messages.MESSAGE_UNKNOWN_COMMAND;
import static seedu.modsuni.logic.commands.DeleteCommand.MESSAGE_DELETE_PERSON_SUCCESS;
import static seedu.modsuni.testutil.TestUtil.getLastIndex;
import static seedu.modsuni.testutil.TestUtil.getMidIndex;
import static seedu.modsuni.testutil.TestUtil.getPerson;
...
public class DeleteCommandSystemTest extends ModsUniSystemTest {
    ...
    public void delete() {
        ...
        /* Case: filtered person list, delete index within bounds of modsuni book and person list -> deleted */
        showPersonsWithName(KEYWORD_MATCHING_MEIER);
        Index index = INDEX_FIRST_PERSON;
        assertTrue(index.getZeroBased() < getModel().getFilteredPersonList().size());
        assertCommandSuccess(index);

        /* Case: filtered person list, delete index within bounds of modsuni book but out of bounds of person list
         * -> rejected
         */
        showPersonsWithName(KEYWORD_MATCHING_MEIER);
    ...
    /**
     * Removes the {@code Person} at the specified {@code index} in {@code model}'s modsuni book.
     ...
     * {@code ModsUniSystemTest#assertApplicationDisplaysExpected(String, String, Model)}.
     ...
     * @see DeleteCommandSystemTest#assertCommandSuccess(String, Model, String)
     * @see ModsUniSystemTest#assertSelectedCardChanged(Index)
     */
    private void assertCommandSuccess(String command, Model expectedModel, String expectedResultMessage,
