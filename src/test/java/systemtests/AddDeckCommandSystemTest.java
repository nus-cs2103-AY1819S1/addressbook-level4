...
//import seedu.address.model.deck.Person;
//import seedu.address.model.tag.Tag;
//import seedu.address.testutil.DeckBuilder;
//import seedu.address.testutil.TestUtil;

public class AddDeckCommandSystemTest extends AnakinSystemTest {
...
// ----------------------------- */
//
//        /* Case: add a deck without tags to a non-empty address book, command with leading spaces and trailing
// spaces
//         * -> added
//         */
//        Person toAdd = AMY;
...
//        command = TestUtil.getAddCommand(toAdd);
//        assertCommandSuccess(command, toAdd);
//
...
//        command = TestUtil.getAddCommand(HOON);
...
//        command = TestUtil.getAddCommand(HOON) + " " + PREFIX_TAG.getPrefix() + "friends";
//        assertCommandFailure(command, AddCommand.MESSAGE_DUPLICATE_PERSON);
//
...
//        command = "adds " + TestUtil.getPersonDetails(toAdd);
...
//        assertCommandSuccess(TestUtil.getAddCommand(toAdd), toAdd);
//    }
//
//    /**
