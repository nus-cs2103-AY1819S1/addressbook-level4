...
public class SelectCommandSystemTest extends AddressBookSystemTest {
    ...
    public void select() {
        ...
        /* Case: filtered playlist list, select index within bounds of address book but out of bounds of playlist list
         * -> rejected
         */
        ...
        /* Case: filtered playlist list, select index within bounds of address book and playlist list -> selected */
