...
public class SelectCommandSystemTest extends MeaningBookSystemTest {
    @Test
    public void select() {
        ...
        /* Case: filtered word list, select index within bounds of address book but out of bounds of word list
         * -> rejected
         */
        ...
        /* Case: filtered word list, select index within bounds of address book and word list -> selected */
