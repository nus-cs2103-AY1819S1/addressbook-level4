...
import static seedu.modsuni.logic.commands.SelectCommand.MESSAGE_SELECT_PERSON_SUCCESS;
...
public class SelectCommandSystemTest extends ModsUniSystemTest {
    @Test
    @Ignore
    public void select() {
        ...
        /* Case: filtered person list, select index within bounds of modsuni book but out of bounds of person list
         * -> rejected
         */
        ...
        /* Case: filtered person list, select index within bounds of modsuni book and person list -> selected */
        ...
        /* Case: select from empty modsuni book -> rejected */
        deleteAllPersons();
