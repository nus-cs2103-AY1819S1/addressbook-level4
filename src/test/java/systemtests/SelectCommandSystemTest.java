...
public class SelectCommandSystemTest extends ClinicIoSystemTest {
    @Test
    public void select() {
        ...
        /* Case: filtered person list, select index within bounds of ClinicIO but out of bounds of person list
         * -> rejected
         */
        ...
        /* Case: filtered person list, select index within bounds of ClinicIO and person list -> selected */
     ...
     * @see ClinicIoSystemTest#assertSelectedCardChanged(Index)
     */
