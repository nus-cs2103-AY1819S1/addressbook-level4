...
public class ClearCommandSystemTest extends AnakinSystemTest {

    @Test
    public void clear() {
        final Model defaultModel = getModel();

        /* Case: clear non-empty anakin, command with leading spaces and trailing alphanumeric characters and
         * spaces -> cleared
         */
