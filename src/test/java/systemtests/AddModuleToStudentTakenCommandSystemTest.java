...
import seedu.modsuni.logic.commands.AddModuleToStudentTakenCommandTest;
...
public class AddModuleToStudentTakenCommandSystemTest extends ModsUniSystemTest {
    ...
    public void addModuleT() {
        ...
        String command = AddModuleToStudentTakenCommand.COMMAND_WORD + CODE_DESC_ACC1002;
        String expectedResultMessage = AddModuleToStudentTakenCommandTest
        ...
        /* Case: add a single module into staged module list, command stars with spaces
         * -> added as expected
         */

        executeCommand(RemoveModuleFromStudentTakenCommand.COMMAND_WORD + CODE_DESC_ACC1002);
        toAdd = ACC1002;
        command = "       " + AddModuleToStudentTakenCommand.COMMAND_WORD + CODE_DESC_ACC1002;
        expectedResultMessage = AddModuleToStudentTakenCommandTest
                .createCommandResult(EMPTY, EMPTY, EMPTY, EMPTY, " " + toAdd.getCode().code);
         ...
         */
        command = AddModuleToStudentTakenCommand.COMMAND_WORD + CODE_DESC_ACC1002 + CODE_DESC_ACC1002X
        ...
        executeCommand(RemoveModuleFromStudentStagedCommand.COMMAND_WORD + CODE_DESC_ACC1002X);

        command = AddModuleToStudentTakenCommand.COMMAND_WORD + CODE_DESC_LOWER_ACC1002X;
        ...
        command = AddModuleToStudentTakenCommand.COMMAND_WORD + CODE_DESC_ACC1002;
        assertCommandFailure(command, AddModuleToStudentTakenCommand.MESSAGE_NOT_LOGIN);
        ...
        command = AddModuleToStudentTakenCommand.COMMAND_WORD + CODE_DESC_ACC1002;
        assertCommandFailure(command, AddModuleToStudentTakenCommand.MESSAGE_NOT_STUDENT);
