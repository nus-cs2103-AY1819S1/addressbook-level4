...
import static seedu.address.logic.commands.personcommands.SelectUserCommand.MESSAGE_SELECT_PERSON_SUCCESS;
...
public class SelectUserCommandSystemTest extends AddressBookSystemTest {
    @Test
    public void select() {
        ...
        command = SelectUserCommand.COMMAND_WORD + " " + personCount.getOneBased();
        ...
        command = SelectUserCommand.COMMAND_WORD + " " + middleIndex.getOneBased();
        ...
        assertCommandFailure(SelectUserCommand.COMMAND_WORD + " "
        ...
        command = SelectUserCommand.COMMAND_WORD + " " + validIndex.getOneBased();
        assertCommandSuccess(command, validIndex);

        /* ----------------------------------- Perform invalid select operations ------------------------------------ */

        /* Case: invalid index (0) -> rejected */
        assertCommandFailure(SelectUserCommand.COMMAND_WORD + " " + 0,
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, SelectUserCommand.MESSAGE_USAGE));

        /* Case: invalid index (-1) -> rejected */
        assertCommandFailure(SelectUserCommand.COMMAND_WORD + " " + -1,
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, SelectUserCommand.MESSAGE_USAGE));

        /* Case: invalid index (size + 1) -> rejected */
        invalidIndex = getModel().getFilteredPersonList().size() + 1;
        assertCommandFailure(SelectUserCommand.COMMAND_WORD + " " + invalidIndex,
                MESSAGE_INVALID_PERSON_DISPLAYED_INDEX);

        /* Case: invalid arguments (alphabets) -> rejected */
        assertCommandFailure(SelectUserCommand.COMMAND_WORD + " abc",
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, SelectUserCommand.MESSAGE_USAGE));

        /* Case: invalid arguments (extra argument) -> rejected */
        assertCommandFailure(SelectUserCommand.COMMAND_WORD + " 1 abc",
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, SelectUserCommand.MESSAGE_USAGE));
        ...
        deleteAllPersons();
        assertCommandFailure(SelectUserCommand.COMMAND_WORD + " " + INDEX_FIRST.getOneBased(),
                MESSAGE_INVALID_PERSON_DISPLAYED_INDEX);
    }
