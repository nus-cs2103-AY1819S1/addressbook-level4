...
public class TestApp extends MainApp {
    ...
    protected Supplier<ReadOnlyMeetingBook> initialDataSupplier = () -> null;
    protected Path saveFileLocation = SAVE_LOCATION_FOR_TESTING;

    public TestApp() {
    }

    public TestApp(Supplier<ReadOnlyMeetingBook> initialDataSupplier, Path saveFileLocation) {
        super();
        ...
        if (initialDataSupplier.get() != null) {
            createDataFileWithData(new XmlSerializableMeetingBook(this.initialDataSupplier.get()),
