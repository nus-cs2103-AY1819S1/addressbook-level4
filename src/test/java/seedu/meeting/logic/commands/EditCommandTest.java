...
import static seedu.meeting.logic.commands.CommandTestUtil.DESC_AMY;
...
public class EditCommandTest {
    ...
    public void execute_duplicatePersonFilteredList_failure() {
        ...
        // edit person in filtered list into a duplicate in MeetingBook
        Person personInList = model.getMeetingBook().getPersonList().get(INDEX_SECOND_PERSON.getZeroBased());
        EditCommand editCommand = new EditCommand(INDEX_FIRST_PERSON,
     ...
     * but smaller than size of MeetingBook
     */
    @Test
    public void execute_invalidPersonIndexFilteredList_failure() {
        ...
        assertTrue(outOfBoundIndex.getZeroBased() < model.getMeetingBook().getPersonList().size());
    ...
    public void executeUndoRedo_validIndexUnfilteredList_success() throws Exception {
        ...
        // undo -> reverts MeetingBook back to previous state and filtered person list to show all persons
    ...
    public void executeUndoRedo_invalidIndexUnfilteredList_failure() {
        ...
        // execution failed -> MeetingBook state not added into model
        assertCommandFailure(editCommand, model, commandHistory, Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX);

        // single MeetingBook state in model -> undoCommand and redoCommand fail
