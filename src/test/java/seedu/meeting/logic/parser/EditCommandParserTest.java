...
import static seedu.meeting.logic.commands.CommandTestUtil.INVALID_GROUPTAG_DESC;
...
import static seedu.meeting.logic.commands.CommandTestUtil.TAG_DESC_PROJECT;
import static seedu.meeting.logic.commands.CommandTestUtil.VALID_ADDRESS_AMY;
import static seedu.meeting.logic.commands.CommandTestUtil.VALID_ADDRESS_BOB;
import static seedu.meeting.logic.commands.CommandTestUtil.VALID_EMAIL_AMY;
...
import static seedu.meeting.logic.commands.CommandTestUtil.VALID_NAME_AMY;
import static seedu.meeting.logic.commands.CommandTestUtil.VALID_PHONE_AMY;
import static seedu.meeting.logic.commands.CommandTestUtil.VALID_PHONE_BOB;
import static seedu.meeting.logic.commands.CommandTestUtil.VALID_TAG_FRIEND;
...
public class EditCommandParserTest {
    ...
    private static final String GROUPTAG_EMPTY = " " + PREFIX_GROUPTAG;
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_GROUPTAG_DESC, Tag.MESSAGE_TAG_CONSTRAINTS); // invalid group tag
        ...
        // while parsing {@code PREFIX_GROUPTAG} alone will reset the tags of the {@code Person} being edited,
        // parsing it together with a valid tag results in error
        assertParseFailure(parser, "1" + TAG_DESC_CCA + TAG_DESC_PROJECT + GROUPTAG_EMPTY, Tag.MESSAGE_TAG_CONSTRAINTS);
        assertParseFailure(parser, "1" + TAG_DESC_PROJECT + GROUPTAG_EMPTY + TAG_DESC_CCA, Tag.MESSAGE_TAG_CONSTRAINTS);
        assertParseFailure(parser, "1" + GROUPTAG_EMPTY + TAG_DESC_CCA + TAG_DESC_PROJECT, Tag.MESSAGE_TAG_CONSTRAINTS);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FRIEND + TAG_DESC_CCA;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).withGroupTags(VALID_GROUPTAG_CCA).build();
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // group tags
        userInput = targetIndex.getOneBased() + TAG_DESC_PROJECT;
        descriptor = new EditPersonDescriptorBuilder().withGroupTags(VALID_GROUPTAG_PROJECT).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
                ...
                + PHONE_DESC_BOB + ADDRESS_DESC_BOB + EMAIL_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_PROJECT
                + TAG_DESC_CCA;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_PHONE_BOB)
                .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .withGroupTags(VALID_GROUPTAG_CCA, VALID_GROUPTAG_PROJECT).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
