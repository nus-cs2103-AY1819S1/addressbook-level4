package seedu.parking.commons.core.index;
...
public class IndexTest {
    ...
    @Test
    public void equals() {
        final Index fifthCarparkIndex = Index.fromOneBased(5);

        // same values -> returns true
        assertTrue(fifthCarparkIndex.equals(Index.fromOneBased(5)));
        assertTrue(fifthCarparkIndex.equals(Index.fromZeroBased(4)));

        // same object -> returns true
        assertTrue(fifthCarparkIndex.equals(fifthCarparkIndex));

        // null -> returns false
        assertFalse(fifthCarparkIndex.equals(null));

        // different types -> returns false
        assertFalse(fifthCarparkIndex.equals(5.0f));

        // different index -> returns false
        assertFalse(fifthCarparkIndex.equals(Index.fromOneBased(1)));
    }
}
