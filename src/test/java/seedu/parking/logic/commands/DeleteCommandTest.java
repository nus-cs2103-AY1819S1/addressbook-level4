...
public class DeleteCommandTest {
    ...
    public void execute_invalidIndexFilteredList_throwsCommandException() {
        ...
        // ensures that outOfBoundIndex is still in bounds of parking book list
    ...
    public void executeUndoRedo_invalidIndexUnfilteredList_failure() {
        ...
        // execution failed -> parking book state not added into model
        assertCommandFailure(deleteCommand, model, commandHistory, Messages.MESSAGE_INVALID_CARPARK_DISPLAYED_INDEX);

        // single parking book state in model -> undoCommand and redoCommand fail
