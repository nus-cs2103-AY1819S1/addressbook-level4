...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        ...
        assertCommandException(deleteCommand, MESSAGE_INVALID_WORDS_DISPLAYED_INDEX);
    ...
    public void getFilteredWordList_modifyList_throwsUnsupportedOperationException() {
        ...
        logic.getFilteredWordList().remove(0);
    }
     ...
     *      - {@code expectedModel}'s learnvocabulary book was saved to the storage file.
     */
