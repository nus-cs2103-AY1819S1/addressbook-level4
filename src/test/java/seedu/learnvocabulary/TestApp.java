...
public class TestApp extends MainApp {
    ...
    protected Supplier<ReadOnlyLearnVocabulary> initialDataSupplier = () -> null;
    protected Path saveFileLocation = SAVE_LOCATION_FOR_TESTING;

    public TestApp() {
    }

    public TestApp(Supplier<ReadOnlyLearnVocabulary> initialDataSupplier, Path saveFileLocation) {
        super();
        ...
        if (initialDataSupplier.get() != null) {
            createDataFileWithData(new XmlSerializableLearnVocabulary(this.initialDataSupplier.get()),
    ...
    protected UserPrefs initPrefs(UserPrefsStorage storage) {
        ...
        userPrefs.setLearnVocabularyFilePath(saveFileLocation);
        return userPrefs;
    }

    /**
     * Returns a defensive copy of the learnvocabulary book data stored inside the storage file.
     */
    public LearnVocabulary readStorageLearnVocabulary() {
        try {
            return new LearnVocabulary(storage.readLearnVocabulary().get());
        } catch (DataConversionException dce) {
            throw new AssertionError("Data is not in the LearnVocabulary format.", dce);
    ...
    public Path getStorageSaveLocation() {
        return storage.getLearnVocabularyFilePath();
    }
    ...
    public Model getModel() {
        Model copy = new ModelManager((model.getLearnVocabulary()), new UserPrefs());
        ModelHelper.setFilteredList(copy, model.getFilteredWordList());
        return copy;
    }
