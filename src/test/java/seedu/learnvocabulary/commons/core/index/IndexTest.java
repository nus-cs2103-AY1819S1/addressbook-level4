package seedu.learnvocabulary.commons.core.index;
...
public class IndexTest {
    ...
    @Test
    public void equals() {
        final Index fifthWordIndex = Index.fromOneBased(5);

        // same values -> returns true
        assertTrue(fifthWordIndex.equals(Index.fromOneBased(5)));
        assertTrue(fifthWordIndex.equals(Index.fromZeroBased(4)));

        // same object -> returns true
        assertTrue(fifthWordIndex.equals(fifthWordIndex));

        // null -> returns false
        assertFalse(fifthWordIndex.equals(null));

        // different types -> returns false
        assertFalse(fifthWordIndex.equals(5.0f));

        // different index -> returns false
        assertFalse(fifthWordIndex.equals(Index.fromOneBased(1)));
    }
}
