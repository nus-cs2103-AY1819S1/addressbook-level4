...
public class StatusBarFooterTest extends GuiUnitTest {
    ...
    private static final AppContentChangedEvent EVENT_STUB = new AppContentChangedEvent(new AppContent());
    ...
    /**
     * Asserts that the saveAppContent location matches that of {@code expectedSaveLocation}, and the
