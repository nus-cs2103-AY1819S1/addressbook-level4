...
public class XmlAdaptedRecipeTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        XmlAdaptedRecipe recipe =
                new XmlAdaptedRecipe(INVALID_NAME, VALID_DIFFICULTY, VALID_COOKTIME, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        XmlAdaptedRecipe recipe = new XmlAdaptedRecipe(null, VALID_DIFFICULTY, VALID_COOKTIME, VALID_TAGS);
    ...
    public void toModelType_invalidDifficulty_throwsIllegalValueException() {
        XmlAdaptedRecipe recipe =
                new XmlAdaptedRecipe(VALID_NAME, INVALID_DIFFICULTY, VALID_COOKTIME, VALID_TAGS);
    ...
    public void toModelType_nullDifficulty_throwsIllegalValueException() {
        XmlAdaptedRecipe recipe = new XmlAdaptedRecipe(VALID_NAME, null, VALID_COOKTIME, VALID_TAGS);
    ...
    public void toModelType_invalidCooktime_throwsIllegalValueException() {
        XmlAdaptedRecipe recipe =
                new XmlAdaptedRecipe(VALID_NAME, VALID_DIFFICULTY, INVALID_COOKTIME, VALID_TAGS);
    ...
    public void toModelType_nullCooktime_throwsIllegalValueException() {
        XmlAdaptedRecipe recipe = new XmlAdaptedRecipe(VALID_NAME, VALID_DIFFICULTY, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        XmlAdaptedRecipe recipe =
                new XmlAdaptedRecipe(VALID_NAME, VALID_DIFFICULTY, VALID_COOKTIME, invalidTags);
