...
public class TypicalPatientsAndDoctors {
    ...
    // Manually added
    public static final Patient HOON_PATIENT = new PatientBuilder()
            .withName("Hoon Meier")
            .withPhone("8482424")
            ...
            .withTags("Patient")
            .withMedicalHistory("", "").build();
    public static final Patient IDA_PATIENT = new PatientBuilder()
    ...
    public static final Patient AMY_PATIENT = new PatientBuilder().withName(VALID_NAME_AMY)
