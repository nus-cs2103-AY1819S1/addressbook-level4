...
public class TypicalPersons {
    ...
    public static final Patient BENSON = new PersonBuilder().withName("Benson Meier").withIcNumber("S1234567X")
            ...
            .withMedicalRecord("A+").build();
    public static final Patient CARL = new PersonBuilder().withName("Carl Kurz").withIcNumber("S1234567X").withPhone("95352563")
            .withEmail("heinz@example.com").withAddress("wall street")
            .withMedicalRecord("A+").build();
    public static final Patient DANIEL = new PersonBuilder().withName("Daniel Meier").withIcNumber("S1234567X").withPhone("87652533")
            .withEmail("cornelia@example.com").withAddress("10th street").withTags("friends").withMedicalRecord("A+").build();
    public static final Patient ELLE = new PersonBuilder().withName("Elle Meyer").withIcNumber("S1234567X").withPhone("9482224")
            .withEmail("werner@example.com").withAddress("michegan ave").withMedicalRecord("A+").build();
    public static final Patient FIONA = new PersonBuilder().withName("Fiona Kunz").withIcNumber("S1234567X").withPhone("9482427")
            .withEmail("lydia@example.com").withAddress("little tokyo").withMedicalRecord("A+").build();
    public static final Patient GEORGE = new PersonBuilder().withName("George Best").withIcNumber("S1234567X").withPhone("9482442")
    ...
    public static final Patient AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY).withIcNumber(VALID_ICNUMBER_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND).build();
    public static final Patient BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB).withIcNumber(VALID_ICNUMBER_BOB)
