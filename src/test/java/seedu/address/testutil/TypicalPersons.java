...
public class TypicalPersons {
    ...
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131").withGrades("99")
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            ...
            .withGrades(VALID_GRADES_AMY).withTime(VALID_TIME_AMY).withTags(VALID_TAG_FRIEND).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withEducation(VALID_EDUCATION_BOB)
            .withGrades(VALID_GRADES_BOB).withTime(VALID_TIME_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND)
            .build();
