...
public class TypicalTasks {
    ...
    public static final Task B_TASK = new TaskBuilder().withName("Benson Meier")
            ...
            .withPriorityValue("johnd@example.com").withDueDate("02-12-18")
    ...
    public static final Task F_TASK = new TaskBuilder().withName("Fiona Kunz").withDueDate("06-12-18")
    ...
    // Manually added
    public static final Task H_TASK = new TaskBuilder().withName("Hoon Meier").withDueDate("08-12-18")
