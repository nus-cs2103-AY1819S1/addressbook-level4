...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        ...
        assertCommandException(deleteCommand, MESSAGE_INVALID_ARTICLE_DISPLAYED_INDEX);
    ...
    public void getFilteredArticleList_modifyList_throwsUnsupportedOperationException() {
        ...
        logic.getFilteredArticleList().remove(0);
    }
     ...
     *      - {@code expectedModel}'s article list was saved to the storage file.
     */
