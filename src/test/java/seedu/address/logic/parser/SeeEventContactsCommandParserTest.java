...
public class SeeEventContactsCommandParserTest {
    private SeeEventContactsCommandParser parser = new SeeEventContactsCommandParser();
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + EVENT_DATE_DESC_DOCTORAPPT + EVENT_FIRST_INDEX_DESC,
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, SeeEventContactsCommand.MESSAGE_USAGE));
    }
}
