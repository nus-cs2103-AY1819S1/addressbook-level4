...
public class ArgumentTokenizerTest {
    ...
    private final Prefix pSlash = new Prefix("t/");
    ...
    public void tokenize_noPrefixes_allTakenAsPreamble() {
        String argsString = "  some random string /l label with leading and trailing spaces ";
    ...
    public void tokenize_multipleArguments() {
        ...
        String argsString = "SomePreambleString -t dashT-Value t/pSlash value";
        ...
        argsString = "Different Preamble String ^Q111 -t dashT-Value t/pSlash value";
    ...
    public void tokenize_multipleArgumentsWithRepeats() {
        ...
        String argsString = "SomePreambleString -t dashT-Value ^Q ^Q -t another dashT value t/ pSlash value -t";
        ArgumentMultimap argMultimap = ArgumentTokenizer.tokenize(argsString, pSlash, dashT, hatQ);
        assertPreamblePresent(argMultimap, "SomePreambleString");
        assertArgumentPresent(argMultimap, pSlash, "pSlash value");
    ...
    public void tokenize_multipleArgumentsJoined() {
        String argsString = "SomePreambleStringt/ pSlash joined-tjoined -t not joined^Qjoined";
        ArgumentMultimap argMultimap = ArgumentTokenizer.tokenize(argsString, pSlash, dashT, hatQ);
        assertPreamblePresent(argMultimap, "SomePreambleStringt/ pSlash joined-tjoined");
        assertArgumentAbsent(argMultimap, pSlash);
