...
public class AddressBookParserTest {
    ...
    public void parseCommand_add() throws Exception {
        ...
        AddCommand command = (AddCommand) parser.parseCommand(ArticleUtil.getAddCommand(article));
        assertEquals(new AddCommand(article), command);
    }
    ...
    public void parseCommand_delete() throws Exception {
        DeleteCommand command = (DeleteCommand) parser.parseCommand(
                DeleteCommand.COMMAND_WORD + " " + INDEX_FIRST_ARTICLE.getOneBased());
        assertEquals(new DeleteCommand(INDEX_FIRST_ARTICLE), command);
    }

    @Test
    public void parseCommand_edit() throws Exception {
        Article article = new ArticleBuilder().build();
        EditArticleDescriptor descriptor = new EditArticleDescriptorBuilder(article).build();
    ...
    public void parseCommand_select() throws Exception {
        SelectCommand command = (SelectCommand) parser.parseCommand(
                SelectCommand.COMMAND_WORD + " " + INDEX_FIRST_ARTICLE.getOneBased());
        assertEquals(new SelectCommand(INDEX_FIRST_ARTICLE), command);
    }
