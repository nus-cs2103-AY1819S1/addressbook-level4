 ...
 * outside of the DeleteUserCommand code. For example, inputs "1" and "1 abc" take the
 * same path through the DeleteUserCommand, and therefore we test only one of them.
...
public class DeleteUserCommandParserTest {
    ...
    public void parse_validArgs_returnsDeleteCommand() {
        assertParseSuccess(parser, "1", new DeleteUserCommand(INDEX_FIRST));
    }
