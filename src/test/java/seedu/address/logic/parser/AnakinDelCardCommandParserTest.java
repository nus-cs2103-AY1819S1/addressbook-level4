...
import seedu.address.logic.anakinparser.AnakinDelCardCommandParser;
 ...
 */
public class AnakinDelCardCommandParserTest {

    private AnakinDelCardCommandParser parser = new AnakinDelCardCommandParser();

    @Test
    public void parse_validArgs_returnsDeleteCommand() {
        assertParseSuccess(parser, "1", new AnakinDelCardCommand(INDEX_FIRST_CARD));
    }
