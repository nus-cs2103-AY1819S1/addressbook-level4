...
public class AddVolunteerCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_VOLUNTEER_DESC_BOB
                ...
                + EMAIL_VOLUNTEER_DESC_BOB + ADDRESS_VOLUNTEER_DESC_BOB + TAG_VOLUNTEER_DESC_FRIEND, new AddVolunteerCommand(expectedVolunteer));
        ...
        Volunteer expectedVolunteerMultipleTags = new VolunteerBuilder(BOB).withTags(VALID_VOLUNTEER_TAG_FRIEND, VALID_VOLUNTEER_TAG_HUSBAND)
                .build();
        assertParseSuccess(parser, NAME_VOLUNTEER_DESC_BOB + GENDER_DESC_BOB + BIRTHDAY_DESC_BOB
                + PHONE_VOLUNTEER_DESC_BOB + EMAIL_VOLUNTEER_DESC_BOB + ADDRESS_VOLUNTEER_DESC_BOB
                + TAG_VOLUNTEER_DESC_HUSBAND + TAG_VOLUNTEER_DESC_FRIEND, new AddVolunteerCommand(expectedVolunteerMultipleTags));
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_VOLUNTEER_DESC_BOB + GENDER_DESC_BOB + BIRTHDAY_DESC_BOB
                        + PHONE_VOLUNTEER_DESC_BOB + EMAIL_VOLUNTEER_DESC_BOB
