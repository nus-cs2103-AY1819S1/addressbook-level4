...
public class FindUserCommandParserTest {
    ...
    public void parse_validArgs() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + "\t\t" + PHONE_DESC_BOB + "\t"
                + EMAIL_DESC_BOB + "\t" + ADDRESS_DESC_BOB + "\t" + INTEREST_DESC_STUDY + "\t" + TAG_DESC_FRIEND,
        ...
        interestsKeywordList = Arrays.asList("study", "play");
        predicate =
                new UserContainsKeywordsPredicate(nameKeywordList,
                        phoneKeywordList,
                        addressKeywordList,
                        ...
                        tagsKeywordList);
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + " i/study play" + TAG_DESC_FRIEND, new FindUserCommand(predicate));

        tagsKeywordList = Arrays.asList("husband", "friend");
        predicate =
                new UserContainsKeywordsPredicate(nameKeywordList,
                        phoneKeywordList,
                        addressKeywordList,
                        ...
                        tagsKeywordList);
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + " i/study play" + " t/husband friend", new FindUserCommand(predicate));
    }
    ...
    public void parseFieldMissing_returnsFindUserCommand() {
        ...
        // missing name
        UserContainsKeywordsPredicate predicate =
                new UserContainsKeywordsPredicate(null,
                        phoneKeywordList,
                        addressKeywordList,
                        emailKeywordList,
                        interestsKeywordList,
        ...
        // missing phone
        predicate = new UserContainsKeywordsPredicate(nameKeywordList,
                        null,
                        addressKeywordList,
                        emailKeywordList,
                        interestsKeywordList,
        ...
        // missing tags
        predicate = new UserContainsKeywordsPredicate(null,
                        phoneKeywordList,
                        addressKeywordList,
                        emailKeywordList,
                        interestsKeywordList,
