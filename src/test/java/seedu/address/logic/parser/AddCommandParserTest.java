...
public class AddCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + GENDER_DESC_BOB + BIRTHDAY_DESC_BOB
                + INVALID_VOLUNTEER_PHONE_DESC + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_DRIVER + TAG_DESC_STUDENT, Phone.MESSAGE_PHONE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + GENDER_DESC_BOB + BIRTHDAY_DESC_BOB
                + PHONE_DESC_BOB + INVALID_VOLUNTEER_EMAIL_DESC + ADDRESS_DESC_BOB
                + TAG_DESC_DRIVER + TAG_DESC_STUDENT, Email.MESSAGE_EMAIL_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, NAME_DESC_BOB + GENDER_DESC_BOB + BIRTHDAY_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_VOLUNTEER_ADDRESS_DESC
                + TAG_DESC_DRIVER + TAG_DESC_STUDENT, Address.MESSAGE_ADDRESS_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + GENDER_DESC_BOB + BIRTHDAY_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_VOLUNTEER_TAG_DESC + VALID_TAG_STUDENT, Tag.MESSAGE_TAG_CONSTRAINTS);
