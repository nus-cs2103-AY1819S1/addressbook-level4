...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        CalendarEvent expectedCalendarEvent = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND).build();

        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedCalendarEvent));
        ...
        CalendarEvent expectedCalendarEventMultipleTags = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        CalendarEvent expectedCalendarEvent = new PersonBuilder(AMY).withTags().build();
