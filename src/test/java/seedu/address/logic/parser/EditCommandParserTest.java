...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditRecipeDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        EditRecipeDescriptor descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_PHONE_BOB)
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        ...
        EditCommand.EditRecipeDescriptor descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_PHONE_BOB)
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        EditCommand.EditRecipeDescriptor descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_PHONE_BOB).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_resetTags_success() {
        ...
        EditRecipeDescriptor descriptor = new EditPersonDescriptorBuilder().withTags().build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
