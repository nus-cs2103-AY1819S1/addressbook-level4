...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_VOLUNTEER_PHONE_DESC + EMAIL_DESC_AMY,
                Phone.MESSAGE_PHONE_CONSTRAINTS);

        // valid phone followed by invalid phone. The test case for invalid phone followed by valid phone
        // is tested at {@code parse_invalidValueFollowedByValidValue_success()}
        assertParseFailure(parser, "1" + PHONE_DESC_BOB + INVALID_VOLUNTEER_PHONE_DESC,
                Phone.MESSAGE_PHONE_CONSTRAINTS);
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        Index targetIndex = INDEX_FIRST_VOLUNTEER;
        String userInput = targetIndex.getOneBased() + INVALID_VOLUNTEER_PHONE_DESC + PHONE_DESC_BOB;
        EditVolunteerDescriptor descriptor = new EditVolunteerDescriptorBuilder()
        ...
        userInput = targetIndex.getOneBased() + EMAIL_DESC_BOB + INVALID_VOLUNTEER_PHONE_DESC
