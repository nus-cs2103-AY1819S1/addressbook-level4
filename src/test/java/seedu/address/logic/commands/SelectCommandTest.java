...
public class SelectCommandTest {
    ...
    public void execute_invalidIndexFilteredList_failure() {
        ...
        assertTrue(outOfBoundsIndex.getZeroBased() < model.getAddressBook()
    ...
    @Test
    public void equals() {
        SelectCommand selectFirstCommand = new SelectCommand(INDEX_FIRST_VOLUNTEER);
        SelectCommand selectSecondCommand = new SelectCommand(INDEX_SECOND_VOLUNTEER);

        // same object -> returns true
        assertTrue(selectFirstCommand.equals(selectFirstCommand));

        // same values -> returns true
        SelectCommand selectFirstCommandCopy = new SelectCommand(INDEX_FIRST_VOLUNTEER);
    ...
    private void assertExecutionSuccess(Index index) {
        ...
        String expectedMessage = String.format(SelectCommand.MESSAGE_SELECT_VOLUNTEER_SUCCESS,
                index.getOneBased());

        assertCommandSuccess(selectCommand, model, commandHistory, expectedMessage,
                expectedModel);
