...
public class AddressbookAddCommandTest {
    ...
    @Test
    public void equals() {
        Person alice = new AddressbookPersonBuilder().withName("Alice").build();
        Person bob = new AddressbookPersonBuilder().withName("Bob").build();
