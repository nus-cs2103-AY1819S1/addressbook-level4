...
/**
 * Contains integration tests (interaction with the Model, UndoCommand and RedoCommand) and unit tests for LeaveApproveCommand.
 */
public class LeaveApproveCommandTest {
    ...
    public void execute_allFieldsSpecifiedUnfilteredList_success() {
        ...
        List<LeaveApplication> leaveApplications = new ArrayList<>(Arrays.asList(leaveApplication));
        Person editedPerson = new PersonBuilder().withLeaveApplications(leaveApplications).build();
        ...
        String originalUsername = model.getFilteredPersonList().get(INDEX_FIRST_PERSON.getZeroBased())
                .getUsername().username;
        String originalPassword = model.getFilteredPersonList().get(INDEX_FIRST_PERSON.getZeroBased())
...
//        LeaveApproveCommand editCommand = new LeaveApproveCommand(indexLastPerson, descriptor);
//
//        String expectedMessage = String.format(LeaveApproveCommand.MESSAGE_EDIT_PERSON_SUCCESS, editedPerson);
//
//        Model expectedModel = new ModelManager(new AddressBook(model.getAddressBook()),
//                model.getArchiveList(), new UserPrefs());
...
//        LeaveApproveCommand editCommand = new LeaveApproveCommand(INDEX_FIRST_PERSON, new EditPersonDescriptor());
...
//        LeaveApproveCommand editCommand = new LeaveApproveCommand(INDEX_FIRST_PERSON,
...
//        LeaveApproveCommand editCommand = new LeaveApproveCommand(INDEX_SECOND_PERSON, descriptor);
//
//        assertCommandFailure(editCommand, model, commandHistory, LeaveApproveCommand.MESSAGE_DUPLICATE_PERSON);
//    }
//
//    @Test
...
//        LeaveApproveCommand editCommand = new LeaveApproveCommand(outOfBoundIndex, descriptor);
//
...
//        LeaveApproveCommand editCommand = new LeaveApproveCommand(INDEX_FIRST_PERSON, descriptor);
//        Model expectedModel = new ModelManager(new AddressBook(model.getAddressBook()),
//                model.getArchiveList(), new UserPrefs());
...
//    @Test
//    public void equals() {
//        final LeaveApproveCommand standardCommand = new LeaveApproveCommand(INDEX_FIRST_PERSON, DESC_AMY);
//
//        // same values -> returns true
//        EditPersonDescriptor copyDescriptor = new EditPersonDescriptor(DESC_AMY);
//        LeaveApproveCommand commandWithSameValues = new LeaveApproveCommand(INDEX_FIRST_PERSON, copyDescriptor);
...
//        assertFalse(standardCommand.equals(new LeaveApproveCommand(INDEX_SECOND_PERSON, DESC_AMY)));
//
//        // different descriptor -> returns false
//        assertFalse(standardCommand.equals(new LeaveApproveCommand(INDEX_FIRST_PERSON, DESC_BOB)));
//    }
