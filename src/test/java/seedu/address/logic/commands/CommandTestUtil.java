...
public class CommandTestUtil {
    ...
    public static final String ADDRESS_DESC_AMY = " " + PREFIX_ROOM + VALID_ROOM_AMY;
    public static final String ADDRESS_DESC_BOB = " " + PREFIX_ROOM + VALID_ROOM_BOB;
    public static final String TAG_DESC_FRIEND = " " + PREFIX_TAG + VALID_TAG_AMY;
    public static final String TAG_DESC_HUSBAND = " " + PREFIX_TAG + VALID_TAG_BOB;

    public static final String INVALID_NAME_DESC = " " + PREFIX_NAME + "James&"; // '&' not allowed in names
    public static final String INVALID_PHONE_DESC = " " + PREFIX_PHONE + "911a"; // 'a' not allowed in phones
    public static final String INVALID_EMAIL_DESC = " " + PREFIX_EMAIL + "bob!yahoo"; // missing '@' symbol
    public static final String INVALID_ADDRESS_DESC = " " + PREFIX_ROOM; // empty string not allowed for addresses
