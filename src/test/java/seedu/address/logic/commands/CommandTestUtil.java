...
public class CommandTestUtil {
    ...
    public static final String INVALID_CATEGORY_DESC = " " + PREFIX_CATEGORY + "911a"; // 'a' not allowed in phones
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_CATEGORY_AMY).withCost(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_CATEGORY_BOB).withCost(VALID_ADDRESS_BOB)
