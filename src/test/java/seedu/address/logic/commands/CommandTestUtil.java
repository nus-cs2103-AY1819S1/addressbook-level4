...
public class CommandTestUtil {
    ...
    public static final String INVALID_VOLUNTEER_PHONE_DESC = " " + PREFIX_PHONE + "911a";
    // 'a' not allowed in phones
    public static final String INVALID_VOLUNTEER_EMAIL_DESC = " " + PREFIX_EMAIL + "bob!yahoo";
    // missing '@' symbol
    public static final String INVALID_VOLUNTEER_ADDRESS_DESC = " " + PREFIX_ADDRESS;
    // empty string not allowed for addresses
    public static final String INVALID_VOLUNTEER_TAG_DESC = " " + PREFIX_TAG + "hubby*";
    // '*' not allowed in tags
