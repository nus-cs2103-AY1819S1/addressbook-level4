...
public class CommandTestUtil {
     ...
     * - the wish book and the filtered person list in the {@code actualModel} remain unchanged <br>
    ...
    /**
     * Deletes the first person in {@code model}'s filtered list from {@code model}'s wish book.
     */
