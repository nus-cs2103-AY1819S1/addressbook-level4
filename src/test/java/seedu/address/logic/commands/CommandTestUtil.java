...
public class CommandTestUtil {
    ...
    public static final String VALID_IC_BOB = "S7764839L";
    public static final String VALID_IC_AMY = "S9964439H";
    ...
    public static final String IC_DESC_BOB = " " + PREFIX_ICNUMBER + VALID_IC_BOB;
    public static final String IC_DESC_AMY = " " + PREFIX_ICNUMBER + VALID_IC_AMY;
