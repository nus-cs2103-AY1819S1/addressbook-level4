...
import static seedu.address.logic.commands.ListDayCommand.MESSAGE_FAILURE;
...
public class ListDayCommandTest {
    ...
    @Test
    public void execute() {
        assertCommandFailure(new ListDayCommand(), model, new CommandHistory(), MESSAGE_FAILURE);
    }
    */
}
