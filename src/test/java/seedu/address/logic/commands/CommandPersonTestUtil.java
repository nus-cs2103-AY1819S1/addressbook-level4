 ...
 */
public class CommandPersonTestUtil {
    ...
    public static final String VALID_INDEX_INSERT_PERSON = " " + PREFIX_PERSONINDEX + VALID_INDEX;
    ...
    public static final String INVALID_INDEX_INSERT_PERSON = " " + PREFIX_PERSONINDEX + "-1";
