...
public class IndexTest {
    ...
    @Test
    public void equals() {
        final Index fifthWishIndex = Index.fromOneBased(5);

        // same values -> returns true
        assertTrue(fifthWishIndex.equals(Index.fromOneBased(5)));
        assertTrue(fifthWishIndex.equals(Index.fromZeroBased(4)));

        // same object -> returns true
        assertTrue(fifthWishIndex.equals(fifthWishIndex));

        // null -> returns false
        assertFalse(fifthWishIndex.equals(null));

        // different types -> returns false
        assertFalse(fifthWishIndex.equals(5.0f));

        // different index -> returns false
        assertFalse(fifthWishIndex.equals(Index.fromOneBased(1)));
    }
}
