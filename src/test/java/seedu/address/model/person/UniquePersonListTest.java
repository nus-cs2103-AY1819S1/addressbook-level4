...
public class UniquePersonListTest {
    ...
    private final UniquePersonList uniquePersonList = new UniquePersonList(new ArrayList<>());
    ...
    public void setPerson_editedPersonIsSamePerson_success() {
        uniquePersonList.add(ALICE);
        uniquePersonList.setPerson(ALICE, ALICE);
        UniquePersonList expectedUniquePersonList = new UniquePersonList(new ArrayList<>());
