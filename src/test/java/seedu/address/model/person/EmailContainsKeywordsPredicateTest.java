...
public class EmailContainsKeywordsPredicateTest {
    ...
    public void test_emailContainsKeywords_returnsTrue() {
        // One keyword
        EmailContainsKeywordsPredicate predicate = new EmailContainsKeywordsPredicate(Collections.singletonList("alice@gmail.com"));
    ...
    public void test_emailDoesNotContainKeywords_returnsFalse() {
        ...
        predicate = new EmailContainsKeywordsPredicate(Arrays.asList("12345678"));
