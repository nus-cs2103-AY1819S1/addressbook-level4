...
public class EmailContainsKeywordsPredicateTest {
    ...
    public void test_emailContainsKeywords_returnsTrue() {
        ...
        EmailContainsKeywordsPredicate predicate =
                new EmailContainsKeywordsPredicate(Collections.singletonList("abc@gm.com"));
        assertTrue(predicate.test(new PersonBuilder().withEmail("abc@gm.com").build()));

        // Only one matching keyword
        predicate = new EmailContainsKeywordsPredicate(Arrays.asList("abc@gm.com", "def@gm.com"));
        assertTrue(predicate.test(new PersonBuilder().withEmail("abc@gm.com").build()));
