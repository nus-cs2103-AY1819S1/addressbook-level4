...
public class CarparkTest {
    ...
    public void isSamePerson() {
        ...
        Carpark editedAlice = new CarparkBuilder(ALICE)
                .withCarparkType(VALID_CARPARK_TYPE_2)
                .withCoordinate(VALID_COORDINATE_2).build();
        assertFalse(ALICE.isSameCarpark(editedAlice));

        // different name -> returns false
        editedAlice = new CarparkBuilder(ALICE).withCarparkNumber(VALID_CARPARK_NUMBER_2).build();
        assertFalse(ALICE.isSameCarpark(editedAlice));

        // same name, same phone, different attributes -> returns true
        editedAlice = new CarparkBuilder(ALICE).withCoordinate(VALID_COORDINATE_2).withAddress(VALID_ADDRESS_2)
                .withTags(VALID_TAG_HUSBAND).build();
        assertTrue(ALICE.isSameCarpark(editedAlice));

        // same name, same email, different attributes -> returns true
        editedAlice = new CarparkBuilder(ALICE).withCarparkType(VALID_CARPARK_TYPE_2).withAddress(VALID_ADDRESS_2)
                .withTags(VALID_TAG_HUSBAND).build();
        assertTrue(ALICE.isSameCarpark(editedAlice));
    ...
    public void equals() {
        ...
        Carpark aliceCopy = new CarparkBuilder(ALICE).build();
        ...
        // different name -> returns false
        Carpark editedAlice = new CarparkBuilder(ALICE).withCarparkNumber(VALID_CARPARK_NUMBER_2).build();
        assertFalse(ALICE.equals(editedAlice));

        // different phone -> returns false
        editedAlice = new CarparkBuilder(ALICE).withCarparkType(VALID_CARPARK_TYPE_2).build();
        assertFalse(ALICE.equals(editedAlice));

        // different email -> returns false
        editedAlice = new CarparkBuilder(ALICE).withCoordinate(VALID_COORDINATE_2).build();
        assertFalse(ALICE.equals(editedAlice));
