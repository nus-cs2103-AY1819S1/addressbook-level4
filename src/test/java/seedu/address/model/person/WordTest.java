...
public class WordTest {
    ...
    public void isSamePerson() {
        ...
        Word editedAlice = new PersonBuilder(ALICE).withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).build();
    ...
    public void equals() {
        ...
        Word aliceCopy = new PersonBuilder(ALICE).build();
        ...
        // different name -> returns false
        Word editedAlice = new PersonBuilder(ALICE).withName(VALID_NAME_BOB).build();
