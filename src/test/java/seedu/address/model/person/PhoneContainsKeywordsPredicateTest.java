...
public class PhoneContainsKeywordsPredicateTest {
    ...
    public void test_phoneDoesNotContainKeywords_returnsFalse() {
        ...
        predicate = new PhoneContainsKeywordsPredicate(Arrays.asList("12345678"));
        assertFalse(predicate.test(new PersonBuilder().withName("Alice Bob").build()));

        // Keywords match email and address, but does not match phone
        predicate = new PhoneContainsKeywordsPredicate(Arrays.asList("alice@email.com", "Main", "Street"));
