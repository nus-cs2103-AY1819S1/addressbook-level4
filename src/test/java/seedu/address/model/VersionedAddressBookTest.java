...
public class VersionedAddressBookTest {
    ...
    private final ReadOnlyAddressBook addressBookWithAmy = new AddressBookBuilder().withExpense(GAME).build();
    private final ReadOnlyAddressBook addressBookWithBob = new AddressBookBuilder().withExpense(IPHONE).build();
    private final ReadOnlyAddressBook addressBookWithCarl = new AddressBookBuilder().withExpense(TOY).build();
