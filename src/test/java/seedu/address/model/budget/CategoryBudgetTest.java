...
import static seedu.address.model.budget.BudgetTest.INVALID_BUDGET;
import static seedu.address.model.budget.BudgetTest.VALID_BUDGET;
...
public class CategoryBudgetTest {
    ...
    @Test
    public void equals() {
        //Most of the tests are covered by those in category and those in budget
