...
public class StatusBarFooterTest extends GuiUnitTest {
    ...
    public void display() {
        ...
        assertStatusBarContent(RELATIVE_PATH.resolve(STUB_SAVE_LOCATION).toString(), SYNC_STATUS_INITIAL,
                String.format(TOTAL_NUMBER_STATUS, INITIAL_NUMBER_OF_PERSONS));

        // after address book is updated
        postNow(EVENT_STUB);
        assertStatusBarContent(RELATIVE_PATH.resolve(STUB_SAVE_LOCATION).toString(),
                String.format(SYNC_STATUS_UPDATED, new Date(injectedClock.millis()).toString()),
                String.format(TOTAL_NUMBER_STATUS, EVENT_STUB.data.getPersonList().size()));
    }
    ...
    private void assertStatusBarContent(String expectedSaveLocation, String expectedSyncStatus,
        ...
        assertEquals(expectedTotalNumberStatus, statusBarFooterHandle.getTotalNumberStatus());
