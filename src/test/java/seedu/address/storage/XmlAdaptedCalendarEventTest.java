...
public class XmlAdaptedCalendarEventTest {
    ...
    public void toModelType_invalidTitle_throwsIllegalValueException() {
        XmlAdaptedCalendarEvent person =
            new XmlAdaptedCalendarEvent(INVALID_TITLE, VALID_DESCRIPTION, VALID_START, VALID_END, VALID_LOCATION, VALID_TAGS);
    ...
    public void toModelType_nullTitle_throwsIllegalValueException() {
        XmlAdaptedCalendarEvent person = new XmlAdaptedCalendarEvent(null, VALID_DESCRIPTION, VALID_START, VALID_END, VALID_LOCATION,
            VALID_TAGS);
    ...
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        XmlAdaptedCalendarEvent person =
            new XmlAdaptedCalendarEvent(VALID_TITLE, INVALID_DESCRIPTION, VALID_START, VALID_END, VALID_LOCATION, VALID_TAGS);
    ...
    public void toModelType_nullDescription_throwsIllegalValueException() {
        XmlAdaptedCalendarEvent person = new XmlAdaptedCalendarEvent(VALID_TITLE, null, VALID_START, VALID_END, VALID_LOCATION,
            VALID_TAGS);
    ...
    public void toModelType_invalidStart_throwsIllegalValueException() {
        XmlAdaptedCalendarEvent person =
            new XmlAdaptedCalendarEvent(VALID_TITLE, VALID_DESCRIPTION, INVALID_START, VALID_END, VALID_LOCATION, VALID_TAGS);
    ...
    public void toModelType_nullStart_throwsIllegalValueException() {
        XmlAdaptedCalendarEvent person = new XmlAdaptedCalendarEvent(VALID_TITLE, VALID_DESCRIPTION, null, VALID_END, VALID_LOCATION,
            VALID_TAGS);
    ...
    public void toModelType_invalidEnd_throwsIllegalValueException() {
        XmlAdaptedCalendarEvent person =
            new XmlAdaptedCalendarEvent(VALID_TITLE, VALID_DESCRIPTION, VALID_START, INVALID_END, VALID_LOCATION, VALID_TAGS);
        String expectedMessage = DateTime.MESSAGE_DATETIMEINPUT_CONSTRAINTS;
        Assert.assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
    ...
    public void toModelType_nullEnd_throwsIllegalValueException() {
        XmlAdaptedCalendarEvent person = new XmlAdaptedCalendarEvent(VALID_TITLE, VALID_DESCRIPTION, VALID_START, null, VALID_LOCATION,
            VALID_TAGS);
    ...
    public void toModelType_invalidLocation_throwsIllegalValueException() {
        XmlAdaptedCalendarEvent person =
            new XmlAdaptedCalendarEvent(VALID_TITLE, VALID_DESCRIPTION, VALID_START, VALID_END, INVALID_LOCATION, VALID_TAGS);
    ...
    public void toModelType_nullLocation_throwsIllegalValueException() {
        XmlAdaptedCalendarEvent person = new XmlAdaptedCalendarEvent(VALID_TITLE, VALID_DESCRIPTION, VALID_START, VALID_END, null,
            VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        XmlAdaptedCalendarEvent calendarEvent =
            new XmlAdaptedCalendarEvent(VALID_TITLE, VALID_DESCRIPTION, VALID_START, VALID_END, VALID_LOCATION, invalidTags);
