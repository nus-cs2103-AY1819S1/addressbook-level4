...
public class XmlAdaptedEventTest {
    ...
    private static final Priority VALID_PRIORITY = JANUARY_1_2018_SINGLE.getPriority();
    ...
    public void toModelType_nullUuid_throwsIllegalValueException() {
        XmlAdaptedEvent event = new XmlAdaptedEvent(null, VALID_EVENT_NAME, VALID_START_DATETIME, VALID_END_DATETIME,
                VALID_DESCRIPTION, VALID_PRIORITY, VALID_VENUE, VALID_REPEAT_TYPE,
    ...
    public void toModelType_nullDescription_throwsIllegalValueException() {
        XmlAdaptedEvent event = new XmlAdaptedEvent(VALID_UUID, VALID_EVENT_NAME, VALID_START_DATETIME, VALID_END_DATETIME,
                null, VALID_PRIORITY, VALID_VENUE, VALID_REPEAT_TYPE,
                VALID_REPEAT_UNTIL_DATETIME);
        Assert.assertThrows(IllegalValueException.class, event::toModelType);
    }
    ...
    public void toModelType_nullPriority_throwsIllegalValueException() {
        XmlAdaptedEvent event = new XmlAdaptedEvent(VALID_UUID, VALID_EVENT_NAME, VALID_START_DATETIME, VALID_END_DATETIME,
                VALID_DESCRIPTION, null, VALID_VENUE, VALID_REPEAT_TYPE,
                VALID_REPEAT_UNTIL_DATETIME);
        Assert.assertThrows(IllegalValueException.class, event::toModelType);
    }
    ...
    public void toModelType_nullVenue_throwsIllegalValueException() {
        XmlAdaptedEvent event = new XmlAdaptedEvent(VALID_UUID, VALID_EVENT_NAME, VALID_START_DATETIME, VALID_END_DATETIME,
                VALID_DESCRIPTION, VALID_PRIORITY, null, VALID_REPEAT_TYPE,
                VALID_REPEAT_UNTIL_DATETIME);
        Assert.assertThrows(IllegalValueException.class, event::toModelType);
    }
    ...
    public void toModelType_nullRepeatType_throwsIllegalValueException() {
        XmlAdaptedEvent event = new XmlAdaptedEvent(VALID_UUID, VALID_EVENT_NAME, VALID_START_DATETIME, VALID_END_DATETIME,
                VALID_DESCRIPTION, VALID_PRIORITY, VALID_VENUE, null,
                VALID_REPEAT_UNTIL_DATETIME);
        Assert.assertThrows(IllegalValueException.class, event::toModelType);
    }
