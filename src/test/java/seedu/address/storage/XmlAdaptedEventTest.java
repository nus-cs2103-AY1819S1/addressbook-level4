...
public class XmlAdaptedEventTest {
    ...
    private static final String INVALID_EVENT_TIME = "123123";
    ...
    private static final String VALID_EVENT_TIME = DOCTORAPPT.getEventTime().toString();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        XmlAdaptedEvent event =
                new XmlAdaptedEvent(INVALID_EVENT_NAME, VALID_EVENT_DESCRIPTION, VALID_EVENT_DATE, VALID_EVENT_TIME,
                        VALID_EVENT_ADDRESS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        XmlAdaptedEvent event =
                new XmlAdaptedEvent(null, VALID_EVENT_DESCRIPTION, VALID_EVENT_DATE, VALID_EVENT_TIME,
                        VALID_EVENT_ADDRESS);
    ...
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        XmlAdaptedEvent event =
                new XmlAdaptedEvent(VALID_EVENT_NAME, INVALID_EVENT_DESCRIPTION, VALID_EVENT_DATE, VALID_EVENT_TIME,
                        VALID_EVENT_ADDRESS);
    ...
    public void toModelType_nullDescription_throwsIllegalValueException() {
        XmlAdaptedEvent event =
                new XmlAdaptedEvent(VALID_EVENT_NAME, null, VALID_EVENT_DATE, VALID_EVENT_TIME,
                        VALID_EVENT_ADDRESS);
    ...
    public void toModelType_invalidDate_throwsIllegalValueException() {
        XmlAdaptedEvent event =
                new XmlAdaptedEvent(VALID_EVENT_NAME, VALID_EVENT_DESCRIPTION, INVALID_EVENT_DATE, VALID_EVENT_TIME,
                        VALID_EVENT_ADDRESS);
    ...
    public void toModelType_nullDate_throwsIllegalValueException() {
        XmlAdaptedEvent event =
                new XmlAdaptedEvent(VALID_EVENT_NAME, VALID_EVENT_DESCRIPTION, null, VALID_EVENT_TIME,
                        VALID_EVENT_ADDRESS);
    ...
    public void toModelType_invalidTime_throwsIllegalValueException() {
        XmlAdaptedEvent event =
                new XmlAdaptedEvent(VALID_EVENT_NAME, VALID_EVENT_DESCRIPTION, VALID_EVENT_DATE, INVALID_EVENT_TIME,
                        VALID_EVENT_ADDRESS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        XmlAdaptedEvent event =
                new XmlAdaptedEvent(VALID_EVENT_NAME, VALID_EVENT_DESCRIPTION, VALID_EVENT_DATE, VALID_EVENT_TIME,
