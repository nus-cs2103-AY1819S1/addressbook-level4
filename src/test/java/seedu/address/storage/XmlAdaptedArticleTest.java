...
public class XmlAdaptedArticleTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        XmlAdaptedArticle article =
                new XmlAdaptedArticle(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        XmlAdaptedArticle article = new XmlAdaptedArticle(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                FALSE_ISRESOLVED, VALID_TAGS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        XmlAdaptedArticle article =
                new XmlAdaptedArticle(VALID_NAME, INVALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        FALSE_ISRESOLVED, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        XmlAdaptedArticle article = new XmlAdaptedArticle(VALID_NAME, null, VALID_EMAIL, VALID_ADDRESS,
                FALSE_ISRESOLVED, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        XmlAdaptedArticle article =
                new XmlAdaptedArticle(VALID_NAME, VALID_PHONE, INVALID_EMAIL, VALID_ADDRESS,
                        FALSE_ISRESOLVED, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        XmlAdaptedArticle article = new XmlAdaptedArticle(VALID_NAME, VALID_PHONE, null, VALID_ADDRESS,
                FALSE_ISRESOLVED, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        XmlAdaptedArticle article =
                new XmlAdaptedArticle(VALID_NAME, VALID_PHONE, VALID_EMAIL, INVALID_ADDRESS,
                        FALSE_ISRESOLVED, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        XmlAdaptedArticle article =
                new XmlAdaptedArticle(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        FALSE_ISRESOLVED, invalidTags);
