...
public class XmlAdaptedWishTest {
    ...
    private static final String INVALID_DATE = "22/1/2019";
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        XmlAdaptedWish wish =
                new XmlAdaptedWish(INVALID_NAME, VALID_PRICE, VALID_DATE, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        XmlAdaptedWish wish = new XmlAdaptedWish(null, VALID_PRICE, VALID_DATE, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidPrice_throwsIllegalValueException() {
        XmlAdaptedWish wish =
                new XmlAdaptedWish(VALID_NAME, INVALID_PRICE, VALID_DATE, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullPrice_throwsIllegalValueException() {
        XmlAdaptedWish wish = new XmlAdaptedWish(VALID_NAME, null, VALID_DATE, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidDate_throwsIllegalValueException() {
        XmlAdaptedWish wish =
                new XmlAdaptedWish(VALID_NAME, VALID_PRICE, INVALID_DATE, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        XmlAdaptedWish wish =
                new XmlAdaptedWish(VALID_NAME, VALID_PRICE, VALID_DATE, INVALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        XmlAdaptedWish wish = new XmlAdaptedWish(VALID_NAME, VALID_PRICE, VALID_DATE, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        XmlAdaptedWish wish =
                new XmlAdaptedWish(VALID_NAME, VALID_PRICE, VALID_DATE, VALID_ADDRESS, invalidTags);
