...
public class XmlSerializableAddressBookTest {
    ...
    private static final Path TYPICAL_PERSONS_FILE = TEST_DATA_FOLDER.resolve("typicalRecipesAddressBook.xml");
    private static final Path INVALID_PERSON_FILE = TEST_DATA_FOLDER.resolve("invalidRecipeAddressBook.xml");
    private static final Path DUPLICATE_PERSON_FILE = TEST_DATA_FOLDER.resolve("duplicateRecipeAddressBook.xml");
    ...
    public void toModelType_typicalPersonsFile_success() throws Exception {
        ...
        AddressBook typicalPersonsAddressBook = TypicalRecipes.getTypicalAddressBook();
