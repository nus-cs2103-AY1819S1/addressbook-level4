...
public class XmlAdaptedTaskTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        XmlAdaptedTask task =
                new XmlAdaptedTask(INVALID_NAME, VALID_DUE_DATE, VALID_PRIORITY_VALUE, VALID_DESCRIPTION, VALID_LABELS, VALID_DEPENDENCIES);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        XmlAdaptedTask task = new XmlAdaptedTask(null, VALID_DUE_DATE, VALID_PRIORITY_VALUE,
                VALID_DESCRIPTION, VALID_LABELS, VALID_DEPENDENCIES);
    ...
    public void toModelType_invalidDueDate_throwsIllegalValueException() {
        XmlAdaptedTask task =
                new XmlAdaptedTask(VALID_NAME, INVALID_DUE_DATE, VALID_PRIORITY_VALUE, VALID_DESCRIPTION, VALID_LABELS, VALID_DEPENDENCIES);
    ...
    public void toModelType_invalidPriorityValue_throwsIllegalValueException() {
        XmlAdaptedTask task =
                new XmlAdaptedTask(VALID_NAME, VALID_DUE_DATE, INVALID_PRIORITY_VALUE, VALID_DESCRIPTION, VALID_LABELS, VALID_DEPENDENCIES);
        String expectedMessage = PriorityValue.MESSAGE_PRIORITY_VALUE_CONSTRAINTS;
        Assert.assertThrows(IllegalValueException.class, expectedMessage, task::toModelType);
    }
    ...
    public void toModelType_nullPriorityValue_throwsIllegalValueException() {
        XmlAdaptedTask priorityValue = new XmlAdaptedTask(VALID_NAME, VALID_DUE_DATE,
                null, VALID_DESCRIPTION, VALID_LABELS, VALID_DEPENDENCIES);
    ...
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        XmlAdaptedTask task =
                new XmlAdaptedTask(VALID_NAME, VALID_DUE_DATE, VALID_PRIORITY_VALUE, INVALID_DESCRIPTION, VALID_LABELS, VALID_DEPENDENCIES);
    ...
    public void toModelType_nullDescription_throwsIllegalValueException() {
        XmlAdaptedTask task = new XmlAdaptedTask(VALID_NAME, VALID_DUE_DATE, VALID_PRIORITY_VALUE, null, VALID_LABELS, VALID_DEPENDENCIES);
    ...
    public void toModelType_invalidLabels_throwsIllegalValueException() {
        ...
        XmlAdaptedTask task =
                new XmlAdaptedTask(VALID_NAME, VALID_DUE_DATE, VALID_PRIORITY_VALUE, VALID_DESCRIPTION, invalidLabels, VALID_DEPENDENCIES);
