package seedu.thanepark.commons.core.index;
...
public class IndexTest {
    ...
    @Test
    public void equals() {
        final Index fifthRideIndex = Index.fromOneBased(5);

        // same values -> returns true
        assertTrue(fifthRideIndex.equals(Index.fromOneBased(5)));
        assertTrue(fifthRideIndex.equals(Index.fromZeroBased(4)));

        // same object -> returns true
        assertTrue(fifthRideIndex.equals(fifthRideIndex));

        // null -> returns false
        assertFalse(fifthRideIndex.equals(null));

        // different types -> returns false
        assertFalse(fifthRideIndex.equals(5.0f));

        // different index -> returns false
        assertFalse(fifthRideIndex.equals(Index.fromOneBased(1)));
    }
}
