...
import static seedu.clinicio.logic.commands.LogoutCommand.MESSAGE_NO_USER_LOGIN;
...
public class LogoutCommandTest {
    ...
    @Test
    public void execute_logout_failure() throws CommandException {
        thrown.expect(CommandException.class);
        thrown.expectMessage(MESSAGE_NO_USER_LOGIN);
