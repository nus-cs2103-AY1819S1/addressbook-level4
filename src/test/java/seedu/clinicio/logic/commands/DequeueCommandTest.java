...
public class DequeueCommandTest {
    ...
    public void constructor_nullIndex_throwsNullPointerException() {
        ...
        new DequeueCommand(null);
    }

    // Remove the last patient in the list, who is BRYAN.
    @Test
    public void execute_indexAcceptedByModel_addSuccessful() throws Exception {
        ...
        CommandResult commandResult = new DequeueCommand(index).execute(modelStub, commandHistory);
     ...
     */
    private class ModelStubAcceptingIndexAdded extends DequeueCommandTest.ModelStub {
        final List<Patient> personsAdded = new ArrayList<>();

        public ModelStubAcceptingIndexAdded() {
            personsAdded.add(ALEX);
            personsAdded.add(BRYAN);
        }
