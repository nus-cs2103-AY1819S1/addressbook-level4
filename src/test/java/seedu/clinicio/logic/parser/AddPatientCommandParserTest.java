...
import static seedu.clinicio.logic.commands.CommandTestUtil.VALID_ALLERGIES;
...
public class AddPatientCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Patient expectedPatient = new PatientBuilder(BRYAN).withAllergies(VALID_ALLERGIES).build();
        ...
        // multiple addresses - last clinicio accepted
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero medical problems & zero medications
        Patient expectedPatient = new PatientBuilder(ALEX).build();
