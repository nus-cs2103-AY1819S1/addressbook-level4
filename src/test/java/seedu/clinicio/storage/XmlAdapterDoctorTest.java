...
public class XmlAdapterDoctorTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        XmlAdaptedDoctor doctor =
                new XmlAdaptedDoctor(INVALID_NAME, VALID_PASSWORD);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        XmlAdaptedDoctor doctor = new XmlAdaptedDoctor(null, VALID_PASSWORD);
    ...
    public void toModelType_invalidPassword_throwsIllegalValueException() {
        XmlAdaptedDoctor doctor =
                new XmlAdaptedDoctor(VALID_NAME, INVALID_PASSWORD);
    ...
    public void toModelType_nullPassword_throwsIllegalValueException() {
        XmlAdaptedDoctor doctor = new XmlAdaptedDoctor(VALID_NAME, null);
