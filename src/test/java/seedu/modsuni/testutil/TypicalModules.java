...
public class TypicalModules {
    ...
    public static final Module CS2103T = new ModuleBuilder().withCode(new Code("CS2103T"))
            ...
            .withDescription("This module introduces the necessary conceptual and analytical tools for systematic "
                    ...
                    + "and testing, with emphasis on system modelling and design and implementation of software modules that "
                    + "work cooperatively to fulfill the requirements of the system. Tools and techniques for software "
                    + "development, such as Unified Modelling Language (UML), program specification, and testing methods, "
                    + "will be taught. Major software engineering issues such as modularisation criteria, program correctness, "
