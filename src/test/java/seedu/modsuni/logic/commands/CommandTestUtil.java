...
public class CommandTestUtil {
    ...
    public static final String VALID_NAME_BOB = "Bob Lee";

    public static final String NAME_DESC_AMY = " " + PREFIX_NAME + VALID_NAME_AMY;
    public static final String NAME_DESC_BOB =
        " " + PREFIX_NAME + VALID_NAME_BOB;
    public static final String USERNAME_AMY = "amy";
    public static final String USERNAME_BOB = "bob";
    public static final String REGISTER_AMY_DESC = " " + PREFIX_USERNAME + USERNAME_AMY;
    public static final String REGISTER_BOB_DESC =
        " " + PREFIX_USERNAME + USERNAME_BOB;
