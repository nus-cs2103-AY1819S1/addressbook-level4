...
public class AddModuleToStudentTakenCommandParserTest {
    ...
    public void parse_multiCode_success() {
        ...
        assertParseSuccess(parser, "CS1010 CS2103T", new AddModuleToStudentTakenCommand(expectedModuleList,
                new HashSet<>()));
    }
    ...
    public void parse_caseInsensitive_success() {
        ...
        assertParseSuccess(parser, "cs1010", new AddModuleToStudentTakenCommand(expectedModuleList,
                new HashSet<>()));
    }
    ...
    public void parse_duplicateCode_success() {
        ...
        assertParseSuccess(parser, "CS1010 CS2103T CS1010 CS1010",
                new AddModuleToStudentTakenCommand(expectedModuleList, expectedHashSet));
    }
}
