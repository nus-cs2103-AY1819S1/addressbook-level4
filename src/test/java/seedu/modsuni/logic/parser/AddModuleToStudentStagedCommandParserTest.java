...
public class AddModuleToStudentStagedCommandParserTest {
    ...
    public void parse_multiCode_success() {
        ...
        assertParseSuccess(parser, "CS1010 CS2103T", new AddModuleToStudentStagedCommand(expectedModuleList));
    }
    ...
    public void parse_caseInsensitive_success() {
        ...
        assertParseSuccess(parser, "cs1010", new AddModuleToStudentStagedCommand(expectedModuleList));
    }
}
