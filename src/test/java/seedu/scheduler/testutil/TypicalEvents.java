...
public class TypicalEvents {
    ...
    private static final UUID CONSTANT_UID = UUID.fromString("066db0fd-0bd2-423f-aef4-fd1f8d30a624");
    private static final UUID CONSTANT_UUID = UUID.fromString("066db0fd-0bd2-423f-aef4-fd1f8d30a625");

    // single event
    public static final Event JANUARY_1_2018_SINGLE = new EventBuilder()
            .withUid(CONSTANT_UID)
    ...
    // daily event
    public static final Event JANUARY_30_2018_DAILY = new EventBuilder()
            .withUid(CONSTANT_UID)
            .withUuid(CONSTANT_UUID)
            ...
            .withReminderDurationList(getReminderDurationList(3))
            .build();
    public static final Event JANUARY_31_2018_DAILY = new EventBuilder()
            .withUid(CONSTANT_UID)
            .withUuid(CONSTANT_UUID)
            .withEventName("30-01-2018 - 01-02-2018")
            ...
            .withReminderDurationList(getReminderDurationList(3))
            .build();
    public static final Event FEBRUARY_1_2018_DAILY = new EventBuilder()
            .withUid(CONSTANT_UID)
            .withUuid(CONSTANT_UUID)
            .withEventName("30-01-2018 - 01-02-2018")
    ...
    // monthly event
    public static final Event JANUARY_1_2018_MONTHLY = new EventBuilder()
            .withUid(CONSTANT_UID)
            .withUuid(CONSTANT_UUID)
            ...
            .withReminderDurationList(getReminderDurationList(3))
            .build();
    public static final Event FEBRUARY_1_2018_MONTHLY = new EventBuilder()
            .withUid(CONSTANT_UID)
            .withUuid(CONSTANT_UUID)
            .withEventName("01-01-2018 - 01-03-2018")
            .withStartDateTime(LocalDateTime.of(2018, 2, 1, 1, 0))
            ...
            .withReminderDurationList(getReminderDurationList(3))
            .build();
    public static final Event MARCH_1_2018_MONTHLY = new EventBuilder()
            .withUid(CONSTANT_UID)
            .withUuid(CONSTANT_UUID)
            .withEventName("01-01-2018 - 01-03-2018")
            ...
            .withReminderDurationList(getReminderDurationList(3))
            .build();
    public static final Event JANUARY_31_2018_MONTHLY = new EventBuilder()
            .withUid(CONSTANT_UID)
            .withUuid(CONSTANT_UUID)
            ...
            .withReminderDurationList(getReminderDurationList(3))
            .build();
    public static final Event MARCH_31_2018_MONTHLY = new EventBuilder()
            .withUid(CONSTANT_UID)
            .withUuid(CONSTANT_UUID)
            .withEventName("31-01-2018 - 31-03-2018")
    ...
    // yearly event
    public static final Event JANUARY_1_2018_YEARLY = new EventBuilder()
            .withUid(CONSTANT_UID)
            .withUuid(CONSTANT_UUID)
            ...
            .withReminderDurationList(getReminderDurationList(3))
            .build();
    public static final Event JANUARY_1_2019_YEARLY = new EventBuilder()
            .withUid(CONSTANT_UID)
            .withUuid(CONSTANT_UUID)
            .withEventName("01-01-2018 - 01-01-2020")
            ...
            .withReminderDurationList(getReminderDurationList(3))
            .build();
    public static final Event JANUARY_1_2020_YEARLY = new EventBuilder()
            .withUid(CONSTANT_UID)
            .withUuid(CONSTANT_UUID)
            .withEventName("01-01-2018 - 01-01-2020")
            ...
            .withReminderDurationList(getReminderDurationList(3))
            .build();
    public static final Event FEBRUARY_29_2016_YEARLY = new EventBuilder()
            .withUid(CONSTANT_UID)
            .withUuid(CONSTANT_UUID)
            ...
            .withReminderDurationList(getReminderDurationList(3))
            .build();
    public static final Event FEBRUARY_29_2020_YEARLY = new EventBuilder()
            .withUid(CONSTANT_UID)
            .withUuid(CONSTANT_UUID)
            .withEventName("29-02-2016 - 29-02-2020")
