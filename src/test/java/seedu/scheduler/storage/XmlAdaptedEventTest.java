...
public class XmlAdaptedEventTest {
    ...
    private static final UUID VALID_EVENTUID = DISCUSSION_WITH_JACK.getEventUid();
    private static final UUID VALID_EVENTSETUID = DISCUSSION_WITH_JACK.getEventSetUid();
    ...
    public void toModelType_nullUid_throwsIllegalValueException() {
        XmlAdaptedEvent event = new XmlAdaptedEvent(null, VALID_EVENTSETUID, VALID_EVENT_NAME, VALID_START_DATETIME,
    ...
    public void toModelType_nullUuid_throwsIllegalValueException() {
        XmlAdaptedEvent event = new XmlAdaptedEvent(VALID_EVENTUID, null, VALID_EVENT_NAME, VALID_START_DATETIME,
                VALID_END_DATETIME, VALID_DESCRIPTION, VALID_VENUE, VALID_REPEAT_TYPE,
                VALID_REPEAT_UNTIL_DATETIME, VALID_TAGS, VALID_REMINDER_DURATION_LIST);
        Assert.assertThrows(IllegalValueException.class, event::toModelType);
    }
    ...
    public void toModelType_invalidEventName_throwsIllegalValueException() {
        XmlAdaptedEvent event = new XmlAdaptedEvent(VALID_EVENTUID, VALID_EVENTSETUID, INVALID_EVENT_NAME, VALID_START_DATETIME,
                VALID_END_DATETIME, VALID_DESCRIPTION, VALID_VENUE, VALID_REPEAT_TYPE,
                VALID_REPEAT_UNTIL_DATETIME, VALID_TAGS, VALID_REMINDER_DURATION_LIST);
    ...
    public void toModelType_nullEventName_throwsIllegalValueException() {
        XmlAdaptedEvent event = new XmlAdaptedEvent(VALID_EVENTUID, VALID_EVENTSETUID, null, VALID_START_DATETIME,
                VALID_END_DATETIME, VALID_DESCRIPTION, VALID_VENUE, VALID_REPEAT_TYPE,
                VALID_REPEAT_UNTIL_DATETIME, VALID_TAGS, VALID_REMINDER_DURATION_LIST);
    ...
    public void toModelType_nullStartDateTime_throwsIllegalValueException() {
        XmlAdaptedEvent event = new XmlAdaptedEvent(VALID_EVENTUID, VALID_EVENTSETUID, VALID_EVENT_NAME, null,
                VALID_END_DATETIME, VALID_DESCRIPTION, VALID_VENUE, VALID_REPEAT_TYPE,
                VALID_REPEAT_UNTIL_DATETIME, VALID_TAGS, VALID_REMINDER_DURATION_LIST);
        Assert.assertThrows(IllegalValueException.class, event::toModelType);
    }
    ...
    public void toModelType_nullEndDateTime_throwsIllegalValueException() {
        XmlAdaptedEvent event = new XmlAdaptedEvent(VALID_EVENTUID, VALID_EVENTSETUID, VALID_EVENT_NAME,
    ...
    public void toModelType_nullDescription_throwsIllegalValueException() {
        XmlAdaptedEvent event = new XmlAdaptedEvent(VALID_EVENTUID, VALID_EVENTSETUID, VALID_EVENT_NAME, VALID_START_DATETIME,
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        XmlAdaptedEvent event =
                new XmlAdaptedEvent(VALID_EVENTUID, VALID_EVENTSETUID, VALID_EVENT_NAME, VALID_START_DATETIME, VALID_END_DATETIME,
