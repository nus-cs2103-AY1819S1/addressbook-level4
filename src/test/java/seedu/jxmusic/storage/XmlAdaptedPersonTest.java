...
import static seedu.jxmusic.storage.XmlAdaptedPerson.MISSING_FIELD_MESSAGE_FORMAT;
...
public class XmlAdaptedPersonTest {
    ...
    private static final String VALID_NAME = METAL.getName().toString();
    private static final String VALID_PHONE = METAL.getPhone().toString();
    private static final String VALID_EMAIL = METAL.getEmail().toString();
    private static final String VALID_ADDRESS = METAL.getAddress().toString();
    private static final List<XmlAdaptedTag> VALID_TAGS = METAL.getTags().stream()
            .map(XmlAdaptedTag::new)
            .collect(Collectors.toList());

    @Test
    public void toModelType_validPersonDetails_returnsPerson() throws Exception {
        XmlAdaptedPerson person = new XmlAdaptedPerson(METAL);
        assertEquals(METAL, person.toModelType());
    }
