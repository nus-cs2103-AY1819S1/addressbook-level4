...
// import static seedu.jxmusic.logic.commands.CommandTestUtil.PLAYLIST_NAME_DESC_ANIME;
...
//         // negative index
//         assertParseFailure(parser, "-5" + PLAYLIST_NAME_DESC_ANIME, MESSAGE_INVALID_FORMAT);
//
//         // zero index
//         assertParseFailure(parser, "0" + PLAYLIST_NAME_DESC_ANIME, MESSAGE_INVALID_FORMAT);
//
...
//         String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TRACK_DESC_EXISTENCE
//                 + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + PLAYLIST_NAME_DESC_ANIME + TRACK_DESC_ALIEZ;
//
//         EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
//                 .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
//                 .withTags(VALID_TRACK_NAME_IHOJIN, VALID_TRACK_EXISTENCE).build();
...
//         String userInput = targetIndex.getOneBased() + PLAYLIST_NAME_DESC_ANIME;
...
//
//         // tags
//         userInput = targetIndex.getOneBased() + TRACK_DESC_ALIEZ;
//         descriptor = new EditPersonDescriptorBuilder().withTags(VALID_TRACK_EXISTENCE).build();
//         expectedCommand = new EditCommand(targetIndex, descriptor);
//         assertParseSuccess(parser, userInput, expectedCommand);
//     }
//
...
//                 + TRACK_DESC_ALIEZ + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY + TRACK_DESC_ALIEZ
