...
public class EditCommandParserTest {
    ...
    public void parse_invalidPreamble_failure() {
        // negative index
        assertParseFailure(parser, "-5" + NAME_DESC_ANIME, MESSAGE_INVALID_FORMAT);

        // zero index
        assertParseFailure(parser, "0" + NAME_DESC_ANIME, MESSAGE_INVALID_FORMAT);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TRACK_DESC_EXISTENCE
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + NAME_DESC_ANIME + TRACK_DESC_ALIEZ;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TRACK_ALIEZ, VALID_TRACK_EXISTENCE).build();
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + NAME_DESC_ANIME;
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        ...
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_PHONE_BOB)
                .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withTags(VALID_TRACK_EXISTENCE, VALID_TRACK_ALIEZ)
                .build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
