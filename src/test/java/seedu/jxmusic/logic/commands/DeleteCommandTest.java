...
public class DeleteCommandTest {
    ...
    public void executeUndoRedo_validIndexUnfilteredList_success() throws Exception {
        ...
        // redo -> same first playlist deleted again
     ...
     * 2. Undo the deletion.
     * 3. The unfiltered list should be shown now. Verify that the index of the previously deleted playlist in the
     * unfiltered list is different from the index at the filtered list.
     * 4. Redo the deletion. This ensures {@code RedoCommand} deletes the playlist object regardless of indexing.
     */
    @Test
    public void executeUndoRedo_validIndexFilteredList_samePersonDeleted() throws Exception {
        ...
        // delete -> deletes second playlist in unfiltered playlist list / first playlist in filtered playlist list
        deleteCommand.execute(model, commandHistory);
        ...
        // redo -> deletes same second playlist in unfiltered playlist list
        expectedModel.redoAddressBook();
        assertCommandSuccess(new RedoCommand(), model, commandHistory, RedoCommand.MESSAGE_SUCCESS, expectedModel);
    }
