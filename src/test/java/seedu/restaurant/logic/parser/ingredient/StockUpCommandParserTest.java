...
import static seedu.restaurant.logic.commands.CommandTestUtil.VALID_NUM_UNITS_APPLE;
import static seedu.restaurant.logic.commands.CommandTestUtil.VALID_NUM_UNITS_BROCCOLI;
...
public class StockUpCommandParserTest {
    ...
    public void parse_validMultipleArgumentPairs_success() {
        Map<IngredientName, Integer> ingredientHashMap = new HashMap<>();
        ingredientHashMap.put(new IngredientName(VALID_NAME_APPLE), VALID_NUM_UNITS_APPLE);
        ingredientHashMap.put(new IngredientName(VALID_NAME_BROCCOLI), VALID_NUM_UNITS_BROCCOLI);
