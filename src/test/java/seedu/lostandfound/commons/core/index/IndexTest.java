package seedu.lostandfound.commons.core.index;
...
public class IndexTest {
    ...
    @Test
    public void equals() {
        final Index fifthArticleIndex = Index.fromOneBased(5);

        // same values -> returns true
        assertTrue(fifthArticleIndex.equals(Index.fromOneBased(5)));
        assertTrue(fifthArticleIndex.equals(Index.fromZeroBased(4)));

        // same object -> returns true
        assertTrue(fifthArticleIndex.equals(fifthArticleIndex));

        // null -> returns false
        assertFalse(fifthArticleIndex.equals(null));

        // different types -> returns false
        assertFalse(fifthArticleIndex.equals(5.0f));

        // different index -> returns false
        assertFalse(fifthArticleIndex.equals(Index.fromOneBased(1)));
    }
}
