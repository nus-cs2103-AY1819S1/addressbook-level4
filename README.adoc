...
** Ability to add friends, modules, and occasions without full details.
** Editing their details and having them updated on the fly.
** Easy swapping of lists on interface.
** Adding and removing friends from modules and occasions that you have.
** Having a command suggestions drop down menu to aid in command typing.
