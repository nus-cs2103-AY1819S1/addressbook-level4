...
* *CLI (Command Line Interface)* interactions with modern *GUI* brought to your!
* *Always connected.* Sync with your google account!
* *Cross platform.* Run it on both *Windows* AND *Mac*!
* *Responsive interface.* We ensure your smooth experience.

== Latest Features
* Suports repeating events.
* Supports tag mangement.
* Sync with your google service.
* Pop-up alert.
...
== Acknowledgements
* This application was morph from CS2103 AddressBook-Level4 project created by https://github.com/se-edu/[SE-EDU initiative].
