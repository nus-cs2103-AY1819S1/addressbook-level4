...
.. Enter the `tasks add n/test calendar multiple ed/20181212 et/1200` command 3 times.
...
.. Test case: `tasks add n/test calendar previous month ed/20181127 et/1200`. +
Expected: Cell corresponding to 27 November 2018 has one new entry displaying "test calendar previous month".
.. Test case: `tasks add n/test calendar following month ed/20190102 et/1200` +
