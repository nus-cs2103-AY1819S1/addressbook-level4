...
Step 3.1 The user views `UniqueArchiveList` and executes delete 1 command to delete the 1st person in the archive list.

Step 3.2 The user views `UniqueArchiveList` and execute restore 1 command to restored 1st person in the archive list to the address book.
