...
image::ClassInheritanceZijin.png[width="800"]
...
image::UndoRedoStartingStateListDiagramZijin.png[width="800"]

Step 2: The user executes 'add n/David...' command to add a person called
David in his TheTracker. The 'add' command calls 'Model#commitAddressBook()
', causing the modified state of TheTracker after the 'add n/David' command
...
image::UndoRedoNewCommand1StateListDiagramZijin.png[width="800"]
...
image::UndoRedoNewCommand2StateListDiagramZijin.png[width="800"]
...
image::UndoRedoExecuteUndoStateListDiagramZijin.png[width='800']
...
image::UndoRedoSequenceDiagramZijin.png[width="800"]
...
image::UndoRedoNewCommand3StateFindDiagramZijin.png[width="800"]
...
image::UndoRedoNewCommand4StateListDiagramZijin.png[width="800"]

The following activity diagram summarizes what happens when a user executes a
new command:

image::UndoRedoActivityDiagramZijin.png[width="650"]
