...
The Patient Management comprises of `AddPatientCommand`, `EditPatientCommand`, `DeletePatientCommand`, `ListPatientCommand`. +
This is the equivalent of Create, Read, Update and Delete (CRUD).
