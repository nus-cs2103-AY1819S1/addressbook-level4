...
. Application displays a default congratulatory message, reports points earned and task completed to user.
...
** 2a1. Application displays a congratulatory message for leveling up, points earned and task completed to user.

### Use case: Completing Task (Batch via `Label`)
#### MSS
. User marks a batch of tasks with the same specified `Label` as complete.
. Application displays a default congratulatory message, reports points earned and task(s) completed to user.
...
* 2a. User earns enough points to level up
** 2a1. Application displays a congratulatory message for leveling up, points earned and task(s) completed to user.

## Non-functional requirements
- There should be no noticeable lag when typing on the command line.
...
- Should be able to hold up to 1000 tasks without a noticeable decline in performance.
...
|===
>>>>>>> 31aa2286d06fa242c54f7e313e50857c67192db3
...
##### 3.8.2.1 Aspect: Location of Implementation
...
** Cons: It is not directly linked to the process of completing a task, and hence should be a separate class.
