...
* Inferred Deletion: The deletion will only be applied to the currently active list.
* Deep Deletion: All references to this entry can be removed (i.e. from other entries' lists).
