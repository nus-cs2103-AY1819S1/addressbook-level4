...
From the code above, we see that upon calling `SwitchCommand`, a contextId is set.
...
The model contains different methods to update the various lists. Passing the predicates help to reset each of the lists to the initial state.
