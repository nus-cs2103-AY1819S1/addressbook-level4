...
Here are the steps to setup the project in your computer:
...
If you plan to develop this fork as a separate product (i.e. instead of contributing to `se-edu/addressbook-level4`), you should:
