...
* 4a. The user has permissions to be able to view all employee leaves.
+
** 4a1. OASIS lists all leave applications of all users
+
Use case ends.
...
.  User login to the system
.  OASIS shows home page
.  User <<Use case: View leave applications, lists leave applications (Use case: View leave applications)>>
...
* 4a. The format is invalid
+
** 4a1. OASIS shows an error message
+
* 4b. The index is does not exist
+
** 4b1. OASIS shows an error message
+
* 4c. The user does not have the permissions to approve leaves
+
** 4c1. OASIS shows an error message
+
Use case resumes at step 2.
Use case ends.
