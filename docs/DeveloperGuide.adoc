...
(For all use cases below, the *System* is the `AddressBook` and the *Actor* is the `JCRC member`, unless specified otherwise)
...
1. JCRC member requests to list persons
2. System shows list of all persons
+
Use case ends.
...
[none]
* 1a. JCRC member requests for list of persons with specific tag
+
[none]
** 1a1. System shows list of only persons with specified tag
+
Use case ends.
...
1. JCRC member requests to find person using name
2. System shows persons with matching name
Use case ends.
...
+
[none]
** 1a1. System clears all persons with specified tag
+
Use case ends.
...
1. JCRC member requests to clear a specific tag
2. System deletes specified tag from all persons
+
Use case ends.
...
1. JCRC member requests to publish email
2. System requests for all details of email (Sender, recipient, subject, content, attachment)
3. JCRC member enters all details
4. System saves an output file in the computer
+
Use case ends.
...
1. JCRC member requests to list persons
2. System shows list of persons
3. JCRC member requests to select a person with specific index
4. System shows details of selected person
+
Use case ends.
...
2. System requests for details of CCA (Name of CCA, names of head and vice-head, budget)
3. JCRC member enters the details
4. System displays the details of the CCA
+
Use Case ends.
