...
[NOTE]
See <<leaveapplicationlisted, How a leave applications are listed>> for further explanation of how the list of leave applications are retrieved and displayed.
