...
** Pros: Able to mask password in order to keep password secure.
** Cons: 
...
** Cons: Less secure as users, who understand how ClinicIO works, could 
edit the role of the user to have unauthorised access
to ClinicIO.
