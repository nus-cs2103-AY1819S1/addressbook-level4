...
* Is a receptionist at a medical clinic currently
* Non-tech savvy
* Prefer desktops apps over other types
* Can type fast
...
* Allow users to focus on attending to patients and provide a better experience.
