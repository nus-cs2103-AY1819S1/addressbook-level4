...
completed from the specified date. +
...
7 days or more later than nexDayBreakPoint.)
...
Expected: Task B is completed, followed by its standard output. Task A is completed, followed by
 its standard output.
