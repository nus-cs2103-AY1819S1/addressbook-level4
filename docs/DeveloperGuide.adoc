...
Tags and categories are single-word keywords tied to individual entries. Each `ResumeEntry` be can classified under one `Category`, but can be associated with multiple `Tag`.
