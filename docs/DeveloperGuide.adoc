...
2. Doctor (User) will add notes to the patient’s medical records

[discrete]
=== Use case: Patient done seeing doctor
1. Doctor (User) will indicate that he is done seeing the patient, and patient will be added to a done set.
...
5. Receptionist (User) will remove patient from done set when finished.
