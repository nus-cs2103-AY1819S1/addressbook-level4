...
image::add-event-component.png[Interactions between components, width="800"]
...
image::get-event.png[Getting an event, width="800"]
...
image::add-event_event-trigger.png[Handling of triggered events, width="800"]
...
image::find-event_event-triggers.png[Handling of triggered events, width="800"]
...
image::tabPanel.png[Tab Panel basic class diagram, width="800"]
