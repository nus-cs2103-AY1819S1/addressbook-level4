...
****
** Cons:
*** Unable to standardise the way the classes that `inherit` from `Document` implement the `generate` method.
****
...
=======
image::PQMS-gui.png[width="650"]
>>>>>>> 7f241a15f96db1c6881a550bb7cb056a61aa8b64
