...
Note that some details where ommited for the sake of simplicity.
...
Again, note that some details for th Logic component where ommited for the sake of simplicity.
