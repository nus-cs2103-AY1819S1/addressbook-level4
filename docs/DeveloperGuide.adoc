...
==== Design Considerations
===== Aspect: Lesser restriction to the inputs of the command
...
.. Prerequisites: List all persons using the list command. Multiple persons in the list.
.. Test case: `addTime 1 ts/mon 1300 1500` +
...
.. Test case: `addTime 2 ts/mon 1300 1500` +
   Expected: Nothing happened. Error details shown in the status message. Status bar remains the same.
.. Test case: `addTime 1 ts/mon 1400 1600` +
   Expected: Nothing happened. Error details shown in the status message. Status bar remains the same.
.. Test case: `addTime 1 ts/tues 1300 1500` +
   Expected: Nothing happened. Error details shown in the status message. Status bar remains the same.
.. Test case: `addTime 1 ts/tue 1 3` +
   Expected: Nothing happened. Error details shown in the status message. Status bar remains the same.
.. Test case: `addTime 1 ts/tue 1300 1500` +
...
.. Prerequisites: List all persons using the list command. Multiple persons in the list. Performed `addTime 1 ts/mon 1300 1500`.
.. Test case: `deleteTime 2 ts/mon 1300 1500` +
   Expected: Nothing happened. Error details shown in the status message. Status bar remains the same.
.. Test case: `deleteTime 1 ts/mon 1200 1500` +
   Expected: Nothing happened. Error details shown in the status message. Status bar remains the same.
.. Test case: `deleteTime 1 ts/mon 1300 1500` +
