...
|`* * *` |student |clear the screen |have my command-line interface cleaned of commands and result

|`* *` |student |sort tasks by category |know what I need to do for each aspect of my life
...
1.  User requests to add exam into Student Schedule Planner.
2.  Student Schedule Planner add the exam into exam list.
+
Use case ends.
...
[none]
* 1a. The add Exam command did not follow the correct format.
+
[none]
...
1.  User requests to view exam list from Student Schedule Planner.
2.  Student Schedule Planner display the exam list.
+
Use case ends.
...
[none]
* 1a. The list exam command did not follow the correct format.
+
[none]
** 1a1. Student Schedule Planner shows an error message.
+
...
[discrete]
=== Use case: Modify Exam

*MSS*

1.  User requests to list exam list from Student Schedule Planner.
2.  Student Schedule Planner display the exam list.
3.  User request to edit a specific exam in the list.
4.  Student Schedule Planner updates the exam.
+
Use case ends.
...
Use case ends.
[none]
* 3a. The Modify exam command did not follow the correct format.
+
[none]
...
1.  User requests to list exam list from Student Schedule Planner.
2.  Student Schedule Planner display the exam list.
3.  User request to delete a specific exam in the list.
4.  Student Schedule Planner delete the exam.
+
Use case ends.
...
Use case ends.
[none]
* 3a. The Delete exam command did not follow the correct format.
+
[none]
** 3a1. Student Schedule Planner shows an error message.
+
...
[discrete]
=== Use case: Search Exam

*MSS*

1.  User requests to search a specific exam from Student Schedule Planner.
2.  Student Schedule Planner filter the exam by the given parameter.
3.  Student Schedule Planner display the filtered exam.
+
Use case ends.
...
[none]
* 1a. The search exam command did not follow the correct format.
+
[none]
** 1a1. Student Schedule Planner shows an error message.
+
Use case resume at step 1.
[none]
* 3a. The filtered exam list is empty and thus display empty list.
+
Use case ends.
