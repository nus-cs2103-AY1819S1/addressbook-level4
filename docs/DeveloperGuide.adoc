...
The _Sequence Diagram_ below shows how the components interact for the scenario where the user issues the command `playlist del p/Fav`.

.Component interactions for `playlist del p/Fav` command (part 1)
...
.Component interactions for `playlist del p/Fav` command (part 2)
...
image::DeletePlaylistSdForLogic.png[width="800"]
