...
Step 1. The user types in a valid `AddCommand`, for example,
`add n/1 TB Toshiba SSD p/158 d/200d`, and the current date is 2nd October 2017 (2/10/2017).

[NOTE]
====

* The Date should be in the format of `dd/mm/yyyy`, `dd` being days,
`mm` being months, `yyyy` being the year,
and the specified date should also be a valid date in the future.
