...
6. `LogicManager` will the proceed to call the `execute` command of `AddTagCommand`.
...
* Solution
** You can modify the existing test methods for `EventCard` 's to include testing the tag's color as well.
