...
The groupadd parser is indicated as `groupaddCommand` in `parsers`, and inherits the `Parser` class. It enables the application to handle the input given by the the user, check its validity and delete whitespaces.
...
The groupdelete parser is indicated as `groupdeleteCommand` in `parsers`, and inherits the `Parser` class. It enables the application to handle the input given by the the user.
...
The showgroup parser is indicated as `showgroupCommand` in `parsers`, and inherits the `Parser` class. It enables the application to handle the input given by the the user.
...
REMOVED IMPLEMENTATIONS AND ADDED ABOVE AT 3.
