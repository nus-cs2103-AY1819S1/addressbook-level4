...
image::AddModuleToStudentStaged/TakenCommandUML.png[width="350"]
...
image::SDforAddModuleToStudentStaged/TakenCommandLogicAndModel.png[width="900"]
...
image::SDforAddModuleToStudentStaged/TakenCommandOverview.png[width="800"]
