...
The _Medicine_ class and the properties of the medicine are stored under the Model package.
...
You can refer to <<ModelComponent, modelcomponent>> to see where are the classes located.
...
`editmedicine` to correct the serial number. Figure xxx shows the execution of the code.
