...
.. Test case: `clear CCA` +
   Expected: Person(s) associated with `CCA` is/are cleared from the list.
.. Test case: `clear ROOM` +
   Expected: Person(s) associated with `ROOM` is/are cleared from the list.
.. Test case: `clear CCA ROOM` +
   Expected: Person(s) associated with `CCA` or `ROOM` is/are cleared from the list.
.. Test case: `clear CCA` (where `CCA` does not exist in list) +
...
.. Prerequitsites: List all persons using the `list` command. Multiple persons in the list.
.. Test case: `erase CCA` +
   Expected: `CCA` is removed from associated person(s) in list.
.. Test case: `clear CCA...` +
   Expected: `CCA`s are removed from associated person(s) in list.
.. Test case: `clear CCA` (where `CCA` does not exist in list) +
