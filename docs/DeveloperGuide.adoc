...
|`* *` |Employee with "Administrative" permissions |Modify the access permissions of an employee |Give the employee higher or lower access to features of the system, possibly in line with promotions or demotions
