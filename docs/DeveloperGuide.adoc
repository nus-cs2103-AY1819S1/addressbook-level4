...
** Pro: Offline mode introduced at the code level to disable certain Google Calendar functions.
** Con: Have to write seperate set of tests and helper functions.

* **No offline mode** (alternative)
** Pro: Easy to implement.
** Con: Running the current set of test cases will certainly sending too many requests to Google.
