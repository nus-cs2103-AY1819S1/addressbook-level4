...
|`* * *` |medical clinic receptionist |assign a queue number for each patient |patient can be called for consultatoin using his/her queue number

|`* * *` |medical clinic receptionist |assign a patient to a queue based on his/her nric|i do not have to scroll through the displayed patient list to look for the patient's index

|`* * *` |medical clinic receptionist |view the length of the queue|respond to quickly and accurately to patients asking for the number of patients in the queue
