...
* `PersonContainsKeywordPredicate` takes in a `HashMap` of `Prefix` mapped to an `ArrayList` of search parameters.
The image below illustrates how the mapping is done for the user input `find n/Alex n/Bernice t/friends`.

.PersonContainsKeywordPredicate HashMap
image::FindCommandDeveloperGuideHashMap.png[width="600"]
