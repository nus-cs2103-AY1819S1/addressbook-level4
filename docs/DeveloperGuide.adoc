...
Given below is an example usage scenario and how the relevant classes behave at each step.
At the end of the explanation is a link:{repoURL}/src/main/java/seedu/address/storage/Storage.java[sequence diagram] of a typical addappt command execution.
