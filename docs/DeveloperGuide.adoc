...
_Figure 3. High Level Sequence Diagram showing how the Storage component handles the `SaveUserChangedEvent`
...
** Pros: Will use less storage space (e.g. for `delete`, just save the person being deleted).
