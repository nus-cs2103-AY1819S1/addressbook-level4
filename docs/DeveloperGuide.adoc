...
Step 5: Following that, the corresponding description of `ToDoListEvent` will be showed and displayed on th a popup window.
...
* `ShowDescriptionCommand` -- Show description of selected(index input) todolist event with an additional popUp window.
