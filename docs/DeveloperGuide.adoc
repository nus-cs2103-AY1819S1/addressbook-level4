...
.. Test Case: `receipt 1`
.. Expected: A `Receipt` is generated for the `ServedPatient` of position 1 in the `ServedPatientList`.
...
.. Test Case: `mc 1`
.. Expected: A `MedicalCertificate` is generated for the `ServedPatient` of position 1 in the `ServedPatientList`.
A window will pop up to show the contents of the generated `MedicalCertificate`.
...
.. Test Case: `refer 1`
.. Expected: A `ReferralLetter` is generated for the `ServedPatient` of position 1 in the `ServedPatientList`.
A window will pop up to show the contents of the generated `ReferralLetter`.
