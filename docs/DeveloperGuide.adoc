...
* 1a. User enters invalid personal event or invalid command.
+
** 1a1. System displays error message.
+
Use case ends.
...
+
** a1. System abandons the meeting being set up, and returns to original screen.
+
Use case ends.
