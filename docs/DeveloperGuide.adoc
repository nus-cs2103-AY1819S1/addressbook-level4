...
The section below will describe in detail the Current Implementation and the Design Considerations of the User Account feature.

==== Current Implementation

The User Account feature is facilitated by the following classes:
...
Step 1. The user launches the application for the first time. The `currentUser` will at this point be `null`.
