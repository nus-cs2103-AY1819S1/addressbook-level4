...
>>>>>>> b79a7a261a54c79599367f606f400fab6db4d389
...
The `exportcert` command enables the volunteer manager to export a PDF document detailing a volunteer's involvement with the organisation, to his/her Desktop. This is only possible when in the 'volunteer' context. The information included in the certificate are as follows:

* Organisation's logo
* Volunteer Name and NRIC
* Date of PDF certificate creation
...
* Export of the PDF document to the user's Desktop.
