...
==== Other notes
Since the the recipe list has to be visible for users to select recipes to add to
...
displaying the Meal Planner.

****
MealPlanner can be displayed by typing in the following commands in order:

1. *-mealplanner*

2. *display*

_Meal Planner is then displayed, showing the current list of Days with plans_
****
