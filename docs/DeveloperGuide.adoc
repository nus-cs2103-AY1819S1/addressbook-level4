...
This feature can be implemented in different ways. Below
...
** Cons: Time-consuming. Tends to work slower when there is a large number of expenses.
...
** Cons: Need extra space as one expense may belong to different files.
