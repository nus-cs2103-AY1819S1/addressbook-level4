...
image::EmailActivityDiagram.png[width="1500"]
...
_Figure 4.3.1.6: Activity diagram for budget command_
...
.. Test case: `compose_email_list from/john@gmail.com to/1 2 subject/Example Subject content/Example Content` +
   Expected: Email displayed on the BrowserPanel with the emails of the first and second contact as recipients of the email.

.. Test case: `compose_email_list from/john@gmail.com to/100 subject/Example Subject content/Example Content` +
   Expected: Email not displayed on the BrowserPanel. Error details shown in the status message.

.. Test case: `compose_email_list from/john@gmail.com to/0 subject/Example Subject content/Example Content` +
   Expected: Email not displayed on the BrowserPanel. Error details shown in the status message.
...
=== Add all day event into monthly Calendar
...
=== Add event into monthly Calendar
...
=== Delete event from monthly Calendar
