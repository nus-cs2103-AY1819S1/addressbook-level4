...
The following activity diagram summarizes what happens when a user executes a create command:

image::CreateCcaActivityDiagram.png[width="650"]
...
image::UpdateCcaActivityDiagram.png[width="650"]
...
image::AddTransActivityDiagram.png[width="650"]
...
The following sequence diagram shows how the budget operation works:

.Sequence diagram for budget command
image::BudgetCommandSequenceDiagram.png[width="1500"]

The following activity diagram summarizes what happens when a user executes a budget command:

image::BudgetActivityDiagram.png[width="650"]
