...
depend on a list of patients. It then passes the data to `ExportUtil` in order to write to a CSV file. The names and
locations of the CSV files are predetermined by `ExportPatientData`.
