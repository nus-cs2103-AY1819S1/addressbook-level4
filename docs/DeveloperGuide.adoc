...
2.  System creates a new playlist and saves it to libaray.
+
Use case ends.
...
1.  User requests delete a playlist.
...
1.  User enters commands to add a track into a playlist.
...
1.  User enters commands to delete a track from a playlist.
...
[none]
* 2a. No track in current playlist.
+
[none]
...
1.  User requests to play tracks in a playlist.
...
2.  System jumps to the point and play from the point.
+
Use case ends.
...
1.  User requests to step forward/backwards a range of time in the playing of current track.
...
1.  User enters commands to skip the next/previous track.
2.	System goes to the next/previous track and play the track.
+
Use case ends.
...
2.	System changes to "repeat track" mode and current track will be played repeatly.
...
5.	User enters the repeat off command.
6.	System changes to "repeat off" mode and the playlist will stop after playing all the tracks.
+
Use case ends.
...
1.  User requests shuffle the playlist.
