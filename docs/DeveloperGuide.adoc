...
If it is the first time the user launch the application or if user deleted `rangeofweek.xml` or modified the file
...
.. Test case: `firstday 130818` +
   ...
   relaunch the application, the application title will be appended with current week's description.
