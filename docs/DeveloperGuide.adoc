...
will test each ride using this method:
...
changes to other classes. After that a list of filtered rides would be returned after each ride is tested with the predicate.
