...
. Giving discount to all item in the displayed item list

.. Prerequisites: You must have at least 1 item in the menu.
.. Test case: `discount-item ALL dp/20` +
   *Expected*: Gives all items in the displayed item list a discount. Number of items given a discount shown in status message.
