...
The sequence diagram in Figure 4 shows the execution of the given scenario:
...
---
The activity diagram in below summarises what happens when a user executes the `addmh` command.
