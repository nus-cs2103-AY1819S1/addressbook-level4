...
command is implemented such that it is able to create a `MedicalHistory` object for a specific `Patient`.

Step 1. The user types in `add-medical-history` in the command box followed by the parameter `n/John Doe al/milk c/sub
healthy`
