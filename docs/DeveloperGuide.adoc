...
.. Prerequisites:
Event Organiser already has a user with name as "Alex Yeoh" and password as "password".
No user is currently logged in.
The Event Organiser does not have a user with name as "Michael Lim" and password as "password".
.. Test case: `login`
...
=== Find users
.. Prerequisites: Event Organiser currently has two user accounts.
