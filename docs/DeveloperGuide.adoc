...
The following class diagram below illustrates the association between the Patient class and its associated class:

.Class Diagram for the Patient.
image::PatientClassDiagram.png[width="1080"]
{sp} +
