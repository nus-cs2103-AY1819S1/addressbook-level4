...
key,
 and `IngredientPortion` object as a value. It is to store the information of needed amount of an ingredient obtained
  from the calculation in amount field of IngredientPortion object.
...
field. Ingredient again inherits IngredientPortion, which is the most complete version of ingredient with date
