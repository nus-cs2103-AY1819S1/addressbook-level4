...
image::MaxScheduleDiagram.png[width="300"]
...
Step 4. The filtered lessons is then converted into an arraylist of Slot.

Step 5. The arraylist of Slot will be passed in a Schedule constructor to generate a new schedule.
