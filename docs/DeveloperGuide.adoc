...
The following activity diagram shows how the `delete` command may be used from a user's perspective:

image::DeleteActivityDiagram.png[width="800"]

In implementing this feature, there are two key components to consider.
