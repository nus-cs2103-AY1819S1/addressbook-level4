...
.. Other incorrect addmedicine commands to try: `addmedicine`, `addmedicine/e` (where e is a unrecognised parameter) +
...
.. Other incorrect editmedicine commands to try: `editmedicine`, `editmedicine/e` (where e is a unrecognised parameter) , `em 1 msq/-2`+
