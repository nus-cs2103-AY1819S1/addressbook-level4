...
The `Model` component consist of a `ModelManager` that manages all the models.
...
The `Storage` component consist of a `StorageManager` that takes care of all the Input/Output actions.
