...
image::import.png[width="550"]

image::import_user_input.png[width="550"]

Step 3. If no such file exists, InsuRen will report an error.

image::import_user_input_fail.png[width="550"]
...
image::import_success.png[width="550"]

image::import_duplicates.png[width="550"]
