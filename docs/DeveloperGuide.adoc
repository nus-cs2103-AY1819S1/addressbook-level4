...
.. [green]#Test case:# `track add p/Favourites i/1 i/2` +
...
.. [green]#Test case:# `track del p/Favourites i/1 i/2` +
Expected: First and second tracks of "Favourites" playlist are removed from playlist.
