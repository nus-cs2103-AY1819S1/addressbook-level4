...
* Additional fields for volunteers, such as number of volunteer hours
* Viewing of volunteer and event statistics

=== Core Team

SocialCare was developed and is maintained by https://github.com/CS2103-AY1819S1-W16-2[Team W16-2]. Due credit goes to the https://se-edu.github.io/docs/Team.html[se-edu] team, who's application https://github.com/nus-cs2103-AY1819S1/addressbook-level4[Address Book - Level 4] was morphed into SocialCare.
