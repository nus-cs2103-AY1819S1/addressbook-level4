...
=== Use case: View clinic analytics

Actor: <<medical-clinic-receptionist, Medical Clinic Receptionist>>, <<doctor, Doctor>> +

*MSS*

1. Actor requests to view average or total analytics.
2. System computes values for each statistic of the respective type.
3. System displays numerical summary and a single chart.
+
Use case ends.

*Extensions*

* 3a. Actor requests to view another chart.
	** 3a.1 System computes values for the respective chart.
	** 3a.2 System replaces display with the new chart.
+
Use case ends.
