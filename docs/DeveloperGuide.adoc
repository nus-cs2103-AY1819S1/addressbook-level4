...
The following activity diagram summarizes how passwords are processed during the login and registration process:
...
The application's user session state is facilitated by `UserSession`. This is triggered by raising a `Login` and
