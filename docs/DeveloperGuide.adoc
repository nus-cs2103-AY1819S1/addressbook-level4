...
.SortMenu Activity Diagram
image::SortMenuActivityDiagram.png[caption=""][width="650"]

The following sequence diagram shows how the `sort-menu` command works:

.SortMenu Sequence Diagram
image::SortMenuSequenceDiagram.png[caption=""][width="1000"]
// end::menuPart2[]
