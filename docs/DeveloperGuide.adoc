...
By: `Team W10-03`      Since: `Jun 2016`      Licence: `MIT`
...
#### Keng Ji : Add event feature and search for participants

- [ ] v1.1: able to create a basic event
- [ ] v1.2: able to add basic event details, and filter users by various criteria
- [ ] v1.3: enable voting feature for location and time

#### Yao Feng : Add scheduling and recommend best time feature
- [ ] v1.1: able to input user schedule and preferred timings
- [ ] v1.2: able to rank most popular timings for an event
- [ ] v1.3:

#### Zhang Cheng :
- [ ] V1.1: Able to specify friendships with other people
- [ ] V1.2: Able to form groups and find mutual friends
- [ ] V1.3: Able to visualise groups

#### Adeel :
- [ ] V1.1: Implement voting for meetup places, choose most popular place from votes
- [ ] V1.2: Implement Google maps visualisation
- [ ] V1.3: Implement recommendation of best meetup location via MRT lines

#### Jason : Event Management/Recommendation
- [ ] V1.1: Implement Event management Tab / Allow Event Data Storage
- [ ] V1.2: Pull schedule from NUS Mods and create union of multiple schedules
- [ ] V1.3: Visualize the most popular threading event criteria
