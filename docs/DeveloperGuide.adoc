...
ClinicIO ensure that proper user access rights is given and authenticated by login to ClinicIO.

==== Current Implementation

The login mechanism uses an immutable list to retrieve a list of doctors or receptionist based on user role.
