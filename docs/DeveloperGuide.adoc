...
both models have to be passed to *PlanCommandParser*.

Within *PlanCommandParser*, it parses the target _date_ from a *String* into a *LocalDate*.
...
taken from _mealPlannerModel_ to be used in *PlanMealCommand*
