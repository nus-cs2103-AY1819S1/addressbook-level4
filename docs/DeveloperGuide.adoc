...
.. Prerequisites: The reservation to be added must not be a duplicated entry in the reservations list and you must be
                  logged in.
...
.. Prerequisites: You must have at least 1 reservation in the reservations list.
...
.. Prerequisites: The reservation to be edited must be an existing entry in the reservations list and you must be
                  logged in.
...
.. Prerequisites: The reservation to be deleted must be an existing entry in the reservations list and you must be
                  logged in.
...
.. Prerequisites: You must be logged in and the reservations list must be populated with more than one entry. +
(and preferably be initially unsorted, to see the effects of the sort command)
