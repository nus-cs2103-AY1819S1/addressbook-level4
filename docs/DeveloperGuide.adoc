...
Step 1. The user launches the application. For simplicity, we assume that the groups `Project2103`, `Presentation` and `FrisbeeTeam` are present in the MeetingBook. None of these groups have a meeting scheduled.
