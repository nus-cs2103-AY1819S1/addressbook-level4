...
two commands. First and foremost, we will need users to be logged in to edit or delete his/her user account. Once the user issues an `deleteUser` command, it is automatically assumed that the user wants to
delete his/her own account. This ensures that only the user of the account is allowed to delete
his/her account. Once the user issues an `editUser` command, it is also automatically assumed that the user wants to
