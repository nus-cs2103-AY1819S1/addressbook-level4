...
+
[none]
** 1b1. AddressBook prompts user to include any more missing fields, or to input nothing and continue otherwise.
...
+
[none]
** 2a1. AddressBook returns the next meeting after the specified time.
+
Use case ends.
...
+
[none]
** 2b1. AddressBook states that there are no meetings scheduled
+
Use case ends.
...
2. AddressBook will add meeting field to specified contact. Meeting will be displayed the next time user executes ‘list’.
+
Use case ends.
...
+
[none]
** 1a1. AddressBook prints error message, prompting user to re-enter a valid ‘schedule’ command. 
+
...
2. AddressBook alerts the user of clients with expiring insurance plans every time it is initialized.
+
Use case ends.
...
+
[none]
** 2a1. AddressBook notifies the user that there are no imminent expiries.
+
Use case ends.
...
2. AddressBook loads new contacts from import file, appending the new contacts to the end of the existing contact list. 
+
Use case ends.
...
2. AddressBook compiles all emails into a csv, saves it in the given directory. 
+
Use case ends.
...
2. AddressBook edits the client’s respective fields, and displays a confirmation message.
+
Use case ends.
...
+
[none]
** 1b1. AddressBook prompts user to include any missing fields, or to input nothing and continue otherwise.
** 1b2. User inputs any additional fields/nothing.
+
...
+
[none]
** 1c1. Ask for the user to specify a field (p/, e/, a/) and the value of the field that will identify that specific person
** 1c2. The user inputs that field.
** 1c3. AddressBook prompts the user to type the fields to be modified.
+
Use case resumes at step 2 if fields are inputted, otherwise display a confirmation that nothing was changed. 
...
2. AddressBook requests for the client’s name.
3. User specifies the client’s name.
4. AddressBook requests for the file location.
5. User specifies the file location.
6. AddressBook uploads the file and tags it to the client’s profile.
+
Use case ends.
...
* 5a. AddressBook detects an error in the entered data.
+
[none]
** 5a1. AddressBook requests for the correct data.
+
...
2. AddressBook shows a list of frequently contacted clients.
+
Use case ends.
...
+
[none]
** 1a1. AddressBook requests for a upper limit.
...
2. AddressBook recognises that the contact is a duplicate and informs user of existing contact.
...
+
[none]
** 1a1. AddressBook allows user to create near-duplicate contact instead of editing existing contact.
+
Use case ends.
...
1. User creates a group in AddressBook that can store clients’ contacts, specifying the group name.
2. AddressBook creates a new group.
...
+
[none]
** 1a1. AddressBook prompts user to choose a different name that will be unique.
+
Use case resumes at step 1.
...
+
[none]
** 1b1. AddressBook prompts user to type in a group name.
+
Use case resumes at step 1.
