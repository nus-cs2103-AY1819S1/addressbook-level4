...
* `bgcolour` - Sets the background colour of the canvas.
...
Step 6) The user finally saves the output with the `canvas save` command.

Step 7) `Canvas#save` then saves the output to disk.
