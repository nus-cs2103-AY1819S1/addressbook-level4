...
image::EffectiveDueDate1.png[width="600"]
...
image::EffectiveDueDate2.png[width="600"]
_Diagram of Due Dates and Effective Due Dates for test case 1_

.. Test case 1: `dependency 2 1`, `select 1` or click on Task A +
Expected: EffectiveDueDate Dependency added between task B and task A. Effective due date of A now specifies 1-1-18.
Number of dependencies field on the task card updated.

image::EffectiveDueDate3.png[width="600"]
