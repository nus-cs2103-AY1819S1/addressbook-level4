...
image::Sequence Diag logic.png[width="1200"]
...
.. Other incorrect schedule commands to try: `schedule` with missing non-optional parameters or invalid values
   Expected: Corresponding error details shown.
