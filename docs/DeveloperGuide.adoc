...
It allows a user to save their data as a XML file.
...
** Pros: The key will be more secured compared to the key generated from alternative 1 since a weak password may be used by a user (susceptible to password cracking).
