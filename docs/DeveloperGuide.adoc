...
2.  MeetingBook updates the task list.
3.  MeetingBook informs the student that the task has been successfully added, and refreshes the main page to reflect the newly updated task list.
+
Use case ends.
...
[none]
** 2a1. MeetingBook informs the student that he/she has entered invalid parameters.
+
Use case ends.
...
2.  MeetingBook returns a list of tasks that matches the keyword.
+
Use case ends.
...
[none]
** 2a1. MeetingBook informs the student that there are no tasks that match the keyword entered.
+
Use case ends.
...
2.  MeetingBook returns a feedback to inform student that the task has been marked as done successfully.
3.  MeetingBook updates the task list to remove the task that is marked as done.
+
Use case ends.
...
2.  MeetingBook returns a feedback to inform user that the task has been successfully edited.
3.  MeetingBook updates the task list with updated information.
+
Use case ends.
...
2.  MeetingBook returns feedback to inform user that the task has been added and attached to parent task.
3.  MeetingBook updates the task list with newly added task.
+
Use case ends.
...
2.  MeetingBook creates the category.
3.  MeetingBook feedbacks that the category had been successfully created.
+
Use case ends.
...
4.  MeetingBook scans and imports the data.
+
Use case ends.
...
[none]
** 4a1. MeetingBook will show an error telling the student that the file is corrupted.
+
Use case ends.
...
3.  MeetingBook updates the command field with the highlighted command from the suggestion list.
+
Use case ends.
