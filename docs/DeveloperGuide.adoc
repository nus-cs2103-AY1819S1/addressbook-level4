...
Example: `addGroup n/CS2103T`: This command adds a new group with title 'CS2103T' into the MeetingBook.
...
Example: `deleteGroup n/CS2101`: This command removes the existing group with title 'CS2101' from the MeetingBook.
...
Example: `join n/Derek g/CS2101`: This command make the person 'Derek' become a member of group 'CS2101'
...
Example: `leave n/Ben g/CS2103T`: This command remove the person `Ben` from the group `CS2103T`.
