...
Step 3. MainWindow responds to the ChangeViewEvent and creates a new TaskListPanel instance with Tasks in filteredArchivedTaskList from logic.

Step 4. The new TaskListPanel is placed in the TaskListPanelPlaceHolder. The archived tasks are now displayed.
...
The `progress` command displays the percentage of tasks for today that is archived.
