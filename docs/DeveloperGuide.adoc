...
[NOTE]
This section is written with reference to commit: 9ddb0ffddf5d769d357e28fbd5337011614e7b14
...
result a new `CompleteCommand` instance containing a  `LabelMatchesAnyKeywordsPredicate` which
