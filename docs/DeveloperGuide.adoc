...
==== Current Implementation
The `cancelAppt` command functions similarly to the `delete` command.
It updates the STATUS field of the target Appointment object to 'CANCELLED'.
The object is removed from the UniqueAppointmentList and added to the Patient's consultation history.

image::CancelApptSequenceDiagram.png[width='700']
//end::cancelappt[]
