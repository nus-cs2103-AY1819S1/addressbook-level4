...
it formats just the _Name, Classification and Active Ingredients_ of the drug results in the cache
...
not less than or equal to zero, and not larger than 10,000.
