...
ClinicIO The login mechanism facilitated by using `UniqueStaffList` to retrieve a list of staffs. +
...
Step 2: The `login` command call `Model#hasStaff()` to ensure that this staff record exist inside ClinicIO. +
