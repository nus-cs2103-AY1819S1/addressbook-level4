...
image::ScheduleCommand1StateDiagram.png[width="800"]
...
image::ScheduleCommand4StateDiagram.png[width="800"]

The following activity diagram summarises what happens when a user executes the `ScheduleCommand`:

image::ScheduleCommand5StateDiagram.png[width="800"]
