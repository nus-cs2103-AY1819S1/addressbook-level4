...
- [x] V1.1: Users able to login.
- [ ] V1.2: Organisers can search for event participants based on interests, friendships, schedule and address.
- [ ] V1.3: Users can rate the event after it is held.
