...
[discrete]
=== Use case: View all patients record

Actor: <<medical-clinic-receptionist, Medical Clinic Receptionist>>

*MSS*

1.  Actor(s) chooses to view all patients record
2.  System retrieve and display all patients record.
+
Use case ends.

*Extensions*

* 2a. The system cannot find all patient records.
...
Actor: <<medical-clinic-receptionist, Medical Clinic Receptionist>>, Doctor
