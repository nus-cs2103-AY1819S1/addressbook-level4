...
|`* *`|User trying to be more healthy | be recommended healthy recipes by the system | save the effort needed to search online
...
[discrete]
=== Use case: Search recipes based on ingredients manager availability

*MSS*

1. User list ingredients (UC11)
...
=== Meal Planner
[discrete]
=== Use case: Add recipe to meal planner
...
[discrete]
=== Use case: Delete recipe from meal planner
...
=== Recipes Management and cook-mode
[discrete]
==== Use case: UC01 – Search for Recipe
*MSS*
...
[discrete]
==== Use case: UC02 – View Recipe
*MSS*

1.	User +++<u>searches for recipe (UC01)</u>+++.
...
[discrete]
==== Use case: UC04 – Navigate Recipe
*MSS*

1.	User +++<u>views recipe (UC02)</u>+++.
...
3. AddressBook creates the plan
+
Use case ends.
...
2. AddressBook retrieves the list of plans by user
3. User select the plan to edit
4. User enters the new details to the plan
5. AddressBook updates the details.
+
Use case ends.
...
==== Use case: Delete plan

*MSS*

1. User requests to delete plan
2. AddressBook shows list of plans
3. User selects plan to delete
4. AddressBook deletes the selected plan
+
Use case ends.
...
[none]
* 2a. No pre-exisiting plan
+
Use case ends.

==== Use case: Enter dietary intakes for the day
...
4. AddressBook shows list of recipes to select
5. User selects recipe to add into list
6. AddressBook adds the recipe to list
+
Use case ends.
...
==== Use case: Remove an recipe from the dietary intakes for the day

*MSS*

1. User request to remove recipe from intake list
2. AddressBook shows list of recipes
3. User selects recipe from the list
4. AddressBook removes the selected recipe from the list.
+
Use case ends.
...
==== Use case: View nutritional Intake

*MSS*

1. User requests to view nutritional intake entered
2. AddressBook retrieves the list of intakes to show the user
3. AddressBook retrieves the nutritional facts based on the recipes in the list to show the user.
...
==== Use case: Compare actual intake against target

*MSS*

1. User requests to compare the entered data against set target.
2. AddressBook shows Target set by User.
3. AddressBook calculates and shows the actual intake by user.
4. AddressBook calculates the difference in the 2 scores and shows the user the percentage difference(positive or negative) from set target.
+
Use case ends.
