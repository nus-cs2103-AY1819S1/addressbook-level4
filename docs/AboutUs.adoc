...
Role: Team Lead +
Responsibility: In charge of Git, Project Management
...
Role: Developer +
Responsibility: In charge of Storage, Deliverables and deadlines
...
Role: Developer +
Responsibility: In charge of UI, Model
...
Role: Developer +
Responsibility: In charge of UI, Testing
...
Role: Developer +
Responsibility: In charge of Integration, Code consistency
