...
{empty}[https://github.com/CrimsonJacket[github]] [<<crimsonjacket#, portfolio>>]
...
{empty}[http://github.com/deming16[github]] [<<deming16#, portfolio>>]
...
{empty}[http://github.com/RTJL[github]] [<<rtjl#, portfolio>>]
