...
Change the current password of the app to `NEW_PASSWORD`. This provides users with the ability to use a different password in the event that the old password was compromised. +
