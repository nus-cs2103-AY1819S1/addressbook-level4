...
If you can type fast, HealthBook can help you maintain a clean and clear information management of your doctors and patients more efficiently compared traditional GUI apps.
...
Shows a list of all persons in the HealthBook. +
Format: `list`
