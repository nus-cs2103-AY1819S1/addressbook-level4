...
|CREATE_ASSIGNMENT (Currently not used)|Allows user to create a project
|ASSIGN_ASSIGNMENT (Currently not used)|Allows user to assign employee to a project
|VIEW_ASSIGNMENT (Currently not used)|Allows user to view all projects
