...
Clears all persons from Hallper. +
Format: `clear all`
...
Format: `export dst/PATH fn/FILENAME`

****
* The file exported will be a *`.xml`* file.
****

File format for exported `.xml` file is as shown below.

image::AddressBookExample.png[width="790"]
_Figure 4.1.8.1: Contacts information `.xml` file format._
