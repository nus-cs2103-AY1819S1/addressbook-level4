...
Format: Edit NAME FIELD_NAME NEW_INFO (FIELD_NAME NEW_INFO)… end

****
* _ can be used to define compound ingredient name e.g. Spring_Onion
...
Format: Select [NUMBER_OF_SERVINGS] KEYWORD… optional KEYWORD… end
...
==== Cook-mode (view full recipe): `cook`
After displaying the meal planner, enters cook-mode by displaying the full recipe at the specified meal slot

Format: `cook DAY MEAL`

== OLD TO BE DELETED (See examples here)
