...
****
WARNING: After a patient has been checked out from the system, all commands concerning this patient (except `checkin`
command) will be considered as invalid commands.
****
