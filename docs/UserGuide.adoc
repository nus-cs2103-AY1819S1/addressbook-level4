...
* We store all of the eventorgansiser data under data/addressbook.xml
* This file is to be stored securely on the computer. No user is allowed to open the xml file using a text editor.
