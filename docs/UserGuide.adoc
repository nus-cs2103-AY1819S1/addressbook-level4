...
.  Double-click the `expensetracker.jar` file to start the app. The GUI will appear in a few seconds and will look like this:
+
...
[NOTE]
====
* Keywords are case insensitive, i.e. the KEYWORD `hans` is equivalent to the KEYWORD `Hans`
