...
LearnVocabulary is for those who prefer to use an offline version of the dictionary for learning purposes. More importantly,
...
****
* the group name is not set to be four per line
****
