...
The *record list* keeps all sales records you have recorded.
====
...
its required ingredients have been specified in the menu component.
====
...
* DATE must be written in the DD-MM-YYYY format.
* DATE must exist in the calendar.
* There must be at least one <<sales-record, sales record>> associated with the specified DATE.
****
