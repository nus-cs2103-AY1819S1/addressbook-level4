...
[width="88%",cols="14%,<30%,<30%",options="header",]
|=======================================================================
...
| *Suggest Location* | `generateLocation event/EVENT_NAME group/GROUP_NAME` | `generateLocation event/First Meeting group/CS2103Group`
...
| `editEventAddress d/2018-04-01 i/1 a/NUS SoC`
| *Add Event Tag* | `addEventTag [t/EVENT_TAG...]` | `addEventTag t/Lecture t/Dinner`
