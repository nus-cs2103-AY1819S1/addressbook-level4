...
. User types in the command `setRecurrenceFrequency hrs/24` as he wants his available spending to reset every day
when he receives his allowance.
. User closes his application.
. User reopens his application on the next day to record another expense.
. His available spending will now be reset as it is past the set frequency of one day. A notification will be shown
