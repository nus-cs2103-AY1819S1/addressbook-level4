...
and only the full name "accelerator" will work.
...
selected. Future versions will allow you to see the first ride selected or show the short help menu if no rides are found.
// end::filter[]
