...
* The specified contact will then have a `GROUP_NAME` tag in his or her details.
****
...
The `John` that has been specified will be added to the group `Work`. If `Work` tag does not exist already, it will be
created now.
...
****
* All contacts in `GROUP_NAME` will be removed from the group. Their `GROUP_NAME` tag will be deleted.
