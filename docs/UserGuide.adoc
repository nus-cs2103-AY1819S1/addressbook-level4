...
****
WARNING: After a patient has been checked out from the system, any commands which select or add information to this
patient will be considered as an invalid command.
****
