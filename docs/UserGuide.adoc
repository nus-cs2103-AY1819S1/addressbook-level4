...
****
* This will display all person in the group of the selected group if `select group` is used.
* If `select group` is called, the person list will be filtered to show only person who belong to the group.
****
