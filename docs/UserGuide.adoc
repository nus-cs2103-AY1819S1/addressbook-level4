...
image::archiveTask.png[width="600"]
====
The [blue]`INDEX` refers to the index number shown in the displayed task list. Refer to the task according to the index number.
The [blue]`INDEX` *must be a positive integer* 1, 2, 3, ...
[TIP]
...
image::listArchive.png[width="600"]
...
image::ListWeekCommand_UG_Before_After.png[width="600"]
====
// end::listweek[]
...
image::Before-after-showtags.png[width="600]
====
// end::showtags[]
// tag::progressbar[]
...
image::before-after-progresstoday.png[width="600"]
====
...
image::before-after-progressweek.png[width="600"]
====
// end::progressbar[]
