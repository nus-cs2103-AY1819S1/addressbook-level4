...
[TIP]
====
Every time you open the app, it will also pop up past reminders since the last time you close the app.
====
...
****
* If you have not set any reminder for the event or the reminder has already popped up previously, it will display as "No reminder".
