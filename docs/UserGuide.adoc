...
definition in the <<sales-record, glossary>> before proceeding.
...
single entry in the <<record-list, record list>>. It comprises 6 different attributes, namely +
...
The *record list* contains all the <<sales-record, sales records>> you have recorded till date. It is shown under the
