...
Available options inside the menu bar: +
...
This component allow you to enter command input. +
...
[WARNING]
You must not be login in order to use this feature. +
...
Prior to logging in to ClinicIO, the ClinicIO user status will show that you have not logged in yet.
