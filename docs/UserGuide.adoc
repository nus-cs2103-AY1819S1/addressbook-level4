...
* Each poll in the event is given a unique index.
****
...
****
* The poll index specifies the index of the poll in the selected event, which can be viewed by selecting the event using `selectEvent`.
* An event must first be selected.
