...
Imports file containing residents information and updates Hallper accordingly. +
...
_Figure 4.1.10.1: Resident information format._

image::CCAListExample.png[width="790"]
_Figure 4.1.10.2: CCA list format._

image::BudgetBookExample.png[width="790"]
_Figure 4.1.10.3: Budget book information format._

image::TransactionsExample.png[width="790"]
_Figure 4.1.10.4: Transaction information format._
