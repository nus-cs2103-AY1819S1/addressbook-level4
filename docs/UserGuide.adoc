...
.A screenshot illustrating the screen that users will see on startup
image::Ui.png[width="790"]

The figure above displays the list of volunteers in the application.

.A labelled screenshot of the parts of the application
image::UiLabelled.png[width="790"]

The figure above shows the typical arrangement of the parts of the application.
