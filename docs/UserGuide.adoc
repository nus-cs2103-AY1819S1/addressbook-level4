...
* Your leave will be applied for all the dates specified after each `-da`. You must specify at least 1 `DATE`.
****
...
The system will display a message indicating a succesful creation of the new leave. You should see something as follows:
...
A list of your leave records will be displayed in the panel on the left. An example of what you should see is shown below:
