...
* `e 2 n/Betsy Crowe t/` +
Edits the name of the 2nd patient in the list to 'Betsy Crowe' while clearing all existing tags tied to the 2nd patient.
...
Adds a medicine _named_ 'panadol' with _minimum stock quantity_ of '500' units, _price per unit_ of $'0.50', _serial number_ of '1234' and _stock_ of '500' units to the CLInic inventory.
* `am mn/asprin msq/100 ppu/0.20 sn/3068 s/100` +
Adds a medicine _named_ 'asprin' with _minimum stock quantity_ of '100' units, _price per unit_ of $'0.20', _serial number_ of '3068' and _stock_ of '100' units to the CLInic inventory.
...
* `fm chlorpheniramine` +
Finds the details of the medicine tagged with the keyword 'chlorpheniramine'.
