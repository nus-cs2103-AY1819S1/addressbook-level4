...
Format: `addUser n/NAME p/PHONE_NUMBER e/EMAIL pass/password a/ADDRESS [i/INTEREST] [t/TAG] [tt/ TIMETABLE]...`
...
Format: `editUser INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [i/INTEREST] [tt/TIMETABLE] [s/SCHEDULE] [su/SCHEDULE_UPDATE] [t/TAGS] ...`
...
* *Add User* `addUser n/NAME p/PHONE_NUMBER e/EMAIL pass/PASSWORD a/ADDRESS [t/TAG] [i/INTEREST] [tt/ TIMETABLE]...` +
