...
* The ITEM_NAME *must be in the displayed item list*.
...
* `fi Cheese` +
`din Cheese Fries` +
Deletes `Cheese Fries` item in the results of the `find-item` command.
//end::menuPart1[]
...
* `fi Cheese` +
`dci 1 dp/0` +
Revert the 1st item in the results of the `find-item` command to original price.
* `li` +
`dci 1 ei/3 dp/50` +
