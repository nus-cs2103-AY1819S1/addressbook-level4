...
****
* To use this command, you must be logged in and have the "REMOVE_EMPLOYEE" permission.
...
****
* To use this command, you must be logged in with "CREATE_ASSIGNMENT" permissions.
****
Examples:
...
|CREATE_ASSIGNMENT (Currently not used)|Allows user to create a assignment
|ASSIGN_ASSIGNMENT (Currently not used)|Allows user to assign employee to a assignment
|VIEW_ASSIGNMENT (Currently not used)|Allows user to view all assignments
...
****
* All restored employees will be taken back to the active list.
****
...
****
* To use this command, you must be logged in with "VIEW_ASSIGNMENT" permissions.
****
...
****
* To use this command, you must be logged in with "REOMVE_ASSIGNMENT" permissions.
****
