...
Shows the percentage of tasks that have been archived for the day. The progress bar is also displayed at the bottom left of the window. +
====
[blue]`progresstoday`
====
...
Shows the percentage of tasks that have been archived for the week. The progress bar is also displayed at the bottom right of the window. +
====
[blue]`progressweek`
====
// end::progressbar[]
