...
`login user/master pass/Pass#123 userdata/masterconfig` +
...
* `addAdmin user/myUsername pass/Password#1 n/John Doe sp/exampleconfig salary/3000 employ/30/09/2018` +
