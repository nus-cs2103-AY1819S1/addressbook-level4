...
** The system will display a success message: "New leave application created:  Description: Family holiday Status: PENDING Dates: 2018-10-182018-10-19"
** You will also be able to view the new leave application using the <<View a list of leave applications : `leavelist`, `leavelist`>> command, as shown below: image:LeaveApplyResult.PNG[width=200]
