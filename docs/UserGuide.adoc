...
* `register id/azhikai pw/1122qq`
* `reg id/azhikai pw/1122qq`
...
Improves the existing `register` command by including the full name of the employee and role.
...
|*Create account* |`register/reg id/USERNAME pw/PASSWORD` |`register/reg id/azhikai pw/p@55w0rd`
