...
* You can give a discount to the whole menu by typing `ALL`(case-insensitive) instead of a specified `INDEX`.
...
|*Add recipe* |`recipe-item r/RECIPE` |`recipe-item r/some recipe`
|*Add required ingredients* |`add-required-ingredients n/INGREDIENT_NAME nu/NUMBER_OF_INGREDIENTS` |`add-required-ingredients n/Apple nu/3`
