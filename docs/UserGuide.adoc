...
Fig. 1: The GUI of Hospital Management System 2K18
+
.  Type the command in the command box and press kbd:[Enter] to execute it. +
e.g. typing *`help`* and pressing kbd:[Enter] will open the help window.
(The command box is indicated in the image above with the words "Enter your commands here...")
...
This command switches the user's view (indicated in the image below) to a chosen view. +
