...
image::beforeremovecommand.png[width="750"]

.After `remove 3` command
image::afterremovecommand.png[width="750"]
...
image::beforeinsertcommand.png[width="750"]

.After `insert 4 p/2` command
image::afterinsertcommand.png[width="750"]
