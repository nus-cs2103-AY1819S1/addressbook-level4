...
Patient must be registered within the system.
...
Add a diagnosis entry to an existing patient’s medical history.
Patient must be registered within the system.
...
* *Help* `help.`
* *Check-in* : `checkin ic/NRIC n/NAME p/PHONE_NUMBER a/ADDRESS d/DRUG_ALLERGIES` +
e.g. `checkin ic/S1234567A n/Ling Zhi Yu p/91234567 a/6 College Avenue East, #00-00, University Town, National University of Singapore, 138614 d/nil`
...
* *Add medical history* : `addmh ic/NRIC mh/[MEDICAL_ENTRY]` +
e.g. `addmh ic/S1234567A mh/Saw patient at 2pm today...`
* *Add appointment for patient* : `addappt ic/NRIC type/TYPE pn/PROCEDURE_NAME dt/DATE_TIME doc/DOCTOR_IN_CHARGE` +
e.g. `addappt ic/S1234567A type/SRG pn/Heart Bypass dt/27-04-2019 1030 doc/Dr. Pepper`
* *View appointments of patient* : `viewappt ic/NRIC` +
e.g. `viewappt S1234567A`
* *Cancel appointment for patient* : `viewappt NRIC` `xappt INDEX` +
e.g. `viewappt S1234567A` `xappt 2`
