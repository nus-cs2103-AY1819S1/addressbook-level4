...
=== Setting a totalBudget: `setBudget`
Sets the totalBudget for Expense Tracker. +

The Expense Tracker will warn you when your total expenditure exceeds the totalBudget that is set.
...
Expense Tracker will reset your totalBudget after every `FREQUENCY`
...
* `setRecurrenceFrequency hrs/1` +
    Sets the totalBudget to reset every 1 hour
* `setRecurrenceFrequency hrs/1 min/30` +
    Sets the totalBudget reset every 1 hour and 30 minutes
****
