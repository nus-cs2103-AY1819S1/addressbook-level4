...
.The red outlines indicate the success message as well as new leave application added to the leave list.
...
.The red outline indicates the list of leave applications.
