...
Syntax: +
 ...
 Shorthand: `find <p|g|m> [a/KEYWORDS...] [s/KEYWORDS...] [n/KEYWORDS...]` +
...
Format: +
Export all groups, meetings and persons : `export * f/FILEPATH` +
Export all meetings and persons of a specific group: `export #GROUP_NAME f/FILEPATH`
