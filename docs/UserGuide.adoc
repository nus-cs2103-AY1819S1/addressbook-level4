...
Creates a new user in Expense Tracker.
...
Edits the all expenses which match the keywords specified by you.
...
Find all the expenses with "lunch" tag and "School" category on 1-10-2018.
...
Expense Tracker will warn you when your total expenditure exceeds the total budget that is set.
