...
=== Adding a module to student's staged module list: `addModuleS` `[coming in v1.3]`

Adds a module to the student’s staged module list. Adding is case insensitive. +
...
* `addModuleS CS2103T CS2101 CS1010` `[coming in v1.3]`

By executing the above command, UI will display the student's staged module list.

=== Adding a module to student's taken module list: `addModuleT` `[coming in v1.3]`

Adds a module to the student’s taken module list. Adding is case insensitive. +
...
* `addModuleT CS2103T CS2101 CS1010` `[coming in v1.3]`

By executing the above command, UI will display the student's taken module list.

=== Deleting a module from student's staged module list: `removeModuleS` `[coming in v1.3]`

Deletes a module from the student’s staged module list. Deleting is case insensitive. +
...
* `removeModuleS CS2103T CS2101 CS1010` `[coming in v1.3]`

By executing the above command, UI will display the student's staged module list.

=== Deleting a module from student's taken module list: `removeModuleT` `[coming in v1.3]`

Deletes a module form the student’s taken module list. Deleting is case insensitive. +
...
* `removeModuleT CS2103T CS2101 CS1010` `[coming in v1.3]`
...
By executing the above command, UI will display all modules in the database whose code starts with given prefix.
