= Hospital Manager 2K18 - User Guide
...
Hospital Manager 2K18 is for hospital administrators, doctors, nurses, and pharmacists who prefer to use a desktop app to manage patients and their associated data. +
More importantly, Hospital Manager 2K18 is *optimized for those who prefer to work with a Command Line Interface* (CLI) while still having the benefits of a Graphical User Interface (GUI). +
If you can type fast, Hospital Manager 2K18 can get your hospital management tasks doen faster than traditional GUI apps. +
...
.  Copy the file to the folder you want to use as the home folder for your Hospital Manager 2K18.
