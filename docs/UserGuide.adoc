...
* Only tag keywords can have multiple keywords. Name/Category/Cost/Date can only have only keywords, i.e."Find n/school n/lunch" is invalid while "Find t/school t/lunch" is valid
====
...
=== Adding a Category Budget: `addCategoryBudget`
...
Format: `addCategoryBudget c/CATEGORY b/BUDGET`

****
*Example:*

* `addCategoryBudget c/School b/10.00` +
    Adds a budget of $10 to the `School` category.
