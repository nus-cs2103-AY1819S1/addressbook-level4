...
Format: `generateLocation n/EVENT_NAME

Examples:

* `generateLocation n/First Meeting`
...
e.g. `showLocation 5`
* *Suggest Location* : `generateLocation n/EVENT_NAME` +
e.g. `generateLocation n/First Meeting`
