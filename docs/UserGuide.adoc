...
The figure above shows the 'event' panel that you will see before executing the `manage` command. The circled
numbers is the EVENT_INDEX that you have to enter.
