...
* `addGroup n/CS2103T` +
Added a new group with title 'CS2103T' into the MeetingBook.
* `addGroup n/Discussion Group 1` +
Added a new group with title 'Discussion Group 1' into the MeetingBook.
...
Removed the group with title 'CS2103T', which is added previously, from MeetingBook.
* `deleteGroup n/Discussion Group 1` +
Removed the group with title 'Discussion Group 1', which is added previously, from MeetingBook.
