...
* `find Logan` +
`enqueuepatient 1` +
Selects the 1st patient in the displayed list of patients whose name contain *Logan* (case insensitive) resulted from the `find Logan` command
...
* *Queue* : `queue` +
e.g. `queue`
* *Enqueue* : `enqueuepatient INDEX` +
e.g. `enqueuepatient 3`
* *Dequeue* : `dequeuepatient INDEX` +
