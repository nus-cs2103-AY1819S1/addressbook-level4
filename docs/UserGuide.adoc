...
Change the current password of the app to `NEW_PASSWORD`. This allows you to use a different password in the event that the old password was compromised. Simply following the example screenshot below: +
