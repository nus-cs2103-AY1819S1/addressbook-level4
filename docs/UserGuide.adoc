...
image::command_clear_before.png[clear bef, 400]

.After clearing entries
image::command_clear_after.png[clear aft, 400]
...
image::command_manage_view.png[manage, 400]
...
.Before adding a volunteer
image::command_record_add.png[add command, 400]
...
.Output of `add 1`
image::command_record_add_after1.png[add command, 400]
...
image::command_record_add_after2.png[add command, 400]
...
.The VOLUNTEER_INDEX
image::command_record_edit_volunteerIndex.png[volunteer index, 400]
...
image::command_record_edit.png[edit command, 400]

.Output of `edit 2 h/5 r/Emcee`
image::command_record_edit_after.png[edit command, 400]
...
.The VOLUNTEER_INDEX
image::command_record_edit_volunteerIndex.png[delete record, 400]
...
image::command_record_edit_after.png[delete command, 400]

.Output of `delete 1`
image::command_record_delete.png[delete command, 400]
