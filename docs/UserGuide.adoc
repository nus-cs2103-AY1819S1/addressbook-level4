...
The figure below displays the expected UI updates after the successful execution of a login command.

image::LoginCommandExample2.png[width="500"]
...
The figures below displays the expected UI updates after the successful execution of the register command.

image::RegisterCommandExample2.png[width="600"]
...
image::RegisterCommandOutputDisplay.png[width="400"]
_Fig 2b. Command Message displayed upon the successful execution of the register command._
...
The figure below displays the expected UI updates after the successful execution of the edit command.

image::EditCommandExample2.png[width="500"]
...
image::LogoutCommandExample.png[width="500"]
_Fig 3. Example of a logout command & the expected UI output._
