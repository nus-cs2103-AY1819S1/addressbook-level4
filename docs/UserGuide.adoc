...
* The sum of all Category budgets cannot exceed the total budget of
  Expense Tracker. This is because Category budgets are used to segment your total budget. Thus, it would not make
  sense to have a Category budget higher than your total budget.
====
