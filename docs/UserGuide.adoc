...
The save command saves the current user's information locally to a file. The saved file is used during the login process to restore a user's information. +
...
_Figure 2. The application displays the saved information and successful message upon entering save command_
