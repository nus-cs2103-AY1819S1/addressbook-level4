...
This section contains all the commands used for ThanePark.
...
* Items in square brackets are optional +
  ...
  n/Battlestar Galactica t/4D or n/Battlestar Galactica.
* Items with …​ after them can be used multiple times including
  zero times +
  e.g. [t/tag]…​ can be used as (i.e. 0 times), t/4D, t/3D t/indoor etc.
