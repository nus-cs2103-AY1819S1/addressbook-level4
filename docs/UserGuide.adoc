...
Then, the new patient will be added to the list as below:
...
Then, any patient that matches the keywords will be displayed as below:
...
include::UserGuide.adoc[tag=loginUser]
