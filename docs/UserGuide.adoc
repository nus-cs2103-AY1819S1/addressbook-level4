...
|===
.Output of `add`
image::command_event_add_after1.png[add command, 200]
...
|===
.Output of `add`
image::command_event_add_after2.png[add command, 200]
...
--
.Before entering the edit command
image::command_event_edit_before.png[Before edit, 200]

.The targeted event is updated to reflect the new values after entering the edit command
image::command_event_edit_after.png[After edit, 200]
--
...
image::command_event_delete_before.png[Before delete, 200]

.The targeted event is deleted after entering the delete command
image::command_event_delete_after.png[After delete, 200]
--
