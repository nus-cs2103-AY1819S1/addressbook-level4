...
image::ui_screenshots/history-example-1.png[width="790"]

Format: `help`

[NOTE]
Extended usage of `help` command: `help [option]`. If invalid `[option]`
is specified, an error message will be shown (soon a default help message will be shown).

* `help more`: Opens the help window to show full usage of ThanePark.

image::ui_screenshots/history-example-1.png[width="790"]

* `help <command word>`: Opens the help window and scrolls to specified command word usage.
Example: `help add`
...
Display previous commands during this session.
...
* *Add*: `add <attraction>` `<maintenance>` `<waitTime>` `<zone>` `[tag(s)]` +
