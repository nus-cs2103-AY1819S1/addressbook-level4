...
image::Overbudget.png[width="200"]
...
spending to reset every week. A detailed use case is given below:
...
image::reset_notif.png[width="200"]
...
If adding an expense causes the available spending of that category to exceeds Category budget, a
