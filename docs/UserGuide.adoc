...
Shows the percentage of tasks that have been archived for the week in the command result box. It also lists the uncompleted tasks for this week. The progress bar is also displayed at the bottom right of the window. +
====
[blue]`progressweek`
====
// end::progressbar[]
