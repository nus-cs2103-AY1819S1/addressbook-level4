...
The `index` field specifies the index of the ride that the user wants to view.
...
image::./ui_screenshots/view-example-3.png[width="600"]
...
image::./ui_screenshots/view-example-4.png[width="600"]
...
image::./ui_screenshots/viewstatus-example-1.png[width="600"]
...
image::./ui_screenshots/viewstatus-example-2.png[width="600"]
...
image::./ui_screenshots/viewstatus-example-3.png[width="600"]

.After executing `viewstatus MainTenaNce` command
image::./ui_screenshots/viewstatus-example-4.png[width="600"]
...
image::./ui_screenshots/viewall-example-1.png[width="600"]

.After executing `viewall`
image::./ui_screenshots/viewall-example-2.png[width="600"]
...
The list box at the left of diagram will also be updated to show all the rides in ThanePark, regardless of status.
|===
// end::viewstatus[]
