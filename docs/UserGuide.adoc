...
* *`-mealplanner`* : display personal meal schedule
* *`-exit`* : exits the app
...
****
For the following features in section 3, each feature's commands will only be recognised when the application is
within the context of the respective feature. In order to switch to the desired feature context, the respective
universal command has to be entered first.
****
