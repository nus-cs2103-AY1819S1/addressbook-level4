...
See below for a pictorial guide on how to find _panadol_ and _dermasone_ in CLInic:
...
those whose stock levels are equal to or lower than their minimum stock quantities.
