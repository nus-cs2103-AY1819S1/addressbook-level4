...
Displays all rides that fits the condition in a table. It can only filter conditions that have numeric values i.e.
...
Finds the rides that the user needs to check on. Case insensitive. +
