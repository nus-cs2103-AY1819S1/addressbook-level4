...
_Figure 2. Saved information and successfully message are displayed upon entering save command_

Upon entering the save command, a file depicted in Figure 3 will be generated.
This file will be required when logging in.

[IMPORTANT]
Modifying the saved file may result in the lost of data that is unrecoverable. Edit at your own risk!
