...
* Password : `pass/<PASSWORD>`
* Name : `n/<NAME>`
* Save path : `sp/<SAVE_PATH>`
* Salary : `salary/<SALARY>`
* Employment date : `date/<EMPLOYMENTDATE>`

Example:

* `addAdmin user/master pass/myPass#1 n/John Doe sp/userconfig.xml salary/4000 date/01/01/2018` +
...
* Name : `n/[NAME]`
* Salary : `salary/[SALARY]`
* Employment date : `employ/[EMPLOYMENT_DATE]`
...
+
image::EditModuleCommandExample.png[width="800"]
...
+
image::RemoveModuleFromDatabaseCommandExample.png[width="800"]
// end::admincommands[]
