...
* If the patient with the specified `NRIC` is still active in the system (which means that the patient in the system has
...
* After a patient has been checked out from the system, any commands which select or add information to this patient
will be considered as an invalid command.
****
