...
`Address Book`, with constraints such as command-line interface must be the main mode of user input.
...
* *Other contributions*:
** Project management:
*** Morphed and transformed portions of `Address Book` into current product `Student Schedule Planner`.
...
*** Added `Target User Profile`, `User Stories` of the Developer Guide:
