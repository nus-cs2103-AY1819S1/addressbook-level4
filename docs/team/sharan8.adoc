...
|===
|_Given below is an excerpt from the section I contributed to the Developer Guide pertaining to my implementation of the `exportcert` feature. It showcases my ability to write technical
documentation aimed at allowing developers to understand my implementation of the feature, including design decisions made. It also showcases the technical depth of my contributions to the project, along with my ability to critically analyse design considerations._
|===
