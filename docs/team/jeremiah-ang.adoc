...
* *Major enhancement*: Implemented the *CAP & Target Grade Calculation* feature.

** What it does: Shows user their current CAP and what grades they needs to achieve
for those incomplete modules so as to achieve their CAP goal.
