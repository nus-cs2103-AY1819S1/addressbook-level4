...
*** What it does: This feature provide a centralised patient database for the user to manage the clinic patients record.
...
* *Minor enhancement*: 
** Redesign the UI. {Pull Request: https://github.com/CS2103-AY1819S1-W14-1/main/pull/248[#248], https://github.com/CS2103-AY1819S1-W14-1/main/pull/251[#251]]
