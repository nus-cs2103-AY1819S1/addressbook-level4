...
** Documentation:
*** Updated the link:{repoURL}/main/tree/master/docs/DeveloperGuide.adoc#Design-Model[Model class diagram]  to better represent all the features that we built.
*** Added documentation in the link:{repoURL}/main/tree/master/docs/DeveloperGuide.adoc#Design-Model[Leave Application section], for the leave management feature I implemented.
** Community:
