...
* *Minor enhancement*: added a list command for dekcs that clears the current filters and displays all decks in Anakin.
...
*** Wrote several additional tests for existing features to increase coverage from 88% to 92% (Pull requests https://github.com[#36], https://github.com[#38])
** Documentation:
...
include::../UserGuide.adoc[Anakin Userguide]
...
include::../DeveloperGuide.adoc[tag=Import/Export Implementation]
