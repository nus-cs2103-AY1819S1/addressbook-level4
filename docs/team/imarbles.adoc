...
For this project, my team had the goal of wanting to _'harness the potential of software to create sustainable social change'_.
...
* View volunteers assigned to event
...
It was challenging as it required complete understanding of all code components so that it can be properly implemented.
