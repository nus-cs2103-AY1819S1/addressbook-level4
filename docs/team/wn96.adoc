...
*** Encryption using randomly generated salts provide a higher level of encryption as hackers will not be able to reverse engineer the password.
*** Inputs of commands requiring password no longer appears in the command history.
*** Existing commands was modified to require a password input.
