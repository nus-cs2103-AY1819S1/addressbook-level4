...
** Highlights:
This enhancement is one of the major building blocks of the system and affects majority of the other components. It required an in-depth analysis of design alternatives. The implementation too was challenging as other components are highly dependent on this enhancement.
...
*** Updated the user interface aesthetics and behaviour: link:{pullURL}/68/[#68], link:{pullURL}/92/[#92], link:{pullURL}/148/[#148], link:{pullURL}/151/[#151], link:{pullURL}/158/[#158], link:{pullURL}/221/[#221], link:{pullURL}/230/[#230], link:{pullURL}/243/[#243]
** Documentation:
*** Did cosmetic tweaks to existing contents of the Developer Guide: link:{pullURL}/118/[#118], link:{pullURL}/123/[#123], link:{pullURL}/128/[#128]
** Community:
*** PRs reviewed (with non-trivial review comments): link:{pullURL}/58/[#58], link:{pullURL}/72/[#72], link:{pullURL}/121/[#121] link:{pullURL}/232/[#232]
