...
|===
|_Given below are part of the sections I contributed to the User Guide. They showcase my ability to write documentation targeting end-users._
|===

include::../UserGuide.adoc[tag=pqms]
include::../UserGuide.adoc[tag=pqms2]
include::../UserGuide.adoc[tag=pqms3]
