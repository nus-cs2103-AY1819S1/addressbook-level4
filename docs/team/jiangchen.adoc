...
all these expenses at the same time.
...
Now users can easily view the list of expenses with desired details, i.e.,specific name, category, cost, etc.
With mass edit, users can easily correct the wrongly recorded expenses.
*** Highlights: This feature enhances the original filtering function and makes filtering more flexible.
...
* *Code contributed*: [https://nus-cs2103-ay1819s1.github.io/cs2103-dashboard/#=undefined&search=jcjxwy&sort=displayName&since=2018-09-12&until=&timeframe=day&reverse=false&repoSort=true[code]]

* *Other contributions*:

** Community:
*** Report bugs for other teams(examples: https://github.com/CS2103-AY1819S1-W16-2/main/issues/209[1],
https://github.com/CS2103-AY1819S1-W16-2/main/issues/211[2])

** Documentation:
*** Update Architecture and Dev Op sections of Developer Guide: https://github.com/CS2103-AY1819S1-T12-1/main/pull/91[#91]
...
image::FindCommandExampleDiagram.png[width="600"]
...
image::MassEditCommandExampleDiagram.png[width="600"]
