...
include::../UserGuide.adoc[tag=byNameCommands]
...
include::../DeveloperGuide.adoc[tag=addUseCase]

include::../DeveloperGuide.adoc[tag=editUseCase]

include::../DeveloperGuide.adoc[tag=deleteUseCase]

include::../DeveloperGuide.adoc[tag=testingAdd]

include::../DeveloperGuide.adoc[tag=testingEdit]
