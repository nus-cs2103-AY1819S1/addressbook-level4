...
to develop a `Java` application as a team of 4 students. This project had a
...
*** Updated the GUI color scheme (Pull requests #102)
** Community:
*** PRs reviewed (with non-trivial review comments): (Pull requests #12, #48, #82, #99)
