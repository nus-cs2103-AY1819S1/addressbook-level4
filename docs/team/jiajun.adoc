...
My task in ThanePark is to implement the view status command to view rides of different status and to update documents.
...
** Credits: The view status is based on the way find feature works, with a `RideStatusPredicate` instead of a
