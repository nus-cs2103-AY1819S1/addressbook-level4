...
*** Added section for payment and earnings in the Developer Guide (Pull requests https://github.com/CS2103-AY1819S1-W13-4/main/pull/81[#81])
*** Added section for Instructions for manual testing in Developer Guide (Pull requests https://github.com/CS2103-AY1819S1-W13-4/main/pull/236[#236])
** Community:
*** Reviewed other PRs
