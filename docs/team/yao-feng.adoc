= Wang YaoFeng - Project Portfolio
...
* *Minor enhancement*: Added an all encompassing command that allows users to find other users based on the name, phone number, address, email, interests, and tags
...
*** Integrated a web service that tracks code coverage (Coveralls) to the project
*** Integrated a web service that automates code reviews and code analytics (Codacy) to the project
