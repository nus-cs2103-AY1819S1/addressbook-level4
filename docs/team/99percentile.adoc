...
Want to make your clinic more organised? https://github.com/CS2103-AY1819S1-W16-4/main/releases[Download] CLInic and try it now for *FREE*!
...
** What it does: It allows the clinic to automate the tracking of the amount of medicines.
** Justification: The amount of medicines are tracked and there are useful commands that can organise or find the information of a medicine.
...
* *Minor enhancement*:
** Rephrased output messages to make it more comprehensive.
...
** Spell-checked all documents to ensure consistency.
