...
*** Added the method of creating command aliases: https://github.com/CS2103-AY1819S1-F10-4/main/pull/41[#41]
** Documentation:
*** Helped teammates with proper language and phrasing in the User Guide and Developer Guide
** Community:
