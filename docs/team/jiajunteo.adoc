...
* *Minor enhancement*: The addition of the `maintain` feature.
** What it does: This feature allows the user to update the status of a selected ride to `MAINTENANCE`.
** Justification: This feature allows the user to keep track of the status of the ride.
** Highlight: This enhancement involves changing the status of the ride to `MAINTENANCE`.
  In doing so, the command also updates the maintenance and waiting time field to zero
** Credits: The maintain feature is based on the way update feature works, by updating the `status`, `maintenance` and `waiting time` fields instead of all other fields.
...
** Documentation:
*** Updated the section of the User Guide on view information of rides [https://github.com/CS2103-AY1819S1-W14-2/main/pull/154[Pull Request #154]]
*** Updated the section of the Developer Guide on View Status feature [https://github.com/CS2103-AY1819S1-W14-2/main/pull/101[Pull Request #101]]

** Community:
*** Reported bugs for other teams in the class [https://github.com/CS2103-AY1819S1-T09-1/main/issues/144[T09-1 Issue #144]]
