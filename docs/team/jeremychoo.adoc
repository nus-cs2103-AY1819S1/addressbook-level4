...
[NOTE]
Text with a note on a left isn't really part of the user guide, they're just questions and comments that I want to bring up during the review.
...
* *Minor enhancement*: Allow for easier searching of employees by updated the find command to support `\*` and `\_` as wildcards. `*` as a generic wildcards for any number of characters (including 0), while `_` acts as a generic wildcard for a single character.
...
*** Reported bugs and suggestions for other teams in the class (examples:  https://github.com/CS2103-AY1819S1-F10-2/main/issues/108[1])
** Tools:
