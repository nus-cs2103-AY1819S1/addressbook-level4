...
** What it does: Ensures that each command is executed only by an employee with the permission required for it.
...
However, usage of this enhancement is made to be simple, simply needing only 1 line of code to be added into any new Command class to ensure that
...
** Highlights: There are many different ways this functionality could have been done. Therefore, I spent quite some time to research how this functionality had been done on existing system, and have created and tested many different prototypes for this functionality before finally deciding on the current implementation.
...
//include::../UserGuide.adoc[tag=permission]

//include::../UserGuide.adoc[tag=commandautocomplete]
