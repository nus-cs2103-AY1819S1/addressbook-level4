...
Office Assistance Specialized Integration System (OASIS) is an all-in-one HR management tool targeted at Small and Medium enterprises to simplify task such as employee management, project management and leave applications
...
==== Others
* *Code contributed*: [https://nus-cs2103-ay1819s1.github.io/cs2103-dashboard/#=undefined&search=kokjianyu&sort=displayName&since=2018-09-12&until=2018-11-11&timeframe=day&reverse=false&repoSort=true[All Code]]
