...
=== Major Enhancement: Implemented Permission System to control what each employee can do in OASIS

** What it does:
*** Ensures that commands are executed only by employees with the permission required for it. It also allow users with the required permission, to view and modify the permissions other employees have.
** Justification:
...
* Added *Command Auto-Complete* feature
** What it does:
