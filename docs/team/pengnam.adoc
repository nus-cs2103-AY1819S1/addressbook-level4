...
also the earliest due date among all tasks that directly or indirectly dependant on the task.
...
https://github.com/CS2103-AY1819S1-F11-3/main/projects[project boards]
...
Pull request 41, 47, 48, 50, 51, 54, 66
