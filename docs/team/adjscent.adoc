...
** What it does: Allows the user to manage their schedule inside EventOrganiser. Allows the user to compare multiple schedules to get the possible free slots.
