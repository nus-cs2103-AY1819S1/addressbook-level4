...
* *Code contributed*: [https://github.com/CS2103-AY1819S1-W10-3/mai[Functional code]] [https://nus-cs2103-ay1819s1.github.io/cs2103-dashboard/#=undefined&search=adjscent&sort=displayName&since=2018-09-12&until=2018-11-06&timeframe=day&reverse=false&repoSort=true[Test code]]
