...
** Function: It informs the user if the their expenses exceed a set budget
...
. Added a `setRecurrenceFrequency` command that allows the user to reset their expenses at a frequency of their choice.
