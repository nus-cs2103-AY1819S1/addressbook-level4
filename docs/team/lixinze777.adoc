...
Patient Book is a student project done by 5 NUS Year 2 Computer Science students. I am one member of
...
Patient Book is a desktop application for doctors. It is an all-in-one software that helps doctors to
...
Patient book allows users to manipulate patient and appointment data in various means such as `add`, `delete`,
