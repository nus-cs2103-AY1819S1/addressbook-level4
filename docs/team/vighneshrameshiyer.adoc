...
*** Modified classes in the original AddressBook app to help transform it into our U-Schedule app. e.g. renaming AddressBook to Scheduler and Person to CalendarEvent, modifying CalendarEvent and the various parsers to accept and store events' date & time (Pull Requests: https://github.com/CS2103-AY1819S1-T10-1/main/pull/11[#11], https://github.com/CS2103-AY1819S1-T10-1/main/pull/39[#39])
