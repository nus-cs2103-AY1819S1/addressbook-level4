...
modsUni is an open-sourced project was in collaboration with four other course mates from the module CS2103 (Introduction to Software Engineering).
...
*** The feature allows returning users to restore their information using the previously saved file.
