...
* *Major enhancement*: This enhancement added functionality to save and load a user (Admin/Student) data feature.

** What it does:
*** This feature allows a user to save their information as a file locally.
*** This feature allows returning users to restore their information using the previously saved file.
*** This feature encrypts information that are saved.
*** This feature displays the saved information upon issue the save command.
...
** Highlights: This enhancement puts confidentiality in high regard with multiple security concerns raised and discussed prior to implementation. The inbuilt security feature was also made robust to prevent users from being frustrated.
...
*** Updated PRs with the relevant tags.
