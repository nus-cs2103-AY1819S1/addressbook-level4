...
*** Updated the GUI to show a ListPicker to toggle between active and archive list. (Pull requests https://github.com/CS2103-AY1819S1-F10-1/main/pull/183[#183])
*** Updated DeleteCommand to delete from either active or archive list depending on which list the user is on. (Pull requests)
*** Updated ClearCommand to clear all employees in OASIS, both active and archive. (Pull requests)
*** Wrote tests for features. (Pull requests https://github.com/CS2103-AY1819S1-F10-1/main/pull/183[#183])
