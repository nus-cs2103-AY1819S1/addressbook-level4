...
*** Updated `DeleteCommand` to delete from either active or archive list depending on which list the user is on.
*** Updated `ClearCommand` to clear all employees in OASIS, both active and archive.
