...
** Highlights: This enhancement affects all existing commands and future commands to be added in future. It required an in-depth analysis of design alternatives. The implementation too was challenging as it required changes to existing commands, and research on
