...
This portfolio showcases my contributions for https://github.com/CS2103-AY1819S1-F10-4/main[MeNUS].
...
|===
|_The following sections below showcase extracts of my contributions to the Developer Guide. It also showcase my
ability to
