...
** *What it does*: Allows the user to manage the menus with the various menu management commands.
** *Justification*: It can be messy and tedious to manage menus manually. This feature helps users to
streamline the process of managing menus by allowing them to modify the menus with just a single command.
