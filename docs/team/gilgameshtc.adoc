...
*My role and contributions:* My contribution to the project is the implementation of the calendar feature and all its relevant commands. The commands that facilitate the calendar feature includes creating calendars, adding events, deleting events and viewing calendars.
