...
** Justification: These features is the basics of the product such that a user can track his or her contacts, modules
...
occasions they are involved in; similarly, it allows finding Modules by module code, module name, academic year or
semester; finding occasions by occasion name, occasion date, or occasion location.
...
** Highlights: The finding is based on the prefixes entered by the user when he or she adds a Person, Module
or Occasion. It is compatible with the Add Command, such that Person, Module and Occasion will only be found by the
attributes that have been entered by the user.
...
** Documentation:
*** Did cosmetic tweaks to existing contents of the User Guide: https://github.com/CS2103-AY1819S1-W10-1/main/pull/88[#88],
...
https://github.com/CS2103-AY1819S1-W10-1/main/pull/121[#121], https://github.com/CS2103-AY1819S1-W10-1/main/pull/171[#171],
https://github.com/CS2103-AY1819S1-W10-1/main/pull/188[#188]
