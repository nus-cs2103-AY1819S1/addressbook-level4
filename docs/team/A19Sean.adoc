...
*** Edited ResultDisplay such that upon an invalid command, the result display text would be in a red font. (Pull requests https://github.com[#13])
** Documentation:
*** Regularly updated User Guide and Developer Guide: https://github.com[#9], https://github.com[#102], https://github.com[#108], https://github.com[#172], https://github.com[#183]
** Community:
*** PRs reviewed (with non-trivial review comments): https://github.com[#39], https://github.com[#73], https://github.com[#79]
