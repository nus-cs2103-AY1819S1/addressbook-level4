...
Fields were used extensively throughout the application in and required careful but major changes of the existing code to not break the whole application. (Pull requests: https://github.com/CS2103-AY1819S1-T10-3/main/pull/50[#50] and https://github.com/CS2103-AY1819S1-T10-3/main/pull/23[#23])

* *Minor enhancement*: Added different coloring of tags. However, feature was later removed due to a fresh restart of the project. After that I considered the feature to be only "nice to have" and did not reimplement it.
