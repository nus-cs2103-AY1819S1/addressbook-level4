...
Our application allows you to view vital information such as lots availability for each car park, so that you can plan ahead of your trip. +

If you use the computer frequently
and commute by driving, try out _Car Park Finder_ https://github.com/CS2103-AY1819S1-T09-4/main/releases[now]. No installation is required and all you need to do to get started is to type away!
