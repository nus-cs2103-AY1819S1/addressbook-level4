...
`CLInic` is a desktop application made to manage and expedite operations in clinics. The main impetus behind `CLInic`
 was to distil the CLI's efficiency of typing commands from its cryptic walls of text that was intimidating to the
 general, non tech-savvy populous. `CLInic` marries the **simplistic design** and **efficient command issuing mechanism**
...
* *Code contributed*: View the code I have written for the project https://nus-cs2103-ay1819s1.github.io/cs2103-dashboard/#=undefined&search=clawyq&sort=displayName&since=2018-09-12&until=2018-11-07&timeframe=day&reverse=false&repoSort=true[here]!
...
https://github.com/ChesterSng/addressbook-level4/pull/24[#119],
...
=== 4.1. Implementation of the Document class
'''
