...
|===
|_The following sections are my contributions to the User Guide. They reflect my ability to write clear and concise
documentation targeting non-technical readers.
|===

include::../UserGuide.adoc[tag=salesmanagement]
include::../UserGuide.adoc[tag=salesv20]
include::../UserGuide.adoc[tag=salesglossary]

== Contributions to the Developer Guide

|===
|_The following sections are my contributions to the Developer Guide. They reflect my ability to convey technical
information in a comprehensible manner.  It also showcases the technical depth of my contributions.
|===

include::../UserGuide.adoc[tag=salesmanagement]
include::../UserGuide.adoc[tag=ucsales]
