...
*** Added the add event tag/find event/command auto-completion functionalities and tests (Pull requests https://github.com/CS2103-AY1819S1-W13-2/main/pull/138[#138],
  https://github.com/CS2103-AY1819S1-W13-2/main/pull/175[#175], https://github.com/CS2103-AY1819S1-W13-2/main/pull/174[#174])
...
include::../DeveloperGuide.adoc[tag=editEventAddress3]
...
include::../DeveloperGuide.adoc[tag=eventTags3]
...
include::../DeveloperGuide.adoc[tag=filterEvents3]
