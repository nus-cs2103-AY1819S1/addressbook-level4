...
*** What it does: Allows the user to add event tags into EventsPlus+ and find events by their tags, used for tagging new events.
*** Justification: This is required for standardization of events tagging and makes it easier to find events by tags.
*** Highlights: Event tags are shown at the top of the *Events* tab and can be used for easy reference of event types.
...
*** Justification: Saves time on the user on typing commands (and remembering full commands), as they can use just the `Tab` key.
//~
* *Other contributions*:
