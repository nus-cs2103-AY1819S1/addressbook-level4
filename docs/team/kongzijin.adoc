...
TheTracker is implemented for applying CS2103 learning outcomes and show understanding of the software design.
It is implemented by our CS2103 Project group. My key contribution is edit commands.
TheTracker is written in Java and JavaFX, and is morphed from AddressBook-level4,
the application used for teaching Software Engineering principles.
