...
that match all user-input tags will be displayed. It resulted in a logic error when no tags were provided, allowing
all tasks to be listed instead of returning an error. This logic error was resolved.
