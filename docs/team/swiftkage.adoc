...
* *Minor enhancement*: added *attributes to an Article entry*
** What it does: The added attributes - Finder, Owner and isResolved will allow the user to keep track of the person who found and claimed the article, and whether the article have been resolved.
...
*** Refactored code according to LostBUTFound's specifications.
